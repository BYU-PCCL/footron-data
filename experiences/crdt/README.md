# Editing Together, Offline

Two people edit the same sentence on two disconnected laptops. When they reconnect, both copies end up exactly the same — no server decides. This is the CRDT idea behind collaborative editors like Automerge and Yjs.
