	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ul.BlurDirectionX=new H(1,0),ul.BlurDirectionY=new H(0,1);var dl={bg:724247,nodeBase:1712960,edgeCheap:1781840,edgeCostly:7218192,frontier:16777215,pathIgnite:16777215,beacon:15988735,starCool:12900095,starWarm:16773586,starLine:3821440},fl={base:2.6,tree:4.2,flash:4.6,path:7};function pl(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function ml(e,t){let n=Array.from({length:4096},()=>e()),r=(e,t)=>n[(t%64+64)%64*64+(e%64+64)%64],i=e=>e*e*(3-2*e);return(e,n)=>{let a=e/t,o=n/t,s=Math.floor(a),c=Math.floor(o),l=i(a-s),u=i(o-c),d=r(s,c)+(r(s+1,c)-r(s,c))*l;return d+(r(s,c+1)+(r(s+1,c+1)-r(s,c+1))*l-d)*u}}var hl=.8,gl=1400;function _l(e){let t=0;for(let n of e)n>t&&(t=n);return{nodeState:new Uint8Array(e.length),parentEdge:new Int32Array(e.length).fill(-1),flashes:new Map,hotAt:new Float64Array(e.length).fill(-1/0),depth:e,maxDepth:t,waveAt:-1,waveMs:0,pending:[],path:null,foundAt:-1,visited:0,lastProbeEdge:-1,rippleAt:-1,rippleDepth:null}}function vl(e,t,n){e.nodeState[t]===0&&e.visited++,e.nodeState[t]=1,e.hotAt[t]=n}function yl(e){for(let t=0;t<e.nodeState.length;t++)e.nodeState[t]===1&&(e.nodeState[t]=2)}function bl(e,t){for(let n of e.pending)vl(e,n,t);e.pending=[]}function xl(e,t){let n=e.depth[t]<0?e.maxDepth:e.depth[t],r=e.maxDepth>0?n/e.maxDepth:0;return e.waveAt+r*e.waveMs*hl}function Sl(e,t,n,r=500){switch(t.kind){case`probe`:e.lastProbeEdge=t.edge,e.flashes.set(t.edge,n);break;case`visit`:case`improve`:if(e.waveAt>=0){e.pending.push(t.node);break}t.kind===`visit`&&vl(e,t.node,n),e.lastProbeEdge>=0&&(e.parentEdge[t.node]=e.lastProbeEdge);break;case`settle`:e.nodeState[t.node]=2;break;case`round`:yl(e),bl(e,n),(e.waveAt<0||n>=e.waveAt+e.waveMs)&&(e.waveAt=n,e.waveMs=r),e.lastProbeEdge=-1;break;case`found`:bl(e,n),e.path=t.path,e.foundAt=n;break;case`deadEnd`:break;default:}}function Cl(e,t){e.waveAt<0||e.pending.length===0||(e.pending=e.pending.filter(n=>t>=xl(e,n)?(vl(e,n,t),!1):!0))}function wl(e,t,n){for(let[r,i]of e.flashes)t-i>n&&e.flashes.delete(r)}function Tl(e,t){let n=new Int32Array(e.length).fill(-1);n[t]=0;let r=[t];for(let t=0;t<r.length;t++)for(let{node:i}of e[r[t]])n[i]<0&&(n[i]=n[r[t]]+1,r.push(i));return n}function El(e,t,n,r=n){bl(e,n),yl(e),e.waveAt=-1,e.rippleAt=Math.max(n,r),e.rippleDepth=t}function Dl(e,t){if(e.rippleAt<0||!e.rippleDepth)return 0;let n=0;for(let t of e.rippleDepth)t>n&&(n=t);return Math.max(0,e.rippleAt+n*50+300-t)}function Ol(e){"@babel/helpers - typeof";return Ol=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Ol(e)}function kl(e,t){if(Ol(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(Ol(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Al(e){var t=kl(e,`string`);return Ol(t)==`symbol`?t:t+``}function Y(e,t,n){return(t=Al(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var jl=15,Ml=300,Nl=1600,Pl=500,Fl=2e3,Il=700,X={strength:1.25,radius:.55,threshold:.14},Z=197641,Ll=96,Rl=130,zl=2,Bl=750,Vl=[2600,7e3],Hl=7,Ul=170,Wl=null;function Gl(){if(Wl)return Wl;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#000`,t.fillRect(0,0,128,128);let n=t.createRadialGradient(64,64,0,64,64,64);return n.addColorStop(0,`rgb(255,255,255)`),n.addColorStop(.18,`rgb(153,153,153)`),n.addColorStop(.5,`rgb(36,36,36)`),n.addColorStop(1,`rgb(0,0,0)`),t.fillStyle=n,t.fillRect(0,0,128,128),Wl=new Ei(e)}var Kl=null;function ql(){if(Kl)return Kl;let e=document.createElement(`canvas`);e.width=256,e.height=2;let t=e.getContext(`2d`),n=t.createImageData(256,2);for(let e=0;e<256;e++){let t=(1-Math.abs(e/127.5-1))**2.2*255;for(let r=0;r<2;r++){let i=4*(r*256+e);n.data[i]=n.data[i+1]=n.data[i+2]=t,n.data[i+3]=255}}return t.putImageData(n,0,0),Kl=new Ei(e)}var Jl=null;function Yl(){if(Jl)return Jl;let e=document.createElement(`canvas`);e.width=256,e.height=16;let t=e.getContext(`2d`),n=t.createImageData(256,16);for(let e=0;e<256;e++){let t=(e/255)**2.6;for(let r=0;r<16;r++){let i=1-Math.abs(r/7.5-1),a=4*(r*256+e);n.data[a]=n.data[a+1]=n.data[a+2]=255*t*i**1.4,n.data[a+3]=255}}return t.putImageData(n,0,0),Jl=new Ei(e)}function Xl(e){let t=pl((e^2654435769)>>>0),n=1024,r=document.createElement(`canvas`);r.width=n,r.height=456;let i=r.getContext(`2d`),a=-.28+t()*.2;i.save(),i.translate(n/2,456/2),i.rotate(a);let o=i.createLinearGradient(0,-150,0,150);o.addColorStop(0,`rgba(120,130,190,0)`),o.addColorStop(.5,`rgba(140,150,210,0.07)`),o.addColorStop(1,`rgba(120,130,190,0)`),i.fillStyle=o,i.fillRect(-1024,-150,2*n,300);for(let e=0;e<6e3;e++){let e=(t()+t()+t()-1.5)*110,r=(t()-.5)*2*n,a=.03+.22*t()*t(),o=.4+t()*1;i.fillStyle=`rgba(215,222,255,${a})`,i.beginPath(),i.arc(r,e,o,0,Math.PI*2),i.fill()}i.restore();let s=[`52,60,150`,`110,50,140`,`30,95,130`,`140,70,110`,`40,70,160`];for(let e=0;e<7;e++){let e=t()*n,r=t()*456,a=120+t()*260,o=s[Math.floor(t()*s.length)],c=i.createRadialGradient(e,r,0,e,r,a);c.addColorStop(0,`rgba(${o},${.09+t()*.07})`),c.addColorStop(.5,`rgba(${o},0.03)`),c.addColorStop(1,`rgba(${o},0)`),i.fillStyle=c,i.fillRect(e-a,r-a,2*a,2*a)}let c=new Ei(r);return c.colorSpace=ct,c}function Zl(e=.045){let t=new Fr,n=e/2;return t.setAttribute(`position`,new br(new Float32Array([-.5,-n,0,.5,-n,0,.5,n,0,-.5,n,0,-n,-.5,0,n,-.5,0,n,.5,0,-n,.5,0]),3)),t.setAttribute(`uv`,new br(new Float32Array([0,.5,1,.5,1,.5,0,.5,0,.5,0,.5,1,.5,1,.5]),2)),t.setIndex([0,1,2,0,2,3,4,5,6,4,6,7]),t}function Ql(){let e=document.createElement(`canvas`);e.width=512,e.height=228;let t=e.getContext(`2d`),n=t.createImageData(512,228);for(let e=0;e<228;e++)for(let t=0;t<512;t++){let r=(t/512-.5)/.75,i=(e/228-.48)/.7,a=Math.sqrt(r*r+i*i),o=Math.max(0,Math.min(1,(a-.58)/.42))*.5,s=4*(e*512+t);n.data[s]=n.data[s+1]=n.data[s+2]=o*255,n.data[s+3]=255}return t.putImageData(n,0,0),new Ei(e)}var $l=class{constructor(e){Y(this,`renderer`,void 0),Y(this,`scene`,new Vn),Y(this,`camera`,void 0),Y(this,`nodeMesh`,null),Y(this,`haloMesh`,null),Y(this,`edgeMesh`,null),Y(this,`graph`,null),Y(this,`strainColor`,new G(`#38d9ff`)),Y(this,`visual`,null),Y(this,`beacon`,null),Y(this,`beaconMat`,null),Y(this,`startMarker`,null),Y(this,`startMat`,null),Y(this,`renderScale`,1),Y(this,`time`,0),Y(this,`dummy`,new Mn),Y(this,`edgeColor`,[]),Y(this,`edgeWidth`,[]),Y(this,`edgeBase`,[]),Y(this,`edgeBaseWidth`,[]),Y(this,`edgesDirty`,!1),Y(this,`sky`,null),Y(this,`skyGroup`,null),Y(this,`skyMesh`,null),Y(this,`nebula`,null),Y(this,`spikeMesh`,null),Y(this,`meteors`,[]),Y(this,`nextMeteorAt`,0),Y(this,`burstLeft`,0),Y(this,`burstAt`,0),Y(this,`skyRng`,Math.random),Y(this,`edgeSeen`,[]),Y(this,`fieldAt`,0),Y(this,`nodeRevealAt`,[]),Y(this,`composer`,void 0),Y(this,`bloom`,void 0),Y(this,`quality`,`high`),this.renderer=new Qc({canvas:e,antialias:!0}),this.renderer.setSize(d,f,!1),this.renderer.setClearColor(dl.bg,1),this.camera=new ga(0,d,0,-f,-100,100),this.camera.position.z=10,e.addEventListener(`webglcontextlost`,()=>location.reload());let t=new ii(new Mi(d,f),new Kr({color:0,transparent:!0,depthWrite:!1,alphaMap:Ql()}));t.position.set(d/2,-f/2,5),t.renderOrder=100,this.scene.add(t),this.composer=new sl(this.renderer),this.composer.addPass(new cl(this.scene,this.camera)),this.bloom=new ul(new H(d,f),X.strength,X.radius,X.threshold),this.composer.addPass(this.bloom)}setQuality(e){e!==this.quality&&(this.quality=e,this.bloom.enabled=e!==`low`&&!this.sky,this.applySizes())}setRenderScale(e){let t=Math.min(1,e);t!==this.renderScale&&(this.renderScale=t,this.applySizes())}applySizes(){let e=Math.max(1,Math.round(d*this.renderScale)),t=Math.max(1,Math.round(f*this.renderScale));this.renderer.setSize(e,t,!1),this.composer.setSize(e,t);let n=this.quality===`high`?1:.5;this.bloom.setSize(e*n,t*n)}setField(e,t=null){this.disposeMeshes(),this.graph=e;let n=e.nodes.length,r=new ji(6,20);this.nodeMesh=new gi(r,new Kr,n);let i=new G(dl.nodeBase);for(let t=0;t<n;t++)this.dummy.position.set(e.nodes[t].x,-e.nodes[t].y,0),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(t,this.dummy.matrix),this.nodeMesh.setColorAt(t,i);this.scene.add(this.nodeMesh);let a=t?new Mi(Ll,Ll):new ji(jl,24),o=new Kr({blending:2,depthWrite:!1,transparent:!0,alphaMap:t?Gl():null});this.haloMesh=new gi(a,o,n);let s=new G(0);for(let t=0;t<n;t++)this.dummy.position.set(e.nodes[t].x,-e.nodes[t].y,-.3),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.haloMesh.setMatrixAt(t,this.dummy.matrix),this.haloMesh.setColorAt(t,s);this.scene.add(this.haloMesh);let c=e.edges.map(e=>e.weight/e.length),l=new G(t?dl.bg:dl.edgeCheap),u=new G(t?dl.bg:dl.edgeCostly),p=c.map(e=>1-1/e);this.edgeBase=p.map(e=>l.clone().lerp(u,e)),this.edgeBaseWidth=p.map(e=>t?0:fl.base*(1+.7*e)),this.edgeSeen=e.edges.map(()=>!1),this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice();let m=new Mi(1,1);if(this.edgeMesh=new gi(m,new Kr,e.edges.length),this.edgesDirty=!0,this.scene.add(this.edgeMesh),this.sky=t,this.renderer.setClearColor(t?Z:dl.bg,1),this.bloom.enabled=this.quality!==`low`&&!t,this.fieldAt=this.time*1e3,this.nodeRevealAt=[],t){this.skyRng=pl((t.seed^24301)>>>0),this.skyGroup=new Nn,this.scene.add(this.skyGroup),this.nebula=new ii(new Mi(d*1.3,f*1.3),new Kr({map:Xl(t.seed),blending:2,depthWrite:!1,transparent:!0,opacity:0})),this.nebula.position.set(d/2,-f/2,-3),this.skyGroup.add(this.nebula);let r=new Mi(1,1),i=new Kr({blending:2,depthWrite:!1,transparent:!0,alphaMap:Gl()});this.skyMesh=new gi(r,i,t.field.length),t.field.forEach((e,t)=>{this.dummy.position.set(e.x,-e.y,-2),this.dummy.scale.setScalar(4+10*e.b),this.dummy.updateMatrix(),this.skyMesh.setMatrixAt(t,this.dummy.matrix),this.skyMesh.setColorAt(t,s)}),this.skyGroup.add(this.skyMesh),this.spikeMesh=new gi(Zl(),new Kr({blending:2,depthWrite:!1,transparent:!0,alphaMap:ql()}),n);for(let e=0;e<n;e++)this.spikeMesh.setColorAt(e,s);this.scene.add(this.spikeMesh),this.meteors=[];for(let e=0;e<4;e++){let e=new ii(new Mi(1,1),new Kr({color:14674175,blending:2,depthWrite:!1,transparent:!0,alphaMap:Yl(),opacity:0}));e.visible=!1,e.position.z=.5,this.skyGroup.add(e),this.meteors.push({mesh:e,at:-1,x:0,y:0,dx:0,dy:0,dist:0,len:0})}this.nextMeteorAt=this.fieldAt+2800+this.skyRng()*2e3,this.burstLeft=0;let a=e.nodes.map(e=>e.x),o=Math.min(...a),c=Math.max(1,Math.max(...a)-o);this.nodeRevealAt=e.nodes.map((e,n)=>this.fieldAt+Pl+Fl*((e.x-o)/c)+140*(t.phase[n]/(2*Math.PI)))}this.visual=null,this.setTarget(null),this.setStart(null)}beginRun(e,t){this.strainColor=new G(e),this.visual=this.graph?_l(Tl(this.graph.adjacency,t)):null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgeSeen.fill(!1),this.edgesDirty=!0}clearRun(){this.visual=null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgeSeen.fill(!1),this.edgesDirty=!0}applyOps(e,t){if(!this.visual)return;let n=this.time*1e3,r=Math.max(t??500,gl);for(let t of e)Sl(this.visual,t,n,r)}setTarget(e){if(e===null||!this.graph){this.beacon&&(this.beacon.visible=!1);return}this.beacon||(this.beaconMat=new Kr({color:dl.beacon,transparent:!0,opacity:.85,blending:2,depthWrite:!1}),this.beacon=new Nn,this.beacon.add(new ii(new Ni(26,30,48),this.beaconMat),new ii(new Ni(44,46,64),this.beaconMat)),this.beacon.position.z=1,this.scene.add(this.beacon));let t=this.graph.nodes[e];this.beacon.position.set(t.x,-t.y,1),this.beacon.visible=!0}finishRipple(e,t=0){if(!this.visual||!this.graph)return 0;let n=this.time*1e3;return El(this.visual,Tl(this.graph.adjacency,e),n,n+t),this.sky&&(this.burstLeft=Hl,this.burstAt=n+t+300),Dl(this.visual,n)}pathIgniteMs(){let e=this.visual?.path;return e?Math.max(0,e.length-1)*60:0}setStart(e){if(e===null||!this.graph){this.startMarker&&(this.startMarker.visible=!1);return}this.startMarker||(this.startMat=new Kr({color:dl.beacon,transparent:!0,opacity:.55,blending:2,depthWrite:!1}),this.startMarker=new ii(new Ni(16,19,40),this.startMat),this.startMarker.position.z=1,this.scene.add(this.startMarker));let t=this.graph.nodes[e];this.startMarker.position.set(t.x,-t.y,1),this.startMarker.visible=!0}update(e){this.time+=e/1e3;let t=this.time*1e3;if(this.camera.position.x=8*Math.sin(this.time*.11),this.camera.position.y=5*Math.cos(this.time*.07),this.beacon?.visible){let t=1+.15*Math.sin(this.time*3);this.beacon.scale.setScalar(t),this.beacon.rotation.z+=e*6e-4}if(this.startMarker?.visible&&this.startMarker.scale.setScalar(1+.08*Math.sin(this.time*3+Math.PI)),!this.nodeMesh||!this.graph)return;let n=this.visual,r=new G(dl.starCool),i=new G(dl.starWarm),a=new G;this.sky&&this.skyMesh&&this.skyGroup&&this.updateSky(t,r,i,a),n?(Cl(n,t),wl(n,t,Ml),this.styleEdges(n,t)):this.edgesDirty&&this.rewriteEdges();let o=new G(dl.nodeBase).multiplyScalar(.8),s=new G(dl.frontier),c=this.strainColor.clone().lerp(s,.35),l=this.strainColor.clone().multiplyScalar(.85),u=n!==null&&n.waveAt>=0,d=new G,f=new G;for(let e=0;e<this.graph.nodes.length;e++){let p=n?n.nodeState[e]:0,m;if(p===0){if(this.sky){let n=this.sky.mag[e],o=.82+.18*Math.sin(this.time*1.3+this.sky.phase[e]);a.copy(r).lerp(i,this.sky.tint[e]),d.copy(a).multiplyScalar((.8+.5*n)*o),m=.55+.5*n,f.copy(a).multiplyScalar((.16+.3*n)*o);let c=(t-this.nodeRevealAt[e])/Il;if(c<0)d.setRGB(0,0,0),f.setRGB(0,0,0),m=.001;else if(c<1){let e=Math.sin(Math.PI*c);d.lerp(s,.85*e),f.copy(a).multiplyScalar(.5*e+.1),m*=1+1.8*e}}else d.copy(o),m=.8,f.setRGB(0,0,0);if(n&&n.rippleAt>=0&&n.rippleDepth&&n.rippleDepth[e]>=0){let r=t-(n.rippleAt+n.rippleDepth[e]*50);if(r>=0){let e=Math.max(0,1-r/300);d.lerp(c,.7*e),f.copy(this.strainColor).multiplyScalar(.45*e),m=.8+.45*e}}}else{let r=Math.max(0,1-(t-n.hotAt[e])/600);d.copy(l).lerp(c,r),m=1.05+.45*r;let i=.3+.35*r;if(u){let r=t-xl(n,e);if(r>=0&&r<300){let e=1-r/300;d.lerp(c,.35*e),m+=.2*e,i+=.3*e}}if(f.copy(this.strainColor).multiplyScalar(i),n.rippleAt>=0&&n.rippleDepth&&n.rippleDepth[e]>=0){let r=t-(n.rippleAt+n.rippleDepth[e]*50);if(r>=0){let e=Math.max(0,1-r/300);d.copy(l).multiplyScalar(1.1).lerp(c,.9*e),f.copy(this.strainColor).multiplyScalar(.28+.5*e),m=1.05+.35*e}}}let h=this.graph.nodes[e];if(this.dummy.position.set(h.x,-h.y,0),this.dummy.scale.setScalar(m),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(e,this.dummy.matrix),this.nodeMesh.setColorAt(e,d),this.haloMesh.setColorAt(e,f),this.spikeMesh&&this.sky){let t=this.sky.mag[e];this.dummy.position.set(h.x,-h.y,.2),this.dummy.rotation.set(0,0,.12*Math.sin(this.sky.phase[e])),this.dummy.scale.setScalar(m*Rl*(.6+.5*t)),this.dummy.updateMatrix(),this.spikeMesh.setMatrixAt(e,this.dummy.matrix),this.spikeMesh.setColorAt(e,f.clone().multiplyScalar(2.3))}}this.dummy.rotation.set(0,0,0),this.nodeMesh.instanceMatrix.needsUpdate=!0,this.nodeMesh.instanceColor&&(this.nodeMesh.instanceColor.needsUpdate=!0),this.haloMesh.instanceColor&&(this.haloMesh.instanceColor.needsUpdate=!0),this.spikeMesh&&(this.spikeMesh.instanceMatrix.needsUpdate=!0,this.spikeMesh.instanceColor&&(this.spikeMesh.instanceColor.needsUpdate=!0))}updateSky(e,t,n,r){let i=this.sky,a=this.skyGroup,o=Math.min(1,(e-this.fieldAt)/Nl);this.nebula.material.opacity=.6*o,a.position.set(14*Math.sin(this.time*.05),9*Math.cos(this.time*.041),0),this.nebula.rotation.z=.012*Math.sin(this.time*.03),i.field.forEach((e,i)=>{let a=.72+.28*Math.sin(this.time*e.speed+e.phase);r.copy(t).lerp(n,e.tint).multiplyScalar(1.05*e.b*a*o),this.skyMesh.setColorAt(i,r)}),this.skyMesh.instanceColor&&(this.skyMesh.instanceColor.needsUpdate=!0),this.burstLeft>0&&e>=this.burstAt?(this.spawnMeteor(e),this.burstLeft--,this.burstAt=e+Ul):e>=this.nextMeteorAt&&(this.spawnMeteor(e),this.nextMeteorAt=e+Vl[0]+this.skyRng()*(Vl[1]-Vl[0]));for(let t of this.meteors){if(t.at<0)continue;let n=(e-t.at)/Bl;if(n>=1){t.at=-1,t.mesh.visible=!1;continue}let r=t.x+t.dx*t.dist*n,i=t.y+t.dy*t.dist*n,a=t.len*Math.min(1,n*3);t.mesh.position.set(r-t.dx*a/2,-(i-t.dy*a/2),.5),t.mesh.rotation.z=Math.atan2(-t.dy,t.dx),t.mesh.scale.set(a,3,1),t.mesh.material.opacity=.9*Math.sin(Math.PI*n)}}spawnMeteor(e){let t=this.meteors.find(e=>e.at<0);if(!t)return;let n=this.skyRng,r=n()<.5?-1:1,i=(.28+n()*.35)*r;t.at=e,t.x=d*(.1+n()*.8),t.y=f*(.05+n()*.35),t.dx=Math.cos(i)*(r>0?1:-1),t.dy=Math.abs(Math.sin(i)),t.dist=380+n()*520,t.len=160+n()*180,t.mesh.visible=!0}render(){this.bloom.enabled?this.composer.render():this.renderer.render(this.scene,this.camera)}disposeMeshes(){let e=[this.nodeMesh,this.haloMesh,this.edgeMesh,this.spikeMesh,this.skyMesh,this.nebula,...this.meteors.map(e=>e.mesh)];for(let t of e){if(!t)continue;t.parent?.remove(t),t.geometry.dispose();let e=t.material;t===this.nebula&&e.map?.dispose(),e.dispose()}this.skyGroup&&this.scene.remove(this.skyGroup),this.nodeMesh=null,this.haloMesh=null,this.edgeMesh=null,this.spikeMesh=null,this.skyMesh=null,this.nebula=null,this.skyGroup=null,this.meteors=[]}dispose(){if(this.disposeMeshes(),this.beacon){this.scene.remove(this.beacon);for(let e of this.beacon.children)e.geometry.dispose();this.beaconMat?.dispose()}this.startMarker&&(this.scene.remove(this.startMarker),this.startMarker.geometry.dispose(),this.startMat?.dispose()),this.composer.dispose(),this.renderer.dispose()}styleEdges(e,t){let n=this.graph,r=this.strainColor.clone().multiplyScalar(.6),i=new G(dl.starLine);for(let e=0;e<n.edges.length;e++){let t=this.sky!==null&&this.edgeSeen[e];this.edgeColor[e].copy(t?i:this.edgeBase[e]),this.edgeWidth[e]=t?zl:this.edgeBaseWidth[e]}if(this.sky){let t=this.strainColor.clone().multiplyScalar(.45);for(let r=0;r<n.edges.length;r++){let i=n.edges[r];e.nodeState[i.a]===0||e.nodeState[i.b]===0||(this.edgeSeen[r]=!0,this.edgeColor[r].copy(t),this.edgeWidth[r]=2.6)}}for(let t=0;t<e.parentEdge.length;t++){let n=e.parentEdge[t];n>=0&&e.nodeState[t]!==0&&(this.edgeColor[n].copy(r),this.edgeWidth[n]=fl.tree)}let a=this.strainColor.clone().lerp(new G(dl.frontier),.45);for(let[n,r]of e.flashes){this.sky&&(this.edgeSeen[n]=!0);let e=1-(t-r)/Ml;e<=0||(this.edgeColor[n].lerp(a,.7*e),this.edgeWidth[n]=Math.max(this.edgeWidth[n],fl.flash*e+fl.base*(1-e)))}if(e.waveAt>=0){let r=this.strainColor.clone().lerp(new G(dl.frontier),.25);for(let i=0;i<n.edges.length;i++){let a=n.edges[i];if(this.sky&&!this.edgeSeen[i])continue;let o=t-Math.max(xl(e,a.a),xl(e,a.b));if(o>=0&&o<300){let e=1-o/300;this.edgeColor[i].lerp(r,.25*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],this.edgeBaseWidth[i]+.8*e)}}}if(e.rippleAt>=0&&e.rippleDepth){let r=this.strainColor.clone().lerp(new G(dl.frontier),.5);for(let i=0;i<n.edges.length;i++){let a=n.edges[i],o=e.rippleDepth[a.a],s=e.rippleDepth[a.b];if(o<0||s<0)continue;let c=t-(e.rippleAt+Math.max(o,s)*50);if(c>=0&&c<300){let e=1-c/300;this.edgeColor[i].lerp(r,.8*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],fl.base+2.4*e)}}}if(e.path&&e.foundAt>=0){let r=Math.floor((t-e.foundAt)/60),i=new G(dl.pathIgnite);for(let t=0;t<Math.min(r,e.path.length-1);t++){let r=e.path[e.path.length-1-t],a=e.path[e.path.length-2-t],o=n.adjacency[r].find(e=>e.node===a);o&&(this.edgeColor[o.edge].copy(i),this.edgeWidth[o.edge]=fl.path)}}this.edgesDirty=!0,this.rewriteEdges()}rewriteEdges(){let e=this.graph;if(!(!e||!this.edgeMesh)){for(let t=0;t<e.edges.length;t++){let n=e.edges[t],r=e.nodes[n.a],i=e.nodes[n.b],a=(r.x+i.x)/2,o=(r.y+i.y)/2;this.dummy.position.set(a,-o,-1),this.dummy.rotation.set(0,0,Math.atan2(-(i.y-r.y),i.x-r.x)),this.dummy.scale.set(n.length,this.edgeWidth[t],1),this.dummy.updateMatrix(),this.edgeMesh.setMatrixAt(t,this.dummy.matrix),this.edgeMesh.setColorAt(t,this.edgeColor[t])}this.dummy.rotation.set(0,0,0),this.edgeMesh.instanceMatrix.needsUpdate=!0,this.edgeMesh.instanceColor&&(this.edgeMesh.instanceColor.needsUpdate=!0),this.edgesDirty=!1}}},eu=[`low`,`medium`,`high`],tu=class{constructor(e=`high`){Y(this,`window`,[]),Y(this,`fastStreak`,0),Y(this,`current`,void 0),this.current=e}get tier(){return this.current}sample(e){this.window.push(e),this.window.length>60&&this.window.shift(),this.fastStreak=e<16?this.fastStreak+1:0;let t=eu.indexOf(this.current);return this.window.length===60&&this.window.reduce((e,t)=>e+t,0)/60>22&&t>0&&(this.current=eu[t-1],this.window=[],this.fastStreak=0),this.fastStreak>=300&&t<eu.length-1&&(this.current=eu[t+1],this.window=[],this.fastStreak=0),this.current}};function nu(e,t,n,r,i,a,o){let s=i/Math.SQRT2,c=Math.ceil(t/s),l=Math.ceil(n/s),u=Math.ceil(a/s),d=Array(c*l).fill(null),f=[],p=[],m=e=>e.x>=o&&e.x<=t-o&&e.y>=o&&e.y<=n-o,h=(e,t)=>{let n=Math.floor(e.x/s),r=Math.floor(e.y/s);for(let i=Math.max(0,r-u);i<=Math.min(l-1,r+u);i++)for(let r=Math.max(0,n-u);r<=Math.min(c-1,n+u);r++){let n=d[i*c+r];if(n!==null&&Math.hypot(f[n].x-e.x,f[n].y-e.y)<t)return!1}return!0},g=e=>{f.push(e),p.push(f.length-1),d[Math.floor(e.y/s)*c+Math.floor(e.x/s)]=f.length-1};for(g({x:t/2,y:n/2});p.length>0;){let t=Math.floor(e()*p.length),n=f[p[t]],i=r(n.x,n.y),a=!1;for(let t=0;t<30;t++){let t=e()*Math.PI*2,o=i*(1+e()),s={x:n.x+Math.cos(t)*o,y:n.y+Math.sin(t)*o};if(m(s)&&h(s,r(s.x,s.y))){g(s),a=!0;break}}a||p.splice(t,1)}return f}function ru(e){let{seed:t,radius:n=70,terrainCell:r=400,terrainStrength:i=2,prune:a=0,mask:o}=e,s=pl(t),c=ml(s,r),l=o?ml(s,o.cell):null,u=nu(s,d,f,l&&o?(e,t)=>n*(1+o.strength*l(e,t)):()=>n,n,n*(1+(o?.strength??0)),60).map((e,t)=>({id:t,x:e.x,y:e.y})),p=[];for(let e=0;e<u.length;e++)for(let t=e+1;t<u.length;t++){let n=u[e],r=u[t],i=(n.x+r.x)/2,a=(n.y+r.y)/2,o=((n.x-r.x)**2+(n.y-r.y)**2)/4,s=!0;for(let n=0;n<u.length;n++){if(n===e||n===t)continue;let r=u[n];if((r.x-i)**2+(r.y-a)**2<o-1e-9){s=!1;break}}s&&p.push([e,t])}a>0&&(p=iu(u.length,p,a,s));let m=[],h=u.map(()=>[]);for(let[e,t]of p){let n=u[e],r=u[t],a=Math.hypot(n.x-r.x,n.y-r.y),o=a*(1+i*c((n.x+r.x)/2,(n.y+r.y)/2)),s=m.length;m.push({id:s,a:e,b:t,length:a,weight:o}),h[e].push({node:t,edge:s}),h[t].push({node:e,edge:s})}return{nodes:u,edges:m,adjacency:h}}function iu(e,t,n,r){let i=Math.floor(t.length*n),a=t.map((e,t)=>t);for(let e=a.length-1;e>0;e--){let t=Math.floor(r()*(e+1));[a[e],a[t]]=[a[t],a[e]]}let o=new Set,s=0;for(let n of a){if(s>=i)break;o.add(n),au(e,t,o,t[n])?s++:o.delete(n)}return t.filter((e,t)=>!o.has(t))}function au(e,t,n,[r,i]){let a=Array.from({length:e},()=>[]);t.forEach(([e,t],r)=>{n.has(r)||(a[e].push(t),a[t].push(e))});let o=new Uint8Array(e);o[r]=1;let s=[r];for(;s.length;){let e=s.pop();if(e===i)return!0;for(let t of a[e])o[t]||(o[t]=1,s.push(t))}return!1}var ou=[{id:`open-sector`,name:`OPEN SECTOR`,tagline:`Flat, cheap terrain. Straight shots win.`,params:{radius:58,terrainCell:400,terrainStrength:.05}},{id:`badlands`,name:`BADLANDS`,tagline:`Vast corrupted zones, half the routes dead. Cheap ground is worth a detour.`,params:{radius:160,terrainCell:1200,terrainStrength:7,prune:.6}},{id:`maze`,name:`THE MAZE`,tagline:`Severed conduits. Few paths thread the labyrinth.`,params:{radius:110,terrainCell:400,terrainStrength:1,prune:.45}},{id:`minefield`,name:`MINEFIELD`,tagline:`Cost spikes everywhere. Caution pays.`,params:{radius:70,terrainCell:170,terrainStrength:4}},{id:`archipelago`,name:`ARCHIPELAGO`,tagline:`Dense clusters, thin bridges. Find the crossings.`,params:{radius:54,terrainCell:400,terrainStrength:.1,mask:{cell:520,strength:2}}}];function su(e){let t=pl(388208^e),n=ou.map((e,t)=>t);for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}function cu(e){let t=ou.length,n=Math.floor(e/t),r=su(n);return n>0&&r[0]===su(n-1)[t-1]&&([r[0],r[1]]=[r[1],r[0]]),ou[r[e%t]]}var lu=(e,t)=>e.kind===`probe`?1:e.kind===`round`?t*2:0,uu=[`ripple`,`tendril`,`miser`,`bloodhound`,`oracle`,`paranoia`],du=[{id:`cover`,name:`FULL COVERAGE`,task:`Touch every node in the sector. Least work wins — there is no beacon to reach.`,metricLabel:`WORK`,eligible:uu,needsTarget:!1},{id:`reach`,name:`FIRST CONTACT`,task:`Reach the beacon. Least work wins.`,metricLabel:`WORK`,eligible:uu,needsTarget:!0},{id:`economy`,name:`CHEAPEST ROUTE`,task:`Find the cheapest route to the beacon. The route is judged, not the speed.`,metricLabel:`ROUTE COST`,eligible:uu,needsTarget:!0}];function fu(e,t,n,r){let i=r.edges.length;if(e.id===`cover`){let e=new Set,a=0;for(let o=0;o<n.ops.length;o++){let s=n.ops[o];if(a+=lu(s,i),s.kind===`visit`&&(e.add(s.node),e.size===r.nodes.length))return{strain:t,run:n,metric:a,tiebreak:0,endIndex:o}}throw Error(`${t} never covered the graph — eligibility/objective bug`)}let a=n.ops.findIndex(e=>e.kind===`found`);if(a<0)throw Error(`${t} emitted no found op on a targeted objective`);let o=0;for(let e=0;e<=a;e++)o+=lu(n.ops[e],i);return e.id===`reach`?{strain:t,run:n,metric:o,tiebreak:n.pathCost,endIndex:a}:{strain:t,run:n,metric:n.pathCost,tiebreak:o,endIndex:a}}function pu(e,t){let n=t=>e.eligible.indexOf(t);return[...t].sort((e,t)=>e.metric-t.metric||e.tiebreak-t.tiebreak||n(e.strain)-n(t.strain))}var mu=class{constructor(){Y(this,`items`,[])}get size(){return this.items.length}push(e,t){let n=this.items;n.push({item:e,priority:t});let r=n.length-1;for(;r>0;){let e=r-1>>1;if(n[e].priority<=n[r].priority)break;[n[e],n[r]]=[n[r],n[e]],r=e}}pop(){let e=this.items;if(e.length===0)return;let t=e[0].item,n=e.pop();if(e.length>0){e[0]=n;let t=0;for(;;){let n=2*t+1,r=n+1,i=t;if(n<e.length&&e[n].priority<e[i].priority&&(i=n),r<e.length&&e[r].priority<e[i].priority&&(i=r),i===t)break;[e[i],e[t]]=[e[t],e[i]],t=i}}return t}};function hu(e,t,n,r,i=n){if(i===null&&(r===`greedy`||r===`astar`))throw Error(`${r} steers by distance-to-beacon — it needs an anchor node`);let a=e.nodes.length,o=r!==`bfs`&&r!==`dfs`,s=(()=>{if(i===null)return()=>0;let t=e.nodes[i].x,n=e.nodes[i].y;return r=>Math.hypot(e.nodes[r].x-t,e.nodes[r].y-n)})(),c=Array(a).fill(1/0),l=Array(a).fill(-1),u=Array(a).fill(!1),d=[],f=new mu,p=0,m=e=>{switch(r){case`bfs`:return p;case`dfs`:return-p;case`dijkstra`:return c[e];case`greedy`:return s(e);case`astar`:return c[e]+s(e)}};for(c[t]=0,d.push({kind:`visit`,node:t,cost:0}),f.push(t,m(t)),p++;f.size>0;){let t=f.pop();if(u[t])continue;if(u[t]=!0,d.push({kind:`settle`,node:t,cost:c[t]}),n!==null&&t===n){let t=[];for(let e=n;e!==-1;e=l[e])t.push(e);t.reverse();let r=gu(e,t);return d.push({kind:`found`,path:t,cost:r}),{ops:d,path:t,pathCost:r,workOps:d.filter(e=>e.kind===`probe`).length}}let r=0;for(let{node:n,edge:i}of e.adjacency[t]){if(u[n])continue;d.push({kind:`probe`,edge:i,from:t,to:n});let a=o?e.edges[i].weight:1,s=c[t]+a;if(s<c[n]){let e=c[n]===1/0;c[n]=s,l[n]=t,d.push(e?{kind:`visit`,node:n,cost:s}:{kind:`improve`,node:n,cost:s}),f.push(n,m(n)),p++,r++}}r===0&&d.push({kind:`deadEnd`,node:t})}if(n!==null)throw Error(`target unreachable — graph invariant violated`);return{ops:d,path:[],pathCost:0,workOps:d.filter(e=>e.kind===`probe`).length}}function gu(e,t){let n=0;for(let r=0;r+1<t.length;r++){let i=e.adjacency[t[r]].find(e=>e.node===t[r+1]);if(!i)throw Error(`path uses a non-edge`);n+=e.edges[i.edge].weight}return n}function _u(e,t,n){let r=e.nodes.length,i=Array(r).fill(1/0),a=Array(r).fill(-1),o=[],s=Array(r).fill(!1);i[t]=0,s[t]=!0,o.push({kind:`visit`,node:t,cost:0});let c=0;for(let t=0;t<r-1;t++){let n=0,r=[];for(let t of e.edges)for(let[e,o]of[[t.a,t.b],[t.b,t.a]])i[e]+t.weight<i[o]&&(i[o]=i[e]+t.weight,a[o]=e,n++,r.push(s[o]?{kind:`improve`,node:o,cost:i[o]}:{kind:`visit`,node:o,cost:i[o]}),s[o]=!0);if(c++,o.push({kind:`round`,index:t,changed:n}),o.push(...r),n===0)break}if(n===null)return{ops:o,path:[],pathCost:0,workOps:c*e.edges.length*2};let l=[];for(let e=n;e!==-1;e=a[e])l.push(e);if(l.reverse(),l[0]!==t)throw Error(`target unreachable — graph invariant violated`);let u=gu(e,l);return o.push({kind:`found`,path:l,cost:u}),{ops:o,path:l,pathCost:u,workOps:c*e.edges.length*2}}var vu=[{id:`ripple`,name:`RIPPLE`,algorithm:`Breadth-First Search`,tagline:`Spreads evenly in every direction. Ignores distance.`,rule:`Always spread from the oldest node it found.`,color:`#38d9ff`},{id:`tendril`,name:`TENDRIL`,algorithm:`Depth-First Search`,tagline:`Follows one path as deep as it can before backtracking.`,rule:`Always spread from the newest node it found.`,color:`#b45cff`},{id:`miser`,name:`MISER`,algorithm:`Dijkstra's Algorithm`,tagline:`Always infects the cheapest reachable node next. Thorough but slow.`,rule:`Always spread from the cheapest node it can reach.`,color:`#ffd23e`},{id:`bloodhound`,name:`BLOODHOUND`,algorithm:`Greedy Best-First`,tagline:`Smells the target and beelines. Fast, but easily fooled.`,rule:`Always spread from the node nearest the beacon.`,color:`#ff5c7a`},{id:`oracle`,name:`ORACLE`,algorithm:`A* Search`,tagline:`Miser's caution + Bloodhound's nose. The smart one.`,rule:`Balance the cost already paid against the distance still to go.`,color:`#5cff9d`},{id:`paranoia`,name:`PARANOIA`,algorithm:`Bellman-Ford`,tagline:`Re-checks everything, over and over. Wasteful… but never wrong.`,rule:`Recheck every link in the sector. Then do it again.`,color:`#ff8c38`}],yu={ripple:`bfs`,tendril:`dfs`,miser:`dijkstra`,bloodhound:`greedy`,oracle:`astar`};function bu(e,t,n,r,i=r){return e===`paranoia`?_u(t,n,r):hu(t,n,r,yu[e],i)}var xu={id:`patient-zero`,name:`PATIENT ZERO`,tagline:`Every outbreak starts with someone.`,params:{radius:70,terrainCell:400,terrainStrength:0}},Su=(e,t=0)=>Array.from({length:e-1},(e,n)=>[t+n,t+n+1]),Cu={w:330,stars:[[.08,0],[.07,.17],[.08,.36],[.07,.5],[.08,.68],[.07,.85],[.08,1],[.42,.02],[.75,.07],[.94,.22],[.86,.4],[.58,.49],[.52,.53],[.86,.61],[.99,.78],[.86,.95],[.5,1]],lines:[...Su(7),[0,7],[7,8],[8,9],[9,10],[10,11],[11,3],[3,12],[12,13],[13,14],[14,15],[15,16],[16,6]],entry:6,exit:14};function wu(e){let t=e.map(e=>{let t=e*Math.PI/180;return[.5+.5*Math.cos(t),.5+.5*Math.sin(t)]}),n=e.length,r=e.map((e,t)=>[t,(t+1)%n]),i=r.filter(([e,n])=>t[e][1]+t[n][1]<1),a=t.map(e=>e[0]);return{w:380,stars:t,lines:r,entry:a.indexOf(Math.min(...a)),exit:a.indexOf(Math.max(...a)),costly:i}}var Tu=wu([0,28,52,85,112,140,172,198,228,258,284,310,336]),Eu=wu([12,40,70,96,124,152,180,206,236,266,296,322,348]),Du=[Cu,Tu,{w:330,stars:[[.92,.12],[.72,.02],[.42,0],[.16,.09],[.05,.27],[.16,.43],[.44,.5],[.72,.56],[.93,.7],[.88,.89],[.62,1],[.32,.99],[.07,.88]],lines:Su(13),entry:12,exit:0},{w:340,stars:[[0,.04],[.26,.01],[.5,0],[.74,.02],[1,.05],[.52,.24],[.49,.5],[.51,.76],[.5,1]],lines:[...Su(5),[2,5],[5,6],[6,7],[7,8]],entry:0,exit:4},Eu,{w:380,stars:[[.05,1],[.06,.76],[.05,.5],[.06,.25],[.05,0],[.27,.25],[.5,.5],[.73,.75],[.95,1],[.94,.75],[.95,.5],[.94,.25],[.95,0]],lines:[...Su(5),[4,5],[5,6],[6,7],[7,8],...Su(5,8)],entry:2,exit:12}],Ou=52,ku=260,Au=700,ju=2.4,Mu=1.8,Nu=1400;function Pu(e){let t=pl((e^358997)>>>0),n=e=>(t()*2-1)*e,r=(d-(Du.reduce((e,t)=>e+t.w,0)+Ou*(Du.length-1)))/2,i=[],a=[],o=[];for(let e of Du){let t=i.length;o.push(t);for(let[t,a]of e.stars)i.push({id:i.length,x:r+t*e.w+n(8),y:ku+a*Au+n(12)});let s=new Set((e.costly??[]).map(([e,t])=>`${e}-${t}`));for(let[n,r]of e.lines)a.push({a:t+n,b:t+r,cost:s.has(`${n}-${r}`)?Mu:1});r+=e.w+Ou}for(let e=0;e+1<Du.length;e++)a.push({a:o[e]+Du[e].exit,b:o[e+1]+Du[e+1].entry,cost:ju});let s=[],c=i.map(()=>[]);for(let{a:e,b:t,cost:n}of a){let r=i[e],a=i[t],o=Math.hypot(r.x-a.x,r.y-a.y),l=s.length;s.push({id:l,a:e,b:t,length:o,weight:o*n}),c[e].push({node:t,edge:l}),c[t].push({node:e,edge:l})}let l=[];for(let e=0;e<Nu;e++){let e=t(),n=t();l.push({x:-40+t()*(d+80),y:-40+t()*(f+80),b:.07+.93*e*e*e*e,tint:n*n,phase:t()*Math.PI*2,speed:.4+t()*1.4})}let u=i.map(()=>.6+t()*.8),p=i.map(()=>{let e=t();return e*e}),m=i.map(()=>t()*Math.PI*2);return{graph:{nodes:i,edges:s,adjacency:c},start:o[0]+Du[0].entry,beacon:o[Du.length-1]+Du[Du.length-1].exit,sky:{seed:e,field:l,mag:u,tint:p,phase:m}}}var Fu=`cover`,Iu=.2;function Lu(e,t,n){let r=0,i=1/0;for(let a of e.nodes){let e=(a.x-t)**2+(a.y-n)**2;e<i&&(i=e,r=a.id)}return r}var Ru=728775;function zu(e){let t=du.length,n=pl((Ru^Math.floor(e/t))>>>0),r=du.map((e,t)=>t);for(let e=r.length-1;e>0;e--){let t=Math.floor(n()*(e+1));[r[e],r[t]]=[r[t],r[e]]}return du[r[e%t]]}function Bu(e,t,n){let r=ru({seed:e,...t.params}),i=Lu(r,d*.12,f*.5),a=Lu(r,d*.88,f*.5),o=n.needsTarget?a:null,s=pu(n,n.eligible.map(e=>fu(n,e,bu(e,r,i,o,a),r)));return{seed:e,archetype:t,objective:n,graph:r,start:i,beacon:a,target:o,outcomes:s,winner:s[0].strain,sky:null,pace:1}}function Vu(e){let t=du.find(e=>e.id===Fu),{graph:n,start:r,beacon:i,sky:a}=Pu(e),o=pu(t,t.eligible.map(e=>fu(t,e,bu(e,n,r,null,i),n)));return{seed:e,archetype:xu,objective:t,graph:n,start:r,beacon:i,target:null,outcomes:o,winner:o[0].strain,sky:a,pace:Iu}}function Hu(e,t=null){if(t?.archetype===xu.id)return Vu(2*e+1);let n=t?ou.find(e=>e.id===t.archetype):cu(e),r=t?du.find(e=>e.id===t.objective):zu(e),i;for(let t=0,a=2*e+1;t<5;t++,a+=2)try{return Bu(a,n,r)}catch(e){i=e}throw i}function Uu(e,t,n){if(n===0)return e;let r=t/n;return e*(1+2*r*r)}var Wu=class{constructor(e,t,n=!1,r=48){Y(this,`budget`,0),Y(this,`index`,0),Y(this,`ops`,void 0),Y(this,`opsPerSecond`,void 0),Y(this,`ramp`,void 0),Y(this,`roundTicks`,void 0),this.ops=e,this.opsPerSecond=t,this.ramp=n,this.roundTicks=r}get done(){return this.index>=this.ops.length}get consumed(){return this.index}rate(){return this.ramp?Uu(this.opsPerSecond,this.index,this.ops.length):this.opsPerSecond}msPerTick(){return 1e3/this.rate()}roundMs(){return this.roundTicks*this.msPerTick()}advance(e){this.budget+=e/1e3*this.rate();let t=[];for(;!this.done;){let e=this.ops[this.index],n=e.kind===`round`?this.roundTicks:1;if(this.budget<n)break;if(this.budget-=n,this.index++,t.push(e),e.kind===`round`)for(;!this.done&&this.ops[this.index].kind!==`round`&&this.ops[this.index].kind!==`found`;)t.push(this.ops[this.index]),this.index++}return t}},Gu={archetype:xu.id,objective:`cover`};function Ku(){return{phase:`attract`,sectorIndex:0,rematch:!1,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0,pick:null,pickFocus:{archetype:0,objective:0},pickReturn:`reveal`,secretIntro:!1}}function qu(e,t){switch(t.type){case`idle`:return e.phase===`attract`?e:{...Ku(),sectorIndex:e.sectorIndex+1};case`wake`:return e.phase===`attract`?{...e,phase:`reveal`,rematch:!1,strain:null,strainFocus:0,menuFocus:0}:e;case`revealDone`:return e.phase===`reveal`?{...e,phase:`select`,menuFocus:0,secretIntro:!1}:e;case`focusMenu`:return e.phase===`reveal`||e.phase===`select`||e.phase===`leaderboard`?{...e,menuFocus:t.index}:e;case`backToReveal`:return e.phase===`select`?{...e,phase:`reveal`,mapPeek:!1,menuFocus:0}:e;case`focusStrain`:return e.phase===`select`?{...e,strainFocus:t.index}:e;case`toggleMapPeek`:return e.phase===`select`?{...e,mapPeek:!e.mapPeek}:e;case`chooseStrain`:return e.phase===`select`?{...e,phase:`run`,strain:t.strain,mapPeek:!1}:e;case`runDone`:return e.phase===`run`?{...e,phase:`leaderboard`,menuFocus:0}:e;case`rematch`:return e.phase===`leaderboard`?{...e,phase:`select`,rematch:!0,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0}:e;case`nextSector`:return e.phase===`leaderboard`?{...e,phase:`reveal`,sectorIndex:e.sectorIndex+1,rematch:!1,strain:null,strainFocus:0,pick:null,menuFocus:0}:e;case`openMapPick`:return e.phase===`reveal`||e.phase===`leaderboard`?{...e,phase:`mapPick`,pickReturn:e.phase,pickFocus:t.focus,secretIntro:!1}:e;case`focusMap`:return e.phase===`mapPick`?{...e,pickFocus:t.focus}:e;case`chooseMap`:return e.phase===`mapPick`?{...e,phase:`reveal`,pick:t.pick,rematch:!1,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0,sectorIndex:e.pickReturn===`leaderboard`?e.sectorIndex+1:e.sectorIndex}:e;case`closeMapPick`:return e.phase===`mapPick`?{...e,phase:e.pickReturn}:e;case`konami`:return{...Ku(),sectorIndex:e.sectorIndex+1,phase:`reveal`,pick:Gu,secretIntro:!0}}}function Ju(e,t=6){return{strainIndex:(e.strainIndex+1)%t}}var Yu=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),Q=e(((e,t)=>{t.exports=Yu()}))(),Xu={ripple:`M60 60 m-12 0 a12 12 0 1 0 24 0 a12 12 0 1 0 -24 0 M60 60 m-28 0 a28 28 0 1 0 56 0 a28 28 0 1 0 -56 0 M60 60 m-44 0 a44 44 0 1 0 88 0 a44 44 0 1 0 -88 0`,tendril:`M16 100 C 30 20, 50 20, 55 60 S 70 110, 80 70 S 95 20, 104 28`,miser:`M60 60 L16 40 M60 60 L30 95 M60 60 L60 14 M60 60 L95 90 M60 60 L104 45 M60 60 L85 20`,bloodhound:`M16 95 L104 25 M104 25 l-18 2 M104 25 l-4 17`,oracle:`M16 95 Q 45 80 60 60 T 104 25 M104 25 l-18 2 M104 25 l-4 17`,paranoia:`M16 40 H104 M16 60 H104 M16 80 H104 M20 30 Q 60 20 100 30`};function Zu(e){return(0,Q.jsxs)(`div`,{className:`strain-screen`,children:[(0,Q.jsxs)(`div`,{className:`strain-header`,children:[(0,Q.jsx)(`h1`,{children:e.rematch?`SAME MAP — NEW CALL`:`WHO WINS THIS SECTOR?`}),(0,Q.jsxs)(`div`,{className:`strain-sub`,children:[e.objectiveName,` — choose the strain you think wins`]}),(0,Q.jsx)(`button`,{className:`peek-btn${e.peekFocused?` focused`:``}`,onMouseEnter:e.onFocusPeek,onClick:e.onPeek,children:`view the map`})]}),(0,Q.jsx)(`div`,{className:`strain-row`,children:e.strains.map((t,n)=>(0,Q.jsxs)(`button`,{className:`strain-card${n===e.focus&&!e.peekFocused?` focused`:``}`,style:{"--accent":t.color},onMouseEnter:()=>e.onFocus(n),onClick:()=>e.onChoose(t.id),children:[(0,Q.jsx)(`h2`,{children:t.name}),(0,Q.jsx)(`div`,{className:`algo`,children:t.algorithm}),(0,Q.jsx)(`svg`,{className:`preview`,viewBox:`0 0 120 120`,children:(0,Q.jsx)(`path`,{d:Xu[t.id],fill:`none`,stroke:t.color,strokeWidth:`3`,strokeLinecap:`round`})}),(0,Q.jsx)(`div`,{className:`tagline`,children:t.tagline})]},t.id))}),(0,Q.jsxs)(`div`,{className:`screen-legend`,children:[(0,Q.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,Q.jsx)(`b`,{children:`▲`}),` view the map `,(0,Q.jsx)(`b`,{children:`A`}),` select `,(0,Q.jsx)(`b`,{children:`B`}),` back`]})]})}function Qu(e){return(0,Q.jsxs)(`div`,{className:`run-hud`,style:{"--accent":e.color??`#38d9ff`},children:[(0,Q.jsx)(`div`,{className:`strain-tag`,children:e.strainName}),(0,Q.jsxs)(`div`,{className:`run-rule`,children:[(0,Q.jsx)(`span`,{children:`RULE`}),` `,e.rule]}),(0,Q.jsxs)(`div`,{className:`run-metric`,children:[e.metricLabel,` `,(0,Q.jsx)(`b`,{children:e.metricValue})]}),e.pass&&(0,Q.jsxs)(`div`,{className:`run-pass`,children:[`PASS `,e.pass.index+1,` — `,e.done&&e.pass.changed===0?`NOTHING CHANGED. DONE.`:`${e.pass.changed} ROUTES IMPROVED`]}),e.found&&(0,Q.jsx)(`div`,{className:`run-found`,children:`TARGET REACHED`})]})}function $u(e){let t=[{label:`Choose your strain`,go:e.onContinue},{label:`Different sector`,go:e.onPickMap}];return(0,Q.jsxs)(`div`,{className:`reveal-card${e.secret?` reveal-secret`:``}${e.intro?` reveal-intro`:``}`,children:[e.secret&&(0,Q.jsx)(`div`,{className:`reveal-eyebrow`,children:`UNLISTED SECTOR — ACCESS GRANTED`}),(0,Q.jsx)(`div`,{className:`reveal-archetype`,children:e.archetypeName}),(0,Q.jsx)(`div`,{className:`reveal-tagline`,children:e.tagline}),(0,Q.jsxs)(`div`,{className:`reveal-objective`,children:[`OBJECTIVE — `,e.objectiveName]}),(0,Q.jsx)(`div`,{className:`reveal-task`,children:e.task}),(0,Q.jsx)(`div`,{className:`reveal-hint`,children:e.secret?`the name is written in the stars — trace it`:`reading the ground is half the game`}),(0,Q.jsx)(`div`,{className:`reveal-continue`,children:t.map((t,n)=>(0,Q.jsx)(`button`,{className:n===e.focus?`focused`:void 0,onMouseEnter:()=>e.onFocus(n),onClick:t.go,children:t.label},t.label))}),(0,Q.jsxs)(`div`,{className:`screen-legend`,children:[(0,Q.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,Q.jsx)(`b`,{children:`A`}),` select`]})]})}function ed(){return(0,Q.jsxs)(`div`,{className:`cost-legend`,children:[(0,Q.jsx)(`span`,{className:`legend-title`,children:`LINK COST`}),(0,Q.jsx)(`span`,{className:`legend-end`,children:`CHEAP`}),(0,Q.jsx)(`div`,{className:`bar`}),(0,Q.jsx)(`span`,{className:`legend-end`,children:`COSTLY`})]})}var td={cover:{ripple:`Even rings waste nothing — RIPPLE touched the last node while the others were still doubling back across {ARCH}.`,tendril:`TENDRIL threaded {ARCH} corridor by corridor and hit the final pocket early.`,miser:`Cheapest ground first meant no wasted probes — MISER covered {ARCH} on a budget.`,bloodhound:`BLOODHOUND ran flat-out for the far side of {ARCH} and swept the whole sector almost by accident.`,oracle:`ORACLE's pull toward the far side lined up with how {ARCH} is laid out, and its cost-first half did the rest.`,paranoia:`One brute-force sweep touched nearly everything at once — on {ARCH}, PARANOIA's excess was actually efficient.`},reach:{ripple:`No terrain worth exploiting on {ARCH} — RIPPLE's steady rings reached the beacon without detours.`,tendril:`A corridor ran straight to the beacon — TENDRIL's all-in lunge paid off on {ARCH}.`,miser:`The others drowned in costly ground — MISER rode the cheap channels of {ARCH} to the beacon.`,bloodhound:`Open ground, clear scent — BLOODHOUND beelined across {ARCH} while the careful ones checked receipts.`,oracle:`Cost so far plus distance to go — ORACLE read {ARCH} and spent almost nothing it didn't have to.`,paranoia:`Every rival wandered into expensive dead ends — on {ARCH}, even PARANOIA's full sweeps came out ahead.`},economy:{ripple:`On this flat stretch of {ARCH} the fewest hops IS the cheapest route — RIPPLE tied the optimum with less work.`,tendril:`TENDRIL's single thread through {ARCH} happened to be the cheap one.`,miser:`MISER never pays more than it must — the guaranteed-cheapest route through {ARCH}.`,bloodhound:`The straight shot across {ARCH} was also the cheap one — BLOODHOUND's rush cost nothing extra.`,oracle:`ORACLE found the same unbeatable route MISER did, and its nose for the beacon meant it checked far less of {ARCH} to get there.`,paranoia:`PARANOIA re-checked every connection in {ARCH} until only the truly cheapest route remained.`}};function nd(e,t,n){return(td[e][n]??`${n.toUpperCase()} simply fit this ground best.`).replaceAll(`{ARCH}`,t)}var rd={ripple:`RIPPLE counts hops, never cost — it fanned out evenly in every direction and paid for ground it never needed.`,tendril:`TENDRIL always chases its newest lead — it committed to one corridor and had to back all the way out.`,miser:`MISER only ever takes the cheapest node next, and nothing in that rule points at the beacon — so it searched the sector in every direction at once.`,bloodhound:`BLOODHOUND runs at whatever looks closest to the beacon and never checks what a link costs — the direct line ran straight through expensive ground.`,oracle:`ORACLE weighs cost paid against distance left before every single move — careful, but on ground this open the caution cost more than it saved.`,paranoia:`PARANOIA rechecks every link in the sector on every pass — never wrong, but it pays full price for that certainty.`},id={cover:{ripple:`RIPPLE widens one even ring at a time — when the job is simply to touch everything, that tidy order probed more links than it had to.`,tendril:`TENDRIL dives down one path to its very end before trying anything else — collecting the last few stragglers is what cost it.`,miser:`MISER sorts every step by cost, but this objective never asked about cost — that careful ordering bought nothing and probed more to get it.`,bloodhound:`BLOODHOUND only knows one move: run at the beacon. There was no beacon to reach here — it sprinted for the far side anyway and then had to crawl back for everything it skipped.`,oracle:`ORACLE aims every step at a beacon. A sharp aim is worthless when the job is to touch everything, so its best instinct pulled it away from the corners it still had to cover.`,paranoia:`PARANOIA sweeps every link in the sector on every pass — it does touch everything, but it pays for the whole map several times over to be sure.`},economy:{ripple:`RIPPLE counts hops, never cost — it found a route with few links, but those links were the expensive kind.`,tendril:`TENDRIL commits to the first path it stumbles into — it delivered a route, but nothing in its rule ever asked what that route cost.`,miser:`MISER always takes the cheapest node next, which is exactly what this objective rewards — it gave up ground on work, not on price.`,oracle:`ORACLE splits its attention between cost paid and distance left — the distance half pulled it toward routes that looked short and priced badly.`}};function ad(e,t,n,r){let i=e===`economy`,a=n>0?t/n:1/0;if(a>=2&&Number.isFinite(a)){let e=a>=10?String(Math.round(a)):a.toFixed(1).replace(/\.0$/,``);return i?`That route cost ${e}× what ${r} paid.`:`That came to ${e}× the work ${r} did.`}let o=Math.round((a-1)*100);return o<1?i?`It came in a hair dearer than ${r}'s route.`:`It came in a hair above ${r} on work.`:i?`That route cost ${o}% more than ${r}'s.`:`That took ${o}% more work than ${r}.`}function od(e,t,n){let r=t[0],i=t.find(e=>e.strain===n);if(!r||!i||i.strain===r.strain)return null;let a=r.strain.toUpperCase();return i.metric===r.metric?`Nothing wrong with ${n.toUpperCase()}'s answer — it matched the winner exactly. ${a} just got there doing less work.`:`${id[e]?.[n]??rd[n]} ${ad(e,i.metric,r.metric,a)}`}function sd(e){let{round:t,pick:n}=e,r=[{label:`Next sector`,go:e.onNext},{label:`Rematch — same map, new strain`,go:e.onRematch},{label:`Choose a sector`,go:e.onPickMap}],i=e=>Math.round(e).toLocaleString(),a=od(t.objective.id,t.outcomes,n);return(0,Q.jsxs)(`div`,{className:`board-panel`,children:[(0,Q.jsxs)(`div`,{className:`board-title`,children:[t.objective.name,` — RESULTS`]}),(0,Q.jsx)(`div`,{className:`board-rows`,children:t.outcomes.map((e,r)=>{let a=vu.find(t=>t.id===e.strain);return(0,Q.jsxs)(`div`,{className:`board-row${e.strain===n?` picked`:``}${r===0?` winner`:``}`,style:{"--accent":a.color},children:[(0,Q.jsx)(`span`,{className:`rank`,children:r+1}),(0,Q.jsx)(`span`,{className:`name`,children:a.name}),(0,Q.jsxs)(`span`,{className:`metric`,children:[t.objective.metricLabel,` `,i(e.metric)]}),e.strain===n&&(0,Q.jsx)(`span`,{className:`call`,children:r===0?`CALLED IT ✓`:`YOUR PICK`})]},e.strain)})}),(0,Q.jsx)(`div`,{className:`board-why`,children:nd(t.objective.id,t.archetype.name,t.winner)}),a&&(0,Q.jsxs)(`div`,{className:`board-loss`,style:{"--accent":vu.find(e=>e.id===n).color},children:[(0,Q.jsx)(`span`,{className:`board-loss-tag`,children:`YOUR CALL`}),` `,a]}),(0,Q.jsx)(`div`,{className:`board-actions`,children:r.map((t,n)=>(0,Q.jsx)(`button`,{className:n===e.focus?`focused`:void 0,onMouseEnter:()=>e.onFocus(n),onClick:t.go,children:t.label},t.label))}),(0,Q.jsxs)(`div`,{className:`screen-legend`,children:[(0,Q.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,Q.jsx)(`b`,{children:`A`}),` select`]})]})}function cd(e){let t=vu.find(t=>t.id===e.pick),n=e.round.outcomes.find(t=>t.strain===e.pick),r=[{label:`Choose a sector`,go:e.onPickMap},{label:`Next sector`,go:e.onNext}];return(0,Q.jsxs)(`div`,{className:`sky-end`,style:{"--accent":t.color},children:[(0,Q.jsx)(`div`,{className:`sky-end-eyebrow`,children:`TRANSMISSION — PATIENT ZERO`}),(0,Q.jsx)(`h1`,{children:`EVERY STAR LIT`}),(0,Q.jsxs)(`div`,{className:`sky-end-stat`,children:[(0,Q.jsx)(`b`,{children:t.name}),` traced the whole name — `,e.round.graph.nodes.length,` stars, work `,Math.round(n.metric).toLocaleString(),`.`]}),(0,Q.jsx)(`div`,{className:`sky-end-note`,children:`This sector is on no chart, and nobody told you it was here. That is exactly how every outbreak starts.`}),(0,Q.jsx)(`div`,{className:`sky-end-sign`,children:`— patient zero`}),(0,Q.jsx)(`div`,{className:`board-actions`,children:r.map((t,n)=>(0,Q.jsx)(`button`,{className:n===e.focus?`focused`:void 0,onMouseEnter:()=>e.onFocus(n),onClick:t.go,children:t.label},t.label))}),(0,Q.jsxs)(`div`,{className:`screen-legend`,children:[(0,Q.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,Q.jsx)(`b`,{children:`A`}),` select`]})]})}var ld={cover:(0,Q.jsx)(Q.Fragment,{children:[16,40,64,88,112].flatMap(e=>[18,40,62].map(t=>(0,Q.jsx)(`circle`,{cx:e,cy:t,r:e===16&&t===40?6:3.5},`${e}-${t}`)))}),reach:(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`circle`,{cx:`16`,cy:`40`,r:`6`}),(0,Q.jsx)(`path`,{d:`M22 40 H100`,strokeDasharray:`6 5`}),(0,Q.jsx)(`circle`,{cx:`112`,cy:`40`,r:`7`,fill:`none`}),(0,Q.jsx)(`circle`,{cx:`112`,cy:`40`,r:`12`,fill:`none`,opacity:`0.5`})]}),economy:(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`circle`,{cx:`16`,cy:`40`,r:`6`}),(0,Q.jsx)(`path`,{d:`M22 40 C 40 40, 44 16, 62 16 S 84 60, 100 44`,fill:`none`}),(0,Q.jsx)(`circle`,{cx:`112`,cy:`40`,r:`7`,fill:`none`}),(0,Q.jsx)(`circle`,{cx:`112`,cy:`40`,r:`12`,fill:`none`,opacity:`0.5`})]})};function ud(e){let t=ou[e.focus.archetype],n=du[e.focus.objective];return(0,Q.jsxs)(`div`,{className:`pick-screen`,children:[(0,Q.jsxs)(`div`,{className:`pick-header`,children:[(0,Q.jsx)(`h1`,{children:`CHOOSE YOUR SECTOR`}),(0,Q.jsx)(`div`,{className:`pick-sub`,children:`any ground, any objective — or let NEXT SECTOR deal the rotation`})]}),(0,Q.jsxs)(`div`,{className:`pick-grid`,style:{gridTemplateColumns:`300px repeat(${ou.length}, 1fr)`},children:[(0,Q.jsx)(`div`,{className:`pick-corner`}),ou.map((t,n)=>(0,Q.jsxs)(`div`,{className:`pick-col${n===e.focus.archetype?` focused`:``}`,children:[(0,Q.jsx)(`b`,{children:t.name}),(0,Q.jsx)(`span`,{children:t.tagline})]},t.id)),du.map((t,n)=>(0,Q.jsx)(dd,{objective:t,r:n,...e},t.id))]}),(0,Q.jsxs)(`div`,{className:`pick-detail`,children:[(0,Q.jsxs)(`b`,{children:[t.name,` — `,n.name]}),` `,n.task]}),(0,Q.jsxs)(`div`,{className:`screen-legend`,children:[(0,Q.jsx)(`b`,{children:`◀ ▶ ▲ ▼`}),` move `,(0,Q.jsx)(`b`,{children:`A`}),` play this sector`,(0,Q.jsxs)(`button`,{className:`legend-btn`,onClick:e.onBack,children:[(0,Q.jsx)(`b`,{children:`B`}),` back`]})]})]})}function dd(e){let{objective:t,r:n}=e;return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`div`,{className:`pick-row${n===e.focus.objective?` focused`:``}`,children:(0,Q.jsx)(`b`,{children:t.name})}),ou.map((r,i)=>{let a=i===e.focus.archetype&&n===e.focus.objective,o=r.id===e.current.archetype&&t.id===e.current.objective;return(0,Q.jsxs)(`button`,{className:`pick-cell${a?` focused`:``}${o?` current`:``}`,onMouseEnter:()=>e.onFocus({archetype:i,objective:n}),onClick:()=>e.onChoose({archetype:r.id,objective:t.id}),children:[(0,Q.jsx)(`svg`,{viewBox:`0 0 128 80`,fill:`currentColor`,stroke:`currentColor`,strokeWidth:`3`,strokeLinecap:`round`,children:ld[t.id]}),o&&(0,Q.jsx)(`span`,{className:`now`,children:`THIS SECTOR`})]},r.id)})]})}var fd=[[12,`up`],[13,`down`],[14,`left`],[15,`right`],[0,`confirm`],[1,`back`]],pd=.6,md=.35;function hd(e,t){let n=e.buttons.slice(),r=e.axes[0]??0,i=e.axes[1]??0,a=(e,n)=>t[e]?n>md:n>pd;return n[12]=n[12]||a(12,-i),n[13]=n[13]||a(13,i),n[14]=n[14]||a(14,-r),n[15]=n[15]||a(15,r),n}function gd(e,t){return fd.filter(([n])=>t[n]&&!e[n]).map(([,e])=>e)}function _d(){let e=[...navigator.getGamepads?navigator.getGamepads():[]].find(e=>e);return e?{buttons:e.buttons.map(e=>e.pressed),axes:[...e.axes]}:{buttons:Array(16).fill(!1),axes:[0,0,0,0]}}var vd=[`left`,`right`,`up`,`down`,`confirm`,`back`];function $(e){let t=e??(typeof location>`u`?``:location.search),n=new URLSearchParams(t);return n.has(`ftMsgUrl`)||n.get(`ftmsg`)===`1`}function yd(e){if(!e||typeof e!=`object`)return null;let t=e;return t.type===`pad`?vd.find(e=>e===t.action)??null:null}function bd(e,t){if(!(t?.enabled??$()))return()=>{};let n=globalThis.FootronMessaging;if(!n||typeof n.Messaging!=`function`)return console.warn(`[phone] footron messaging client not loaded; phone controls are off`),()=>{};let r=new n.Messaging,i=t=>{let n=yd(t);n&&e.onAction(n)},a=()=>e.onConnect?.();return r.addMessageListener(i),r.addConnectionListener(a),r.mount(),()=>{r.removeMessageListener(i),r.removeConnectionListener(a),r.unmount()}}var xd=[`up`,`up`,`down`,`down`,`left`,`right`,`left`,`right`,`confirm`,`back`];function Sd(e=xd){let t=[],n=()=>{for(let n=Math.min(t.length,e.length);n>0;n--){let r=!0;for(let i=0;i<n;i++)if(t[t.length-n+i]!==e[i]){r=!1;break}if(r)return n}return 0};return{press(r){t.push(r),t.length>e.length&&(t=t.slice(-e.length));let i=n();return i===e.length?(t=[],`fire`):i===e.length-1?`hold`:`pass`},progress:()=>n()}}function Cd(e){let[t,n]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=0,r=()=>{window.clearTimeout(t),n(!0),t=window.setTimeout(()=>n(!1),e)};return window.addEventListener(`gamepadconnected`,r),()=>{window.clearTimeout(t),window.removeEventListener(`gamepadconnected`,r)}},[e]),t}function wd(e,t){let n=(0,l.useRef)(0),r=(0,l.useRef)(e);r.current=e;let i=(0,l.useRef)(()=>{window.clearTimeout(n.current),n.current=window.setTimeout(()=>r.current(),t)}).current;return(0,l.useEffect)(()=>(i(),window.addEventListener(`pointerdown`,i),window.addEventListener(`pointermove`,i),()=>{window.clearTimeout(n.current),window.removeEventListener(`pointerdown`,i),window.removeEventListener(`pointermove`,i)}),[]),i}function Td(e,t,n){return t===`left`||t===`up`?Math.max(0,e-1):t===`right`||t===`down`?Math.min(n,e+1):e}function Ed(e){return{archetype:Math.max(0,ou.findIndex(t=>t.id===e.archetype.id)),objective:Math.max(0,du.findIndex(t=>t.id===e.objective.id))}}function Dd(){let[e,t]=(0,l.useState)({scale:1,x:0,y:0});return(0,l.useEffect)(()=>{let e=()=>{let e=Math.min(window.innerWidth/d,window.innerHeight/f);t({scale:e,x:(window.innerWidth-d*e)/2,y:(window.innerHeight-f*e)/2})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),e}function Od(){let e=Dd(),t=(0,l.useRef)(null),n=(0,l.useRef)(null),[r,i]=(0,l.useReducer)(qu,void 0,Ku),[a,o]=(0,l.useState)({strainIndex:0}),s=(0,l.useRef)(r);(0,l.useEffect)(()=>{s.current=r},[r]);let c=wd(()=>i({type:`idle`}),m),u=Cd(g),_=(0,l.useMemo)(()=>Hu(r.sectorIndex,r.pick),[r.sectorIndex,r.pick]),v=(0,l.useRef)(_);(0,l.useEffect)(()=>{v.current=_},[_]);let y=(0,l.useMemo)(()=>_.objective.eligible.map(e=>vu.find(t=>t.id===e)),[_]),b=vu.find(e=>e.id===r.strain)??null,x=(0,l.useRef)(null),S=(0,l.useRef)(null),[C,w]=(0,l.useState)({work:0,visited:0,found:!1,pass:null,done:!1}),T=(0,l.useRef)(Array(16).fill(!1)),E=(0,l.useRef)(y);(0,l.useEffect)(()=>{E.current=y},[y]);let D=(0,l.useRef)(Sd()),O=e=>{c();let t=D.current.press(e);if(t===`fire`){i({type:`konami`});return}if(t===`hold`)return;let n=s.current;switch(n.phase){case`attract`:i({type:`wake`});break;case`reveal`:{let t=Td(n.menuFocus,e,1);t!==n.menuFocus&&i({type:`focusMenu`,index:t}),e===`confirm`&&(n.menuFocus===0?i({type:`revealDone`}):k());break}case`select`:{if(n.mapPeek){i({type:`toggleMapPeek`});break}if(e===`back`){i({type:`backToReveal`});break}if(e===`up`){i({type:`focusMenu`,index:1});break}if(e===`down`){i({type:`focusMenu`,index:0});break}if(n.menuFocus===1){e===`confirm`&&i({type:`toggleMapPeek`});break}let t=E.current.length-1;e===`left`&&i({type:`focusStrain`,index:Math.max(0,n.strainFocus-1)}),e===`right`&&i({type:`focusStrain`,index:Math.min(t,n.strainFocus+1)}),e===`confirm`&&i({type:`chooseStrain`,strain:E.current[Math.min(n.strainFocus,t)].id});break}case`run`:break;case`leaderboard`:{let t=v.current.sky!==null,r=Td(n.menuFocus,e,t?1:2);r!==n.menuFocus&&i({type:`focusMenu`,index:r}),e===`confirm`&&(t?n.menuFocus===0?k():i({type:`nextSector`}):n.menuFocus===0?i({type:`nextSector`}):n.menuFocus===1?i({type:`rematch`}):k());break}case`mapPick`:{let t=n.pickFocus,r=(e,n)=>i({type:`focusMap`,focus:{archetype:Math.max(0,Math.min(ou.length-1,t.archetype+e)),objective:Math.max(0,Math.min(du.length-1,t.objective+n))}});e===`left`&&r(-1,0),e===`right`&&r(1,0),e===`up`&&r(0,-1),e===`down`&&r(0,1),e===`confirm`&&i({type:`chooseMap`,pick:{archetype:ou[t.archetype].id,objective:du[t.objective].id}}),e===`back`&&i({type:`closeMapPick`});break}}},k=()=>i({type:`openMapPick`,focus:Ed(v.current)});(0,l.useEffect)(()=>bd({onAction:O,onConnect:()=>{c(),s.current.phase===`attract`&&i({type:`wake`})}}),[]),(0,l.useEffect)(()=>{let e=new $l(t.current);return n.current=e,()=>{e.dispose(),n.current=null}},[]),(0,l.useEffect)(()=>{n.current?.setField(_.graph,_.sky),n.current?.setTarget(_.target),n.current?.setStart(_.start)},[_]),(0,l.useEffect)(()=>{n.current?.setRenderScale(e.scale*window.devicePixelRatio)},[e.scale]),(0,l.useEffect)(()=>{r.phase===`reveal`&&n.current?.clearRun()},[r.phase]),(0,l.useEffect)(()=>{if(r.phase!==`run`||!r.strain)return;let e=_.outcomes.find(e=>e.strain===r.strain);return x.current=new Wu(e.run.ops.slice(0,e.endIndex+1),90*_.pace,!0,48*_.pace),n.current?.beginRun(vu.find(e=>e.id===r.strain).color,_.start),w({work:0,visited:0,found:!1,pass:null,done:!1}),()=>{x.current=null}},[r.phase,r.strain,_]),(0,l.useEffect)(()=>{if(r.phase!==`attract`)return;let e=_.outcomes[a.strainIndex%_.outcomes.length];return n.current?.beginRun(vu.find(t=>t.id===e.strain).color,_.start),S.current=new Wu(e.run.ops.slice(0,e.endIndex+1),180,!0),()=>{S.current=null}},[r.phase,a.strainIndex,_]),(0,l.useEffect)(()=>{let e=new URLSearchParams(location.search).get(`quality`),t=new tu(e??`high`);n.current?.setQuality(t.tier);let r=0,a=performance.now(),c=l=>{let u=l-a;a=l;let d=hd(_d(),T.current);for(let e of gd(T.current,d))O(e);T.current=d;let f=n.current;if(f){e||f.setQuality(t.sample(u));let n=x.current;if(s.current.phase===`run`&&n){let e=n.advance(u);if(e.length>0){f.applyOps(e,n.roundMs());let t=v.current.graph.edges.length,r=[...e].reverse().find(e=>e.kind===`round`);w(n=>({...n,work:n.work+e.reduce((e,n)=>e+lu(n,t),0),visited:n.visited+e.filter(e=>e.kind===`visit`).length,found:n.found||e.some(e=>e.kind===`found`),pass:r&&r.kind===`round`?{index:r.index,changed:r.changed}:n.pass}))}if(n.done){x.current=null,w(e=>({...e,done:!0}));let e=f.finishRipple(v.current.start,f.pathIgniteMs());window.setTimeout(()=>i({type:`runDone`}),Math.max(p,e+700))}}else if(s.current.phase===`attract`){let e=S.current;if(e){let t=e.advance(u);if(t.length>0&&f.applyOps(t,e.roundMs()),e.done){S.current=null;let e=f.finishRipple(v.current.start,f.pathIgniteMs());window.setTimeout(()=>o(e=>Ju(e,v.current.outcomes.length)),Math.max(h,e+500))}}}f.update(u),f.render()}r=requestAnimationFrame(c)};return r=requestAnimationFrame(c),()=>cancelAnimationFrame(r)},[]);let A=vu.find(e=>e.id===_.outcomes[a.strainIndex%_.outcomes.length].strain),ee=_.objective.id===`cover`?`${Math.round(100*C.visited/_.graph.nodes.length)}% COVERED`:(e=>Math.round(e).toLocaleString())(C.work),te=_.objective.id===`cover`?`COVERAGE`:`WORK`;return(0,Q.jsxs)(`div`,{className:`stage`,style:{transform:`translate(${e.x}px, ${e.y}px) scale(${e.scale})`},children:[(0,Q.jsx)(`canvas`,{ref:t,width:d,height:f,style:{width:d,height:f}}),(0,Q.jsxs)(`div`,{className:`hud`,onPointerDown:()=>{r.phase===`attract`&&i({type:`wake`})},children:[r.phase===`attract`&&(0,Q.jsxs)(`div`,{className:`attract-card`,style:{"--accent":A.color},children:[(0,Q.jsx)(`h1`,{children:`NODE ZERO`}),(0,Q.jsxs)(`div`,{className:`now-spreading`,children:[`now spreading: `,(0,Q.jsx)(`b`,{children:A.name}),` — `,A.algorithm]}),u?(0,Q.jsx)(`div`,{className:`press press-ready`,children:`CONTROLLER READY`}):(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`div`,{className:`press`,children:`PRESS ANY BUTTON TO PLAY`}),(0,Q.jsx)(`div`,{className:`press-sub`,children:$()?`no controller? scan the QR code to play on your phone`:`controller asleep? press the Xbox button to wake it`})]})]}),r.phase===`reveal`&&(0,Q.jsx)($u,{archetypeName:_.archetype.name,tagline:_.archetype.tagline,objectiveName:_.objective.name,task:_.objective.task,focus:r.menuFocus,onFocus:e=>i({type:`focusMenu`,index:e}),onContinue:()=>i({type:`revealDone`}),onPickMap:k,secret:_.sky!==null,intro:r.secretIntro}),r.phase===`mapPick`&&(0,Q.jsx)(ud,{focus:r.pickFocus,current:{archetype:_.archetype.id,objective:_.objective.id},onFocus:e=>i({type:`focusMap`,focus:e}),onChoose:e=>i({type:`chooseMap`,pick:e}),onBack:()=>i({type:`closeMapPick`})}),r.phase===`select`&&!r.mapPeek&&(0,Q.jsx)(Zu,{strains:y,objectiveName:_.objective.name,rematch:r.rematch,focus:r.strainFocus,peekFocused:r.menuFocus===1,onFocus:e=>{i({type:`focusStrain`,index:e}),i({type:`focusMenu`,index:0})},onFocusPeek:()=>i({type:`focusMenu`,index:1}),onChoose:e=>i({type:`chooseStrain`,strain:e}),onPeek:()=>i({type:`toggleMapPeek`})}),r.phase===`select`&&r.mapPeek&&(0,Q.jsx)(`button`,{className:`peek-banner`,onClick:()=>i({type:`toggleMapPeek`}),children:`READING THE GROUND — press any button to choose your strain`}),r.phase===`run`&&b&&(0,Q.jsx)(Qu,{strainName:b.name,color:b.color,rule:b.rule,metricLabel:te,metricValue:ee,found:C.found,pass:C.pass,done:C.done}),(r.phase===`reveal`||r.phase===`run`||r.phase===`select`&&r.mapPeek)&&(0,Q.jsx)(ed,{}),r.phase===`leaderboard`&&r.strain&&_.sky&&(0,Q.jsx)(cd,{round:_,pick:r.strain,focus:r.menuFocus,onFocus:e=>i({type:`focusMenu`,index:e}),onPickMap:k,onNext:()=>i({type:`nextSector`})}),r.phase===`leaderboard`&&r.strain&&!_.sky&&(0,Q.jsx)(sd,{round:_,pick:r.strain,focus:r.menuFocus,onFocus:e=>i({type:`focusMenu`,index:e}),onRematch:()=>i({type:`rematch`}),onNext:()=>i({type:`nextSector`}),onPickMap:k})]})]})}var kd=class extends l.Component{componentDidCatch(){location.reload()}render(){return this.props.children}};(0,u.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(l.StrictMode,{children:(0,Q.jsx)(kd,{children:(0,Q.jsx)(Od,{})})}));