...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(e,t,n){let r=new Float32Array(qa),i=new W(0,1,0);return new zi({name:`SphericalGaussianBlur`,defines:{n:qa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(){return new zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(){return new zi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
	...
	`}var uo=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},sl=class e extends Zc{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new U(256,256):new U(e.x,e.y),this.clearColor=new q(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new $t(i,a,{type:P}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new $t(i,a,{type:P});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new $t(i,a,{type:P});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=ol;this.highPassUniforms=Ii.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new zi({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1),new W(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Ii.clone(Xc.uniforms),this.blendMaterial=new zi({uniforms:this.copyUniforms,vertexShader:Xc.vertexShader,fragmentShader:Xc.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new q,this._oldClearAlpha=1,this._basic=new Wr,this._fsQuad=new el(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new U(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new zi({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new U(.5,.5)},direction:{value:new U(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};sl.BlurDirectionX=new U(1,0),sl.BlurDirectionY=new U(0,1);var cl={bg:724247,nodeBase:1712960,edgeCheap:1781840,edgeCostly:7218192,frontier:16777215,pathIgnite:16777215,beacon:15988735},ll={base:2.6,tree:4.2,flash:4.6,path:7},ul=.8,dl=1400;function fl(e){let t=0;for(let n of e)n>t&&(t=n);return{nodeState:new Uint8Array(e.length),parentEdge:new Int32Array(e.length).fill(-1),flashes:new Map,hotAt:new Float64Array(e.length).fill(-1/0),depth:e,maxDepth:t,waveAt:-1,waveMs:0,pending:[],path:null,foundAt:-1,visited:0,lastProbeEdge:-1,rippleAt:-1,rippleDepth:null}}function pl(e,t,n){e.nodeState[t]===0&&e.visited++,e.nodeState[t]=1,e.hotAt[t]=n}function ml(e){for(let t=0;t<e.nodeState.length;t++)e.nodeState[t]===1&&(e.nodeState[t]=2)}function hl(e,t){for(let n of e.pending)pl(e,n,t);e.pending=[]}function gl(e,t){let n=e.depth[t]<0?e.maxDepth:e.depth[t],r=e.maxDepth>0?n/e.maxDepth:0;return e.waveAt+r*e.waveMs*ul}function _l(e,t,n,r=500){switch(t.kind){case`probe`:e.lastProbeEdge=t.edge,e.flashes.set(t.edge,n);break;case`visit`:case`improve`:if(e.waveAt>=0){e.pending.push(t.node);break}t.kind===`visit`&&pl(e,t.node,n),e.lastProbeEdge>=0&&(e.parentEdge[t.node]=e.lastProbeEdge);break;case`settle`:e.nodeState[t.node]=2;break;case`round`:ml(e),hl(e,n),(e.waveAt<0||n>=e.waveAt+e.waveMs)&&(e.waveAt=n,e.waveMs=r),e.lastProbeEdge=-1;break;case`found`:hl(e,n),e.path=t.path,e.foundAt=n;break;case`deadEnd`:break;default:}}function vl(e,t){e.waveAt<0||e.pending.length===0||(e.pending=e.pending.filter(n=>t>=gl(e,n)?(pl(e,n,t),!1):!0))}function yl(e,t,n){for(let[r,i]of e.flashes)t-i>n&&e.flashes.delete(r)}function bl(e,t){let n=new Int32Array(e.length).fill(-1);n[t]=0;let r=[t];for(let t=0;t<r.length;t++)for(let{node:i}of e[r[t]])n[i]<0&&(n[i]=n[r[t]]+1,r.push(i));return n}function xl(e,t,n,r=n){hl(e,n),ml(e),e.waveAt=-1,e.rippleAt=Math.max(n,r),e.rippleDepth=t}function Sl(e,t){if(e.rippleAt<0||!e.rippleDepth)return 0;let n=0;for(let t of e.rippleDepth)t>n&&(n=t);return Math.max(0,e.rippleAt+n*50+300-t)}function Cl(e){"@babel/helpers - typeof";return Cl=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Cl(e)}function wl(e,t){if(Cl(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(Cl(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Tl(e){var t=wl(e,`string`);return Cl(t)==`symbol`?t:t+``}function El(e,t,n){return(t=Tl(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Dl=15,Ol=300,kl=class{constructor(e){El(this,`renderer`,void 0),El(this,`scene`,new zn),El(this,`camera`,void 0),El(this,`nodeMesh`,null),El(this,`haloMesh`,null),El(this,`edgeMesh`,null),El(this,`graph`,null),El(this,`strainColor`,new q(`#38d9ff`)),El(this,`visual`,null),El(this,`beacon`,null),El(this,`beaconMat`,null),El(this,`startMarker`,null),El(this,`startMat`,null),El(this,`renderScale`,1),El(this,`time`,0),El(this,`dummy`,new An),El(this,`edgeColor`,[]),El(this,`edgeWidth`,[]),El(this,`edgeBase`,[]),El(this,`edgeBaseWidth`,[]),El(this,`edgesDirty`,!1),El(this,`composer`,void 0),El(this,`bloom`,void 0),El(this,`quality`,`high`),this.renderer=new Yc({canvas:e,antialias:!0}),this.renderer.setSize(d,f,!1),this.renderer.setClearColor(cl.bg,1),this.camera=new pa(0,d,0,-f,-100,100),this.camera.position.z=10,e.addEventListener(`webglcontextlost`,()=>location.reload()),this.composer=new il(this.renderer),this.composer.addPass(new al(this.scene,this.camera)),this.bloom=new sl(new U(d,f),1.25,.55,.14),this.composer.addPass(this.bloom)}setQuality(e){e!==this.quality&&(this.quality=e,this.bloom.enabled=e!==`low`,this.applySizes())}setRenderScale(e){let t=Math.min(1,e);t!==this.renderScale&&(this.renderScale=t,this.applySizes())}applySizes(){let e=Math.max(1,Math.round(d*this.renderScale)),t=Math.max(1,Math.round(f*this.renderScale));this.renderer.setSize(e,t,!1),this.composer.setSize(e,t);let n=this.quality===`high`?1:.5;this.bloom.setSize(e*n,t*n)}setField(e){this.disposeMeshes(),this.graph=e;let t=e.nodes.length,n=new Oi(6,20);this.nodeMesh=new mi(n,new Wr,t);let r=new q(cl.nodeBase);for(let n=0;n<t;n++)this.dummy.position.set(e.nodes[n].x,-e.nodes[n].y,0),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(n,this.dummy.matrix),this.nodeMesh.setColorAt(n,r);this.scene.add(this.nodeMesh);let i=new Oi(Dl,24),a=new Wr({blending:2,depthWrite:!1,transparent:!0});this.haloMesh=new mi(i,a,t);let o=new q(0);for(let n=0;n<t;n++)this.dummy.position.set(e.nodes[n].x,-e.nodes[n].y,-.3),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.haloMesh.setMatrixAt(n,this.dummy.matrix),this.haloMesh.setColorAt(n,o);this.scene.add(this.haloMesh);let s=e.edges.map(e=>e.weight/e.length),c=new q(cl.edgeCheap),l=new q(cl.edgeCostly),u=s.map(e=>1-1/e);this.edgeBase=u.map(e=>c.clone().lerp(l,e)),this.edgeBaseWidth=u.map(e=>ll.base*(1+.7*e)),this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice();let d=new ki(1,1);this.edgeMesh=new mi(d,new Wr,e.edges.length),this.edgesDirty=!0,this.scene.add(this.edgeMesh),this.visual=null,this.setTarget(null),this.setStart(null)}beginRun(e,t){this.strainColor=new q(e),this.visual=this.graph?fl(bl(this.graph.adjacency,t)):null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgesDirty=!0}clearRun(){this.visual=null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgesDirty=!0}applyOps(e,t){if(!this.visual)return;let n=this.time*1e3,r=Math.max(t??500,dl);for(let t of e)_l(this.visual,t,n,r)}setTarget(e){if(e===null||!this.graph){this.beacon&&(this.beacon.visible=!1);return}this.beacon||(this.beaconMat=new Wr({color:cl.beacon,transparent:!0,opacity:.85,blending:2,depthWrite:!1}),this.beacon=new jn,this.beacon.add(new ni(new Ai(26,30,48),this.beaconMat),new ni(new Ai(44,46,64),this.beaconMat)),this.beacon.position.z=1,this.scene.add(this.beacon));let t=this.graph.nodes[e];this.beacon.position.set(t.x,-t.y,1),this.beacon.visible=!0}finishRipple(e,t=0){if(!this.visual||!this.graph)return 0;let n=this.time*1e3;return xl(this.visual,bl(this.graph.adjacency,e),n,n+t),Sl(this.visual,n)}pathIgniteMs(){let e=this.visual?.path;return e?Math.max(0,e.length-1)*60:0}setStart(e){if(e===null||!this.graph){this.startMarker&&(this.startMarker.visible=!1);return}this.startMarker||(this.startMat=new Wr({color:cl.beacon,transparent:!0,opacity:.55,blending:2,depthWrite:!1}),this.startMarker=new ni(new Ai(16,19,40),this.startMat),this.startMarker.position.z=1,this.scene.add(this.startMarker));let t=this.graph.nodes[e];this.startMarker.position.set(t.x,-t.y,1),this.startMarker.visible=!0}update(e){this.time+=e/1e3;let t=this.time*1e3;if(this.camera.position.x=8*Math.sin(this.time*.11),this.camera.position.y=5*Math.cos(this.time*.07),this.beacon?.visible){let t=1+.15*Math.sin(this.time*3);this.beacon.scale.setScalar(t),this.beacon.rotation.z+=e*6e-4}if(this.startMarker?.visible&&this.startMarker.scale.setScalar(1+.08*Math.sin(this.time*3+Math.PI)),!this.nodeMesh||!this.graph)return;let n=this.visual;n?(vl(n,t),yl(n,t,Ol),this.styleEdges(n,t)):this.edgesDirty&&this.rewriteEdges();let r=new q(cl.nodeBase).multiplyScalar(.8),i=new q(cl.frontier),a=this.strainColor.clone().lerp(i,.35),o=this.strainColor.clone().multiplyScalar(.85),s=n!==null&&n.waveAt>=0,c=new q,l=new q;for(let e=0;e<this.graph.nodes.length;e++){let i=n?n.nodeState[e]:0,u;if(i===0){if(c.copy(r),u=.8,l.setRGB(0,0,0),n&&n.rippleAt>=0&&n.rippleDepth&&n.rippleDepth[e]>=0){let r=t-(n.rippleAt+n.rippleDepth[e]*50);if(r>=0){let e=Math.max(0,1-r/300);c.lerp(a,.7*e),l.copy(this.strainColor).multiplyScalar(.45*e),u=.8+.45*e}}}else{let r=Math.max(0,1-(t-n.hotAt[e])/600);c.copy(o).lerp(a,r),u=1.05+.45*r;let i=.3+.35*r;if(s){let r=t-gl(n,e);if(r>=0&&r<300){let e=1-r/300;c.lerp(a,.35*e),u+=.2*e,i+=.3*e}}if(l.copy(this.strainColor).multiplyScalar(i),n.rippleAt>=0&&n.rippleDepth&&n.rippleDepth[e]>=0){let r=t-(n.rippleAt+n.rippleDepth[e]*50);if(r>=0){let e=Math.max(0,1-r/300);c.copy(o).multiplyScalar(1.1).lerp(a,.9*e),l.copy(this.strainColor).multiplyScalar(.28+.5*e),u=1.05+.35*e}}}let d=this.graph.nodes[e];this.dummy.position.set(d.x,-d.y,0),this.dummy.scale.setScalar(u),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(e,this.dummy.matrix),this.nodeMesh.setColorAt(e,c),this.haloMesh.setColorAt(e,l)}this.nodeMesh.instanceMatrix.needsUpdate=!0,this.nodeMesh.instanceColor&&(this.nodeMesh.instanceColor.needsUpdate=!0),this.haloMesh.instanceColor&&(this.haloMesh.instanceColor.needsUpdate=!0)}render(){this.quality===`low`?this.renderer.render(this.scene,this.camera):this.composer.render()}disposeMeshes(){for(let e of[this.nodeMesh,this.haloMesh,this.edgeMesh])e&&(this.scene.remove(e),e.geometry.dispose(),e.material.dispose());this.nodeMesh=null,this.haloMesh=null,this.edgeMesh=null}dispose(){if(this.disposeMeshes(),this.beacon){this.scene.remove(this.beacon);for(let e of this.beacon.children)e.geometry.dispose();this.beaconMat?.dispose()}this.startMarker&&(this.scene.remove(this.startMarker),this.startMarker.geometry.dispose(),this.startMat?.dispose()),this.composer.dispose(),this.renderer.dispose()}styleEdges(e,t){let n=this.graph,r=this.strainColor.clone().multiplyScalar(.6);for(let e=0;e<n.edges.length;e++)this.edgeColor[e].copy(this.edgeBase[e]),this.edgeWidth[e]=this.edgeBaseWidth[e];for(let t=0;t<e.parentEdge.length;t++){let n=e.parentEdge[t];n>=0&&e.nodeState[t]!==0&&(this.edgeColor[n].copy(r),this.edgeWidth[n]=ll.tree)}let i=this.strainColor.clone().lerp(new q(cl.frontier),.45);for(let[n,r]of e.flashes){let e=1-(t-r)/Ol;e<=0||(this.edgeColor[n].lerp(i,.7*e),this.edgeWidth[n]=Math.max(this.edgeWidth[n],ll.flash*e+ll.base*(1-e)))}if(e.waveAt>=0){let r=this.strainColor.clone().lerp(new q(cl.frontier),.25);for(let i=0;i<n.edges.length;i++){let a=n.edges[i],o=t-Math.max(gl(e,a.a),gl(e,a.b));if(o>=0&&o<300){let e=1-o/300;this.edgeColor[i].lerp(r,.25*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],this.edgeBaseWidth[i]+.8*e)}}}if(e.rippleAt>=0&&e.rippleDepth){let r=this.strainColor.clone().lerp(new q(cl.frontier),.5);for(let i=0;i<n.edges.length;i++){let a=n.edges[i],o=e.rippleDepth[a.a],s=e.rippleDepth[a.b];if(o<0||s<0)continue;let c=t-(e.rippleAt+Math.max(o,s)*50);if(c>=0&&c<300){let e=1-c/300;this.edgeColor[i].lerp(r,.8*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],ll.base+2.4*e)}}}if(e.path&&e.foundAt>=0){let r=Math.floor((t-e.foundAt)/60),i=new q(cl.pathIgnite);for(let t=0;t<Math.min(r,e.path.length-1);t++){let r=e.path[e.path.length-1-t],a=e.path[e.path.length-2-t],o=n.adjacency[r].find(e=>e.node===a);o&&(this.edgeColor[o.edge].copy(i),this.edgeWidth[o.edge]=ll.path)}}this.edgesDirty=!0,this.rewriteEdges()}rewriteEdges(){let e=this.graph;if(!(!e||!this.edgeMesh)){for(let t=0;t<e.edges.length;t++){let n=e.edges[t],r=e.nodes[n.a],i=e.nodes[n.b],a=(r.x+i.x)/2,o=(r.y+i.y)/2;this.dummy.position.set(a,-o,-1),this.dummy.rotation.set(0,0,Math.atan2(-(i.y-r.y),i.x-r.x)),this.dummy.scale.set(n.length,this.edgeWidth[t],1),this.dummy.updateMatrix(),this.edgeMesh.setMatrixAt(t,this.dummy.matrix),this.edgeMesh.setColorAt(t,this.edgeColor[t])}this.dummy.rotation.set(0,0,0),this.edgeMesh.instanceMatrix.needsUpdate=!0,this.edgeMesh.instanceColor&&(this.edgeMesh.instanceColor.needsUpdate=!0),this.edgesDirty=!1}}},Al=[`low`,`medium`,`high`],jl=class{constructor(e=`high`){El(this,`window`,[]),El(this,`fastStreak`,0),El(this,`current`,void 0),this.current=e}get tier(){return this.current}sample(e){this.window.push(e),this.window.length>60&&this.window.shift(),this.fastStreak=e<16?this.fastStreak+1:0;let t=Al.indexOf(this.current);return this.window.length===60&&this.window.reduce((e,t)=>e+t,0)/60>22&&t>0&&(this.current=Al[t-1],this.window=[],this.fastStreak=0),this.fastStreak>=300&&t<Al.length-1&&(this.current=Al[t+1],this.window=[],this.fastStreak=0),this.current}};function Ml(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Nl(e,t){let n=Array.from({length:4096},()=>e()),r=(e,t)=>n[(t%64+64)%64*64+(e%64+64)%64],i=e=>e*e*(3-2*e);return(e,n)=>{let a=e/t,o=n/t,s=Math.floor(a),c=Math.floor(o),l=i(a-s),u=i(o-c),d=r(s,c)+(r(s+1,c)-r(s,c))*l;return d+(r(s,c+1)+(r(s+1,c+1)-r(s,c+1))*l-d)*u}}function Pl(e,t,n,r,i,a,o){let s=i/Math.SQRT2,c=Math.ceil(t/s),l=Math.ceil(n/s),u=Math.ceil(a/s),d=Array(c*l).fill(null),f=[],p=[],m=e=>e.x>=o&&e.x<=t-o&&e.y>=o&&e.y<=n-o,h=(e,t)=>{let n=Math.floor(e.x/s),r=Math.floor(e.y/s);for(let i=Math.max(0,r-u);i<=Math.min(l-1,r+u);i++)for(let r=Math.max(0,n-u);r<=Math.min(c-1,n+u);r++){let n=d[i*c+r];if(n!==null&&Math.hypot(f[n].x-e.x,f[n].y-e.y)<t)return!1}return!0},g=e=>{f.push(e),p.push(f.length-1),d[Math.floor(e.y/s)*c+Math.floor(e.x/s)]=f.length-1};for(g({x:t/2,y:n/2});p.length>0;){let t=Math.floor(e()*p.length),n=f[p[t]],i=r(n.x,n.y),a=!1;for(let t=0;t<30;t++){let t=e()*Math.PI*2,o=i*(1+e()),s={x:n.x+Math.cos(t)*o,y:n.y+Math.sin(t)*o};if(m(s)&&h(s,r(s.x,s.y))){g(s),a=!0;break}}a||p.splice(t,1)}return f}function Fl(e){let{seed:t,radius:n=70,terrainCell:r=400,terrainStrength:i=2,prune:a=0,mask:o}=e,s=Ml(t),c=Nl(s,r),l=o?Nl(s,o.cell):null,u=Pl(s,d,f,l&&o?(e,t)=>n*(1+o.strength*l(e,t)):()=>n,n,n*(1+(o?.strength??0)),60).map((e,t)=>({id:t,x:e.x,y:e.y})),p=[];for(let e=0;e<u.length;e++)for(let t=e+1;t<u.length;t++){let n=u[e],r=u[t],i=(n.x+r.x)/2,a=(n.y+r.y)/2,o=((n.x-r.x)**2+(n.y-r.y)**2)/4,s=!0;for(let n=0;n<u.length;n++){if(n===e||n===t)continue;let r=u[n];if((r.x-i)**2+(r.y-a)**2<o-1e-9){s=!1;break}}s&&p.push([e,t])}a>0&&(p=Z(u.length,p,a,s));let m=[],h=u.map(()=>[]);for(let[e,t]of p){let n=u[e],r=u[t],a=Math.hypot(n.x-r.x,n.y-r.y),o=a*(1+i*c((n.x+r.x)/2,(n.y+r.y)/2)),s=m.length;m.push({id:s,a:e,b:t,length:a,weight:o}),h[e].push({node:t,edge:s}),h[t].push({node:e,edge:s})}return{nodes:u,edges:m,adjacency:h}}function Z(e,t,n,r){let i=Math.floor(t.length*n),a=t.map((e,t)=>t);for(let e=a.length-1;e>0;e--){let t=Math.floor(r()*(e+1));[a[e],a[t]]=[a[t],a[e]]}let o=new Set,s=0;for(let n of a){if(s>=i)break;o.add(n),Il(e,t,o,t[n])?s++:o.delete(n)}return t.filter((e,t)=>!o.has(t))}function Il(e,t,n,[r,i]){let a=Array.from({length:e},()=>[]);t.forEach(([e,t],r)=>{n.has(r)||(a[e].push(t),a[t].push(e))});let o=new Uint8Array(e);o[r]=1;let s=[r];for(;s.length;){let e=s.pop();if(e===i)return!0;for(let t of a[e])o[t]||(o[t]=1,s.push(t))}return!1}var Q=[{id:`open-sector`,name:`OPEN SECTOR`,tagline:`Flat, cheap terrain. Straight shots win.`,params:{radius:58,terrainCell:400,terrainStrength:.05}},{id:`badlands`,name:`BADLANDS`,tagline:`Vast corrupted zones, half the routes dead. Cheap ground is worth a detour.`,params:{radius:160,terrainCell:1200,terrainStrength:7,prune:.6}},{id:`maze`,name:`THE MAZE`,tagline:`Severed conduits. Few paths thread the labyrinth.`,params:{radius:110,terrainCell:400,terrainStrength:1,prune:.45}},{id:`minefield`,name:`MINEFIELD`,tagline:`Cost spikes everywhere. Caution pays.`,params:{radius:70,terrainCell:170,terrainStrength:4}},{id:`archipelago`,name:`ARCHIPELAGO`,tagline:`Dense clusters, thin bridges. Find the crossings.`,params:{radius:54,terrainCell:400,terrainStrength:.1,mask:{cell:520,strength:2}}}];function Ll(e){let t=Ml(388208^e),n=Q.map((e,t)=>t);for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}function Rl(e){let t=Q.length,n=Math.floor(e/t),r=Ll(n);return n>0&&r[0]===Ll(n-1)[t-1]&&([r[0],r[1]]=[r[1],r[0]]),Q[r[e%t]]}var zl=(e,t)=>e.kind===`probe`?1:e.kind===`round`?t*2:0,Bl=[`ripple`,`tendril`,`miser`,`bloodhound`,`oracle`,`paranoia`],Vl=[{id:`cover`,name:`FULL COVERAGE`,task:`Touch every node in the sector. Least work wins — there is no beacon to reach.`,metricLabel:`WORK`,eligible:Bl,needsTarget:!1},{id:`reach`,name:`FIRST CONTACT`,task:`Reach the beacon. Least work wins.`,metricLabel:`WORK`,eligible:Bl,needsTarget:!0},{id:`economy`,name:`CHEAPEST ROUTE`,task:`Find the cheapest route to the beacon. The route is judged, not the speed.`,metricLabel:`ROUTE COST`,eligible:Bl,needsTarget:!0}];function Hl(e,t,n,r){let i=r.edges.length;if(e.id===`cover`){let e=new Set,a=0;for(let o=0;o<n.ops.length;o++){let s=n.ops[o];if(a+=zl(s,i),s.kind===`visit`&&(e.add(s.node),e.size===r.nodes.length))return{strain:t,run:n,metric:a,tiebreak:0,endIndex:o}}throw Error(`${t} never covered the graph — eligibility/objective bug`)}let a=n.ops.findIndex(e=>e.kind===`found`);if(a<0)throw Error(`${t} emitted no found op on a targeted objective`);let o=0;for(let e=0;e<=a;e++)o+=zl(n.ops[e],i);return e.id===`reach`?{strain:t,run:n,metric:o,tiebreak:n.pathCost,endIndex:a}:{strain:t,run:n,metric:n.pathCost,tiebreak:o,endIndex:a}}function Ul(e,t){let n=t=>e.eligible.indexOf(t);return[...t].sort((e,t)=>e.metric-t.metric||e.tiebreak-t.tiebreak||n(e.strain)-n(t.strain))}var Wl=class{constructor(){El(this,`items`,[])}get size(){return this.items.length}push(e,t){let n=this.items;n.push({item:e,priority:t});let r=n.length-1;for(;r>0;){let e=r-1>>1;if(n[e].priority<=n[r].priority)break;[n[e],n[r]]=[n[r],n[e]],r=e}}pop(){let e=this.items;if(e.length===0)return;let t=e[0].item,n=e.pop();if(e.length>0){e[0]=n;let t=0;for(;;){let n=2*t+1,r=n+1,i=t;if(n<e.length&&e[n].priority<e[i].priority&&(i=n),r<e.length&&e[r].priority<e[i].priority&&(i=r),i===t)break;[e[i],e[t]]=[e[t],e[i]],t=i}}return t}};function Gl(e,t,n,r,i=n){if(i===null&&(r===`greedy`||r===`astar`))throw Error(`${r} steers by distance-to-beacon — it needs an anchor node`);let a=e.nodes.length,o=r!==`bfs`&&r!==`dfs`,s=(()=>{if(i===null)return()=>0;let t=e.nodes[i].x,n=e.nodes[i].y;return r=>Math.hypot(e.nodes[r].x-t,e.nodes[r].y-n)})(),c=Array(a).fill(1/0),l=Array(a).fill(-1),u=Array(a).fill(!1),d=[],f=new Wl,p=0,m=e=>{switch(r){case`bfs`:return p;case`dfs`:return-p;case`dijkstra`:return c[e];case`greedy`:return s(e);case`astar`:return c[e]+s(e)}};for(c[t]=0,d.push({kind:`visit`,node:t,cost:0}),f.push(t,m(t)),p++;f.size>0;){let t=f.pop();if(u[t])continue;if(u[t]=!0,d.push({kind:`settle`,node:t,cost:c[t]}),n!==null&&t===n){let t=[];for(let e=n;e!==-1;e=l[e])t.push(e);t.reverse();let r=Kl(e,t);return d.push({kind:`found`,path:t,cost:r}),{ops:d,path:t,pathCost:r,workOps:d.filter(e=>e.kind===`probe`).length}}let r=0;for(let{node:n,edge:i}of e.adjacency[t]){if(u[n])continue;d.push({kind:`probe`,edge:i,from:t,to:n});let a=o?e.edges[i].weight:1,s=c[t]+a;if(s<c[n]){let e=c[n]===1/0;c[n]=s,l[n]=t,d.push(e?{kind:`visit`,node:n,cost:s}:{kind:`improve`,node:n,cost:s}),f.push(n,m(n)),p++,r++}}r===0&&d.push({kind:`deadEnd`,node:t})}if(n!==null)throw Error(`target unreachable — graph invariant violated`);return{ops:d,path:[],pathCost:0,workOps:d.filter(e=>e.kind===`probe`).length}}function Kl(e,t){let n=0;for(let r=0;r+1<t.length;r++){let i=e.adjacency[t[r]].find(e=>e.node===t[r+1]);if(!i)throw Error(`path uses a non-edge`);n+=e.edges[i.edge].weight}return n}function ql(e,t,n){let r=e.nodes.length,i=Array(r).fill(1/0),a=Array(r).fill(-1),o=[],s=Array(r).fill(!1);i[t]=0,s[t]=!0,o.push({kind:`visit`,node:t,cost:0});let c=0;for(let t=0;t<r-1;t++){let n=0,r=[];for(let t of e.edges)for(let[e,o]of[[t.a,t.b],[t.b,t.a]])i[e]+t.weight<i[o]&&(i[o]=i[e]+t.weight,a[o]=e,n++,r.push(s[o]?{kind:`improve`,node:o,cost:i[o]}:{kind:`visit`,node:o,cost:i[o]}),s[o]=!0);if(c++,o.push({kind:`round`,index:t,changed:n}),o.push(...r),n===0)break}if(n===null)return{ops:o,path:[],pathCost:0,workOps:c*e.edges.length*2};let l=[];for(let e=n;e!==-1;e=a[e])l.push(e);if(l.reverse(),l[0]!==t)throw Error(`target unreachable — graph invariant violated`);let u=Kl(e,l);return o.push({kind:`found`,path:l,cost:u}),{ops:o,path:l,pathCost:u,workOps:c*e.edges.length*2}}var Jl=[{id:`ripple`,name:`RIPPLE`,algorithm:`Breadth-First Search`,tagline:`Spreads evenly in every direction. Ignores distance.`,rule:`Always spread from the oldest node it found.`,color:`#38d9ff`},{id:`tendril`,name:`TENDRIL`,algorithm:`Depth-First Search`,tagline:`Follows one path as deep as it can before backtracking.`,rule:`Always spread from the newest node it found.`,color:`#b45cff`},{id:`miser`,name:`MISER`,algorithm:`Dijkstra's Algorithm`,tagline:`Always infects the cheapest reachable node next. Thorough but slow.`,rule:`Always spread from the cheapest node it can reach.`,color:`#ffd23e`},{id:`bloodhound`,name:`BLOODHOUND`,algorithm:`Greedy Best-First`,tagline:`Smells the target and beelines. Fast, but easily fooled.`,rule:`Always spread from the node nearest the beacon.`,color:`#ff5c7a`},{id:`oracle`,name:`ORACLE`,algorithm:`A* Search`,tagline:`Miser's caution + Bloodhound's nose. The smart one.`,rule:`Balance the cost already paid against the distance still to go.`,color:`#5cff9d`},{id:`paranoia`,name:`PARANOIA`,algorithm:`Bellman-Ford`,tagline:`Re-checks everything, over and over. Wasteful… but never wrong.`,rule:`Recheck every link in the sector. Then do it again.`,color:`#ff8c38`}],Yl={ripple:`bfs`,tendril:`dfs`,miser:`dijkstra`,bloodhound:`greedy`,oracle:`astar`};function Xl(e,t,n,r,i=r){return e===`paranoia`?ql(t,n,r):Gl(t,n,r,Yl[e],i)}function Zl(e,t,n){let r=0,i=1/0;for(let a of e.nodes){let e=(a.x-t)**2+(a.y-n)**2;e<i&&(i=e,r=a.id)}return r}var Ql=728775;function $l(e){let t=Vl.length,n=Ml((Ql^Math.floor(e/t))>>>0),r=Vl.map((e,t)=>t);for(let e=r.length-1;e>0;e--){let t=Math.floor(n()*(e+1));[r[e],r[t]]=[r[t],r[e]]}return Vl[r[e%t]]}function eu(e,t,n){let r=Fl({seed:e,...t.params}),i=Zl(r,d*.12,f*.5),a=Zl(r,d*.88,f*.5),o=n.needsTarget?a:null,s=Ul(n,n.eligible.map(e=>Hl(n,e,Xl(e,r,i,o,a),r)));return{seed:e,archetype:t,objective:n,graph:r,start:i,beacon:a,target:o,outcomes:s,winner:s[0].strain}}function tu(e,t=null){let n=t?Q.find(e=>e.id===t.archetype):Rl(e),r=t?Vl.find(e=>e.id===t.objective):$l(e),i;for(let t=0,a=2*e+1;t<5;t++,a+=2)try{return eu(a,n,r)}catch(e){i=e}throw i}function nu(e,t,n){if(n===0)return e;let r=t/n;return e*(1+2*r*r)}var ru=class{constructor(e,t,n=!1){El(this,`budget`,0),El(this,`index`,0),El(this,`ops`,void 0),El(this,`opsPerSecond`,void 0),El(this,`ramp`,void 0),this.ops=e,this.opsPerSecond=t,this.ramp=n}get done(){return this.index>=this.ops.length}get consumed(){return this.index}rate(){return this.ramp?nu(this.opsPerSecond,this.index,this.ops.length):this.opsPerSecond}msPerTick(){return 1e3/this.rate()}advance(e){this.budget+=e/1e3*this.rate();let t=[];for(;!this.done;){let e=this.ops[this.index],n=e.kind===`round`?48:1;if(this.budget<n)break;if(this.budget-=n,this.index++,t.push(e),e.kind===`round`)for(;!this.done&&this.ops[this.index].kind!==`round`&&this.ops[this.index].kind!==`found`;)t.push(this.ops[this.index]),this.index++}return t}};function iu(){return{phase:`attract`,sectorIndex:0,rematch:!1,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0,pick:null,pickFocus:{archetype:0,objective:0},pickReturn:`reveal`}}function au(e,t){switch(t.type){case`idle`:return e.phase===`attract`?e:{...iu(),sectorIndex:e.sectorIndex+1};case`wake`:return e.phase===`attract`?{...e,phase:`reveal`,rematch:!1,strain:null,strainFocus:0,menuFocus:0}:e;case`revealDone`:return e.phase===`reveal`?{...e,phase:`select`,menuFocus:0}:e;case`focusMenu`:return e.phase===`reveal`||e.phase===`select`||e.phase===`leaderboard`?{...e,menuFocus:t.index}:e;case`backToReveal`:return e.phase===`select`?{...e,phase:`reveal`,mapPeek:!1,menuFocus:0}:e;case`focusStrain`:return e.phase===`select`?{...e,strainFocus:t.index}:e;case`toggleMapPeek`:return e.phase===`select`?{...e,mapPeek:!e.mapPeek}:e;case`chooseStrain`:return e.phase===`select`?{...e,phase:`run`,strain:t.strain,mapPeek:!1}:e;case`runDone`:return e.phase===`run`?{...e,phase:`leaderboard`,menuFocus:0}:e;case`rematch`:return e.phase===`leaderboard`?{...e,phase:`select`,rematch:!0,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0}:e;case`nextSector`:return e.phase===`leaderboard`?{...e,phase:`reveal`,sectorIndex:e.sectorIndex+1,rematch:!1,strain:null,strainFocus:0,pick:null,menuFocus:0}:e;case`openMapPick`:return e.phase===`reveal`||e.phase===`leaderboard`?{...e,phase:`mapPick`,pickReturn:e.phase,pickFocus:t.focus}:e;case`focusMap`:return e.phase===`mapPick`?{...e,pickFocus:t.focus}:e;case`chooseMap`:return e.phase===`mapPick`?{...e,phase:`reveal`,pick:t.pick,rematch:!1,strain:null,strainFocus:0,mapPeek:!1,menuFocus:0,sectorIndex:e.pickReturn===`leaderboard`?e.sectorIndex+1:e.sectorIndex}:e;case`closeMapPick`:return e.phase===`mapPick`?{...e,phase:e.pickReturn}:e}}function ou(e,t=6){return{strainIndex:(e.strainIndex+1)%t}}var su=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=e(((e,t)=>{t.exports=su()}))(),cu={ripple:`M60 60 m-12 0 a12 12 0 1 0 24 0 a12 12 0 1 0 -24 0 M60 60 m-28 0 a28 28 0 1 0 56 0 a28 28 0 1 0 -56 0 M60 60 m-44 0 a44 44 0 1 0 88 0 a44 44 0 1 0 -88 0`,tendril:`M16 100 C 30 20, 50 20, 55 60 S 70 110, 80 70 S 95 20, 104 28`,miser:`M60 60 L16 40 M60 60 L30 95 M60 60 L60 14 M60 60 L95 90 M60 60 L104 45 M60 60 L85 20`,bloodhound:`M16 95 L104 25 M104 25 l-18 2 M104 25 l-4 17`,oracle:`M16 95 Q 45 80 60 60 T 104 25 M104 25 l-18 2 M104 25 l-4 17`,paranoia:`M16 40 H104 M16 60 H104 M16 80 H104 M20 30 Q 60 20 100 30`};function lu(e){return(0,$.jsxs)(`div`,{className:`strain-screen`,children:[(0,$.jsxs)(`div`,{className:`strain-header`,children:[(0,$.jsx)(`h1`,{children:e.rematch?`SAME MAP — NEW CALL`:`WHO WINS THIS SECTOR?`}),(0,$.jsxs)(`div`,{className:`strain-sub`,children:[e.objectiveName,` — choose the strain you think wins`]}),(0,$.jsx)(`button`,{className:`peek-btn${e.peekFocused?` focused`:``}`,onMouseEnter:e.onFocusPeek,onClick:e.onPeek,children:`view the map`})]}),(0,$.jsx)(`div`,{className:`strain-row`,children:e.strains.map((t,n)=>(0,$.jsxs)(`button`,{className:`strain-card${n===e.focus&&!e.peekFocused?` focused`:``}`,style:{"--accent":t.color},onMouseEnter:()=>e.onFocus(n),onClick:()=>e.onChoose(t.id),children:[(0,$.jsx)(`h2`,{children:t.name}),(0,$.jsx)(`div`,{className:`algo`,children:t.algorithm}),(0,$.jsx)(`svg`,{className:`preview`,viewBox:`0 0 120 120`,children:(0,$.jsx)(`path`,{d:cu[t.id],fill:`none`,stroke:t.color,strokeWidth:`3`,strokeLinecap:`round`})}),(0,$.jsx)(`div`,{className:`tagline`,children:t.tagline})]},t.id))}),(0,$.jsxs)(`div`,{className:`screen-legend`,children:[(0,$.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,$.jsx)(`b`,{children:`▲`}),` view the map `,(0,$.jsx)(`b`,{children:`A`}),` select `,(0,$.jsx)(`b`,{children:`B`}),` back`]})]})}function uu(e){return(0,$.jsxs)(`div`,{className:`run-hud`,style:{"--accent":e.color??`#38d9ff`},children:[(0,$.jsx)(`div`,{className:`strain-tag`,children:e.strainName}),(0,$.jsxs)(`div`,{className:`run-rule`,children:[(0,$.jsx)(`span`,{children:`RULE`}),` `,e.rule]}),(0,$.jsxs)(`div`,{className:`run-metric`,children:[e.metricLabel,` `,(0,$.jsx)(`b`,{children:e.metricValue})]}),e.pass&&(0,$.jsxs)(`div`,{className:`run-pass`,children:[`PASS `,e.pass.index+1,` — `,e.done&&e.pass.changed===0?`NOTHING CHANGED. DONE.`:`${e.pass.changed} ROUTES IMPROVED`]}),e.found&&(0,$.jsx)(`div`,{className:`run-found`,children:`TARGET REACHED`})]})}function du(e){let t=[{label:`Choose your strain`,go:e.onContinue},{label:`Different sector`,go:e.onPickMap}];return(0,$.jsxs)(`div`,{className:`reveal-card`,children:[(0,$.jsx)(`div`,{className:`reveal-archetype`,children:e.archetypeName}),(0,$.jsx)(`div`,{className:`reveal-tagline`,children:e.tagline}),(0,$.jsxs)(`div`,{className:`reveal-objective`,children:[`OBJECTIVE — `,e.objectiveName]}),(0,$.jsx)(`div`,{className:`reveal-task`,children:e.task}),(0,$.jsx)(`div`,{className:`reveal-hint`,children:`reading the ground is half the game`}),(0,$.jsx)(`div`,{className:`reveal-continue`,children:t.map((t,n)=>(0,$.jsx)(`button`,{className:n===e.focus?`focused`:void 0,onMouseEnter:()=>e.onFocus(n),onClick:t.go,children:t.label},t.label))}),(0,$.jsxs)(`div`,{className:`screen-legend`,children:[(0,$.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,$.jsx)(`b`,{children:`A`}),` select`]})]})}function fu(){return(0,$.jsxs)(`div`,{className:`cost-legend`,children:[(0,$.jsx)(`span`,{className:`legend-title`,children:`LINK COST`}),(0,$.jsx)(`span`,{className:`legend-end`,children:`CHEAP`}),(0,$.jsx)(`div`,{className:`bar`}),(0,$.jsx)(`span`,{className:`legend-end`,children:`COSTLY`})]})}var pu={cover:{ripple:`Even rings waste nothing — RIPPLE touched the last node while the others were still doubling back across {ARCH}.`,tendril:`TENDRIL threaded {ARCH} corridor by corridor and hit the final pocket early.`,miser:`Cheapest ground first meant no wasted probes — MISER covered {ARCH} on a budget.`,bloodhound:`BLOODHOUND ran flat-out for the far side of {ARCH} and swept the whole sector almost by accident.`,oracle:`ORACLE's pull toward the far side lined up with how {ARCH} is laid out, and its cost-first half did the rest.`,paranoia:`One brute-force sweep touched nearly everything at once — on {ARCH}, PARANOIA's excess was actually efficient.`},reach:{ripple:`No terrain worth exploiting on {ARCH} — RIPPLE's steady rings reached the beacon without detours.`,tendril:`A corridor ran straight to the beacon — TENDRIL's all-in lunge paid off on {ARCH}.`,miser:`The others drowned in costly ground — MISER rode the cheap channels of {ARCH} to the beacon.`,bloodhound:`Open ground, clear scent — BLOODHOUND beelined across {ARCH} while the careful ones checked receipts.`,oracle:`Cost so far plus distance to go — ORACLE read {ARCH} and spent almost nothing it didn't have to.`,paranoia:`Every rival wandered into expensive dead ends — on {ARCH}, even PARANOIA's full sweeps came out ahead.`},economy:{ripple:`On this flat stretch of {ARCH} the fewest hops IS the cheapest route — RIPPLE tied the optimum with less work.`,tendril:`TENDRIL's single thread through {ARCH} happened to be the cheap one.`,miser:`MISER never pays more than it must — the guaranteed-cheapest route through {ARCH}.`,bloodhound:`The straight shot across {ARCH} was also the cheap one — BLOODHOUND's rush cost nothing extra.`,oracle:`ORACLE found the same unbeatable route MISER did, and its nose for the beacon meant it checked far less of {ARCH} to get there.`,paranoia:`PARANOIA re-checked every connection in {ARCH} until only the truly cheapest route remained.`}};function mu(e,t,n){return(pu[e][n]??`${n.toUpperCase()} simply fit this ground best.`).replaceAll(`{ARCH}`,t)}var hu={ripple:`RIPPLE counts hops, never cost — it fanned out evenly in every direction and paid for ground it never needed.`,tendril:`TENDRIL always chases its newest lead — it committed to one corridor and had to back all the way out.`,miser:`MISER only ever takes the cheapest node next, and nothing in that rule points at the beacon — so it searched the sector in every direction at once.`,bloodhound:`BLOODHOUND runs at whatever looks closest to the beacon and never checks what a link costs — the direct line ran straight through expensive ground.`,oracle:`ORACLE weighs cost paid against distance left before every single move — careful, but on ground this open the caution cost more than it saved.`,paranoia:`PARANOIA rechecks every link in the sector on every pass — never wrong, but it pays full price for that certainty.`},gu={cover:{ripple:`RIPPLE widens one even ring at a time — when the job is simply to touch everything, that tidy order probed more links than it had to.`,tendril:`TENDRIL dives down one path to its very end before trying anything else — collecting the last few stragglers is what cost it.`,miser:`MISER sorts every step by cost, but this objective never asked about cost — that careful ordering bought nothing and probed more to get it.`,bloodhound:`BLOODHOUND only knows one move: run at the beacon. There was no beacon to reach here — it sprinted for the far side anyway and then had to crawl back for everything it skipped.`,oracle:`ORACLE aims every step at a beacon. A sharp aim is worthless when the job is to touch everything, so its best instinct pulled it away from the corners it still had to cover.`,paranoia:`PARANOIA sweeps every link in the sector on every pass — it does touch everything, but it pays for the whole map several times over to be sure.`},economy:{ripple:`RIPPLE counts hops, never cost — it found a route with few links, but those links were the expensive kind.`,tendril:`TENDRIL commits to the first path it stumbles into — it delivered a route, but nothing in its rule ever asked what that route cost.`,miser:`MISER always takes the cheapest node next, which is exactly what this objective rewards — it gave up ground on work, not on price.`,oracle:`ORACLE splits its attention between cost paid and distance left — the distance half pulled it toward routes that looked short and priced badly.`}};function _u(e,t,n,r){let i=e===`economy`,a=n>0?t/n:1/0;if(a>=2&&Number.isFinite(a)){let e=a>=10?String(Math.round(a)):a.toFixed(1).replace(/\.0$/,``);return i?`That route cost ${e}× what ${r} paid.`:`That came to ${e}× the work ${r} did.`}let o=Math.round((a-1)*100);return o<1?i?`It came in a hair dearer than ${r}'s route.`:`It came in a hair above ${r} on work.`:i?`That route cost ${o}% more than ${r}'s.`:`That took ${o}% more work than ${r}.`}function vu(e,t,n){let r=t[0],i=t.find(e=>e.strain===n);if(!r||!i||i.strain===r.strain)return null;let a=r.strain.toUpperCase();return i.metric===r.metric?`Nothing wrong with ${n.toUpperCase()}'s answer — it matched the winner exactly. ${a} just got there doing less work.`:`${gu[e]?.[n]??hu[n]} ${_u(e,i.metric,r.metric,a)}`}function yu(e){let{round:t,pick:n}=e,r=[{label:`Next sector`,go:e.onNext},{label:`Rematch — same map, new strain`,go:e.onRematch},{label:`Choose a sector`,go:e.onPickMap}],i=e=>Math.round(e).toLocaleString(),a=vu(t.objective.id,t.outcomes,n);return(0,$.jsxs)(`div`,{className:`board-panel`,children:[(0,$.jsxs)(`div`,{className:`board-title`,children:[t.objective.name,` — RESULTS`]}),(0,$.jsx)(`div`,{className:`board-rows`,children:t.outcomes.map((e,r)=>{let a=Jl.find(t=>t.id===e.strain);return(0,$.jsxs)(`div`,{className:`board-row${e.strain===n?` picked`:``}${r===0?` winner`:``}`,style:{"--accent":a.color},children:[(0,$.jsx)(`span`,{className:`rank`,children:r+1}),(0,$.jsx)(`span`,{className:`name`,children:a.name}),(0,$.jsxs)(`span`,{className:`metric`,children:[t.objective.metricLabel,` `,i(e.metric)]}),e.strain===n&&(0,$.jsx)(`span`,{className:`call`,children:r===0?`CALLED IT ✓`:`YOUR PICK`})]},e.strain)})}),(0,$.jsx)(`div`,{className:`board-why`,children:mu(t.objective.id,t.archetype.name,t.winner)}),a&&(0,$.jsxs)(`div`,{className:`board-loss`,style:{"--accent":Jl.find(e=>e.id===n).color},children:[(0,$.jsx)(`span`,{className:`board-loss-tag`,children:`YOUR CALL`}),` `,a]}),(0,$.jsx)(`div`,{className:`board-actions`,children:r.map((t,n)=>(0,$.jsx)(`button`,{className:n===e.focus?`focused`:void 0,onMouseEnter:()=>e.onFocus(n),onClick:t.go,children:t.label},t.label))}),(0,$.jsxs)(`div`,{className:`screen-legend`,children:[(0,$.jsx)(`b`,{children:`◀ ▶`}),` move `,(0,$.jsx)(`b`,{children:`A`}),` select`]})]})}var bu={cover:(0,$.jsx)($.Fragment,{children:[16,40,64,88,112].flatMap(e=>[18,40,62].map(t=>(0,$.jsx)(`circle`,{cx:e,cy:t,r:e===16&&t===40?6:3.5},`${e}-${t}`)))}),reach:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`circle`,{cx:`16`,cy:`40`,r:`6`}),(0,$.jsx)(`path`,{d:`M22 40 H100`,strokeDasharray:`6 5`}),(0,$.jsx)(`circle`,{cx:`112`,cy:`40`,r:`7`,fill:`none`}),(0,$.jsx)(`circle`,{cx:`112`,cy:`40`,r:`12`,fill:`none`,opacity:`0.5`})]}),economy:(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`circle`,{cx:`16`,cy:`40`,r:`6`}),(0,$.jsx)(`path`,{d:`M22 40 C 40 40, 44 16, 62 16 S 84 60, 100 44`,fill:`none`}),(0,$.jsx)(`circle`,{cx:`112`,cy:`40`,r:`7`,fill:`none`}),(0,$.jsx)(`circle`,{cx:`112`,cy:`40`,r:`12`,fill:`none`,opacity:`0.5`})]})};function xu(e){let t=Q[e.focus.archetype],n=Vl[e.focus.objective];return(0,$.jsxs)(`div`,{className:`pick-screen`,children:[(0,$.jsxs)(`div`,{className:`pick-header`,children:[(0,$.jsx)(`h1`,{children:`CHOOSE YOUR SECTOR`}),(0,$.jsx)(`div`,{className:`pick-sub`,children:`any ground, any objective — or let NEXT SECTOR deal the rotation`})]}),(0,$.jsxs)(`div`,{className:`pick-grid`,style:{gridTemplateColumns:`300px repeat(${Q.length}, 1fr)`},children:[(0,$.jsx)(`div`,{className:`pick-corner`}),Q.map((t,n)=>(0,$.jsxs)(`div`,{className:`pick-col${n===e.focus.archetype?` focused`:``}`,children:[(0,$.jsx)(`b`,{children:t.name}),(0,$.jsx)(`span`,{children:t.tagline})]},t.id)),Vl.map((t,n)=>(0,$.jsx)(Su,{objective:t,r:n,...e},t.id))]}),(0,$.jsxs)(`div`,{className:`pick-detail`,children:[(0,$.jsxs)(`b`,{children:[t.name,` — `,n.name]}),` `,n.task]}),(0,$.jsxs)(`div`,{className:`screen-legend`,children:[(0,$.jsx)(`b`,{children:`◀ ▶ ▲ ▼`}),` move `,(0,$.jsx)(`b`,{children:`A`}),` play this sector`,(0,$.jsxs)(`button`,{className:`legend-btn`,onClick:e.onBack,children:[(0,$.jsx)(`b`,{children:`B`}),` back`]})]})]})}function Su(e){let{objective:t,r:n}=e;return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`pick-row${n===e.focus.objective?` focused`:``}`,children:(0,$.jsx)(`b`,{children:t.name})}),Q.map((r,i)=>{let a=i===e.focus.archetype&&n===e.focus.objective,o=r.id===e.current.archetype&&t.id===e.current.objective;return(0,$.jsxs)(`button`,{className:`pick-cell${a?` focused`:``}${o?` current`:``}`,onMouseEnter:()=>e.onFocus({archetype:i,objective:n}),onClick:()=>e.onChoose({archetype:r.id,objective:t.id}),children:[(0,$.jsx)(`svg`,{viewBox:`0 0 128 80`,fill:`currentColor`,stroke:`currentColor`,strokeWidth:`3`,strokeLinecap:`round`,children:bu[t.id]}),o&&(0,$.jsx)(`span`,{className:`now`,children:`THIS SECTOR`})]},r.id)})]})}var Cu=[[12,`up`],[13,`down`],[14,`left`],[15,`right`],[0,`confirm`],[1,`back`]],wu=.6,Tu=.35;function Eu(e,t){let n=e.buttons.slice(),r=e.axes[0]??0,i=e.axes[1]??0,a=(e,n)=>t[e]?n>Tu:n>wu;return n[12]=n[12]||a(12,-i),n[13]=n[13]||a(13,i),n[14]=n[14]||a(14,-r),n[15]=n[15]||a(15,r),n}function Du(e,t){return Cu.filter(([n])=>t[n]&&!e[n]).map(([,e])=>e)}function Ou(){let e=[...navigator.getGamepads?navigator.getGamepads():[]].find(e=>e);return e?{buttons:e.buttons.map(e=>e.pressed),axes:[...e.axes]}:{buttons:Array(16).fill(!1),axes:[0,0,0,0]}}var ku=[`left`,`right`,`up`,`down`,`confirm`,`back`];function Au(e){let t=e??(typeof location>`u`?``:location.search),n=new URLSearchParams(t);return n.has(`ftMsgUrl`)||n.get(`ftmsg`)===`1`}function ju(e){if(!e||typeof e!=`object`)return null;let t=e;return t.type===`pad`?ku.find(e=>e===t.action)??null:null}function Mu(e,t){if(!(t?.enabled??Au()))return()=>{};let n=globalThis.FootronMessaging;if(!n||typeof n.Messaging!=`function`)return console.warn(`[phone] footron messaging client not loaded; phone controls are off`),()=>{};let r=new n.Messaging,i=t=>{let n=ju(t);n&&e.onAction(n)},a=()=>e.onConnect?.();return r.addMessageListener(i),r.addConnectionListener(a),r.mount(),()=>{r.removeMessageListener(i),r.removeConnectionListener(a),r.unmount()}}function Nu(e){let[t,n]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=0,r=()=>{window.clearTimeout(t),n(!0),t=window.setTimeout(()=>n(!1),e)};return window.addEventListener(`gamepadconnected`,r),()=>{window.clearTimeout(t),window.removeEventListener(`gamepadconnected`,r)}},[e]),t}function Pu(e,t){let n=(0,l.useRef)(0),r=(0,l.useRef)(e);r.current=e;let i=(0,l.useRef)(()=>{window.clearTimeout(n.current),n.current=window.setTimeout(()=>r.current(),t)}).current;return(0,l.useEffect)(()=>(i(),window.addEventListener(`pointerdown`,i),window.addEventListener(`pointermove`,i),()=>{window.clearTimeout(n.current),window.removeEventListener(`pointerdown`,i),window.removeEventListener(`pointermove`,i)}),[]),i}function Fu(e,t,n){return t===`left`||t===`up`?Math.max(0,e-1):t===`right`||t===`down`?Math.min(n,e+1):e}function Iu(e){return{archetype:Math.max(0,Q.findIndex(t=>t.id===e.archetype.id)),objective:Math.max(0,Vl.findIndex(t=>t.id===e.objective.id))}}function Lu(){let[e,t]=(0,l.useState)({scale:1,x:0,y:0});return(0,l.useEffect)(()=>{let e=()=>{let e=Math.min(window.innerWidth/d,window.innerHeight/f);t({scale:e,x:(window.innerWidth-d*e)/2,y:(window.innerHeight-f*e)/2})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),e}function Ru(){let e=Lu(),t=(0,l.useRef)(null),n=(0,l.useRef)(null),[r,i]=(0,l.useReducer)(au,void 0,iu),[a,o]=(0,l.useState)({strainIndex:0}),s=(0,l.useRef)(r);(0,l.useEffect)(()=>{s.current=r},[r]);let c=Pu(()=>i({type:`idle`}),m),u=Nu(g),_=(0,l.useMemo)(()=>tu(r.sectorIndex,r.pick),[r.sectorIndex,r.pick]),v=(0,l.useRef)(_);(0,l.useEffect)(()=>{v.current=_},[_]);let y=(0,l.useMemo)(()=>_.objective.eligible.map(e=>Jl.find(t=>t.id===e)),[_]),b=Jl.find(e=>e.id===r.strain)??null,x=(0,l.useRef)(null),S=(0,l.useRef)(null),[C,w]=(0,l.useState)({work:0,visited:0,found:!1,pass:null,done:!1}),T=(0,l.useRef)(Array(16).fill(!1)),E=(0,l.useRef)(y);(0,l.useEffect)(()=>{E.current=y},[y]);let D=e=>{c();let t=s.current;switch(t.phase){case`attract`:i({type:`wake`});break;case`reveal`:{let n=Fu(t.menuFocus,e,1);n!==t.menuFocus&&i({type:`focusMenu`,index:n}),e===`confirm`&&(t.menuFocus===0?i({type:`revealDone`}):O());break}case`select`:{if(t.mapPeek){i({type:`toggleMapPeek`});break}if(e===`back`){i({type:`backToReveal`});break}if(e===`up`){i({type:`focusMenu`,index:1});break}if(e===`down`){i({type:`focusMenu`,index:0});break}if(t.menuFocus===1){e===`confirm`&&i({type:`toggleMapPeek`});break}let n=E.current.length-1;e===`left`&&i({type:`focusStrain`,index:Math.max(0,t.strainFocus-1)}),e===`right`&&i({type:`focusStrain`,index:Math.min(n,t.strainFocus+1)}),e===`confirm`&&i({type:`chooseStrain`,strain:E.current[Math.min(t.strainFocus,n)].id});break}case`run`:break;case`leaderboard`:{let n=Fu(t.menuFocus,e,2);n!==t.menuFocus&&i({type:`focusMenu`,index:n}),e===`confirm`&&(t.menuFocus===0?i({type:`nextSector`}):t.menuFocus===1?i({type:`rematch`}):O());break}case`mapPick`:{let n=t.pickFocus,r=(e,t)=>i({type:`focusMap`,focus:{archetype:Math.max(0,Math.min(Q.length-1,n.archetype+e)),objective:Math.max(0,Math.min(Vl.length-1,n.objective+t))}});e===`left`&&r(-1,0),e===`right`&&r(1,0),e===`up`&&r(0,-1),e===`down`&&r(0,1),e===`confirm`&&i({type:`chooseMap`,pick:{archetype:Q[n.archetype].id,objective:Vl[n.objective].id}}),e===`back`&&i({type:`closeMapPick`});break}}},O=()=>i({type:`openMapPick`,focus:Iu(v.current)});(0,l.useEffect)(()=>Mu({onAction:D,onConnect:()=>{c(),s.current.phase===`attract`&&i({type:`wake`})}}),[]),(0,l.useEffect)(()=>{let e=new kl(t.current);return n.current=e,()=>{e.dispose(),n.current=null}},[]),(0,l.useEffect)(()=>{n.current?.setField(_.graph),n.current?.setTarget(_.target),n.current?.setStart(_.start)},[_]),(0,l.useEffect)(()=>{n.current?.setRenderScale(e.scale*window.devicePixelRatio)},[e.scale]),(0,l.useEffect)(()=>{r.phase===`reveal`&&n.current?.clearRun()},[r.phase]),(0,l.useEffect)(()=>{if(r.phase!==`run`||!r.strain)return;let e=_.outcomes.find(e=>e.strain===r.strain);return x.current=new ru(e.run.ops.slice(0,e.endIndex+1),90,!0),n.current?.beginRun(Jl.find(e=>e.id===r.strain).color,_.start),w({work:0,visited:0,found:!1,pass:null,done:!1}),()=>{x.current=null}},[r.phase,r.strain,_]),(0,l.useEffect)(()=>{if(r.phase!==`attract`)return;let e=_.outcomes[a.strainIndex%_.outcomes.length];return n.current?.beginRun(Jl.find(t=>t.id===e.strain).color,_.start),S.current=new ru(e.run.ops.slice(0,e.endIndex+1),180,!0),()=>{S.current=null}},[r.phase,a.strainIndex,_]),(0,l.useEffect)(()=>{let e=new URLSearchParams(location.search).get(`quality`),t=new jl(e??`high`);n.current?.setQuality(t.tier);let r=0,a=performance.now(),c=l=>{let u=l-a;a=l;let d=Eu(Ou(),T.current);for(let e of Du(T.current,d))D(e);T.current=d;let f=n.current;if(f){e||f.setQuality(t.sample(u));let n=x.current;if(s.current.phase===`run`&&n){let e=n.advance(u);if(e.length>0){f.applyOps(e,48*n.msPerTick());let t=v.current.graph.edges.length,r=[...e].reverse().find(e=>e.kind===`round`);w(n=>({...n,work:n.work+e.reduce((e,n)=>e+zl(n,t),0),visited:n.visited+e.filter(e=>e.kind===`visit`).length,found:n.found||e.some(e=>e.kind===`found`),pass:r&&r.kind===`round`?{index:r.index,changed:r.changed}:n.pass}))}if(n.done){x.current=null,w(e=>({...e,done:!0}));let e=f.finishRipple(v.current.start,f.pathIgniteMs());window.setTimeout(()=>i({type:`runDone`}),Math.max(p,e+700))}}else if(s.current.phase===`attract`){let e=S.current;if(e){let t=e.advance(u);if(t.length>0&&f.applyOps(t,48*e.msPerTick()),e.done){S.current=null;let e=f.finishRipple(v.current.start,f.pathIgniteMs());window.setTimeout(()=>o(e=>ou(e,v.current.outcomes.length)),Math.max(h,e+500))}}}f.update(u),f.render()}r=requestAnimationFrame(c)};return r=requestAnimationFrame(c),()=>cancelAnimationFrame(r)},[]);let k=Jl.find(e=>e.id===_.outcomes[a.strainIndex%_.outcomes.length].strain),A=_.objective.id===`cover`?`${Math.round(100*C.visited/_.graph.nodes.length)}% COVERED`:(e=>Math.round(e).toLocaleString())(C.work),ee=_.objective.id===`cover`?`COVERAGE`:`WORK`;return(0,$.jsxs)(`div`,{className:`stage`,style:{transform:`translate(${e.x}px, ${e.y}px) scale(${e.scale})`},children:[(0,$.jsx)(`canvas`,{ref:t,width:d,height:f,style:{width:d,height:f}}),(0,$.jsxs)(`div`,{className:`hud`,onPointerDown:()=>{r.phase===`attract`&&i({type:`wake`})},children:[(0,$.jsx)(`div`,{className:`vignette`}),r.phase===`attract`&&(0,$.jsxs)(`div`,{className:`attract-card`,style:{"--accent":k.color},children:[(0,$.jsx)(`h1`,{children:`NODE ZERO`}),(0,$.jsxs)(`div`,{className:`now-spreading`,children:[`now spreading: `,(0,$.jsx)(`b`,{children:k.name}),` — `,k.algorithm]}),u?(0,$.jsx)(`div`,{className:`press press-ready`,children:`CONTROLLER READY`}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`press`,children:`PRESS ANY BUTTON TO PLAY`}),(0,$.jsx)(`div`,{className:`press-sub`,children:Au()?`no controller? scan the QR code to play on your phone`:`controller asleep? press the Xbox button to wake it`})]})]}),r.phase===`reveal`&&(0,$.jsx)(du,{archetypeName:_.archetype.name,tagline:_.archetype.tagline,objectiveName:_.objective.name,task:_.objective.task,focus:r.menuFocus,onFocus:e=>i({type:`focusMenu`,index:e}),onContinue:()=>i({type:`revealDone`}),onPickMap:O}),r.phase===`mapPick`&&(0,$.jsx)(xu,{focus:r.pickFocus,current:{archetype:_.archetype.id,objective:_.objective.id},onFocus:e=>i({type:`focusMap`,focus:e}),onChoose:e=>i({type:`chooseMap`,pick:e}),onBack:()=>i({type:`closeMapPick`})}),r.phase===`select`&&!r.mapPeek&&(0,$.jsx)(lu,{strains:y,objectiveName:_.objective.name,rematch:r.rematch,focus:r.strainFocus,peekFocused:r.menuFocus===1,onFocus:e=>{i({type:`focusStrain`,index:e}),i({type:`focusMenu`,index:0})},onFocusPeek:()=>i({type:`focusMenu`,index:1}),onChoose:e=>i({type:`chooseStrain`,strain:e}),onPeek:()=>i({type:`toggleMapPeek`})}),r.phase===`select`&&r.mapPeek&&(0,$.jsx)(`button`,{className:`peek-banner`,onClick:()=>i({type:`toggleMapPeek`}),children:`READING THE GROUND — press any button to choose your strain`}),r.phase===`run`&&b&&(0,$.jsx)(uu,{strainName:b.name,color:b.color,rule:b.rule,metricLabel:ee,metricValue:A,found:C.found,pass:C.pass,done:C.done}),(r.phase===`reveal`||r.phase===`run`||r.phase===`select`&&r.mapPeek)&&(0,$.jsx)(fu,{}),r.phase===`leaderboard`&&r.strain&&(0,$.jsx)(yu,{round:_,pick:r.strain,focus:r.menuFocus,onFocus:e=>i({type:`focusMenu`,index:e}),onRematch:()=>i({type:`rematch`}),onNext:()=>i({type:`nextSector`}),onPickMap:O})]})]})}var zu=class extends l.Component{componentDidCatch(){location.reload()}render(){return this.props.children}};(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(zu,{children:(0,$.jsx)(Ru,{})})}));