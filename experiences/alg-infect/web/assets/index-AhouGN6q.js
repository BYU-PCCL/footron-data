...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(e,t,n){let r=new Float32Array(Ya),i=new U(0,1,0);return new Vi({name:`SphericalGaussianBlur`,defines:{n:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fo(),fragmentShader:`
	...
	`}var po=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ll.BlurDirectionX=new H(1,0),ll.BlurDirectionY=new H(0,1);var ul={bg:724247,nodeBase:1712960,edgeCheap:1781840,edgeCostly:7218192,frontier:16777215,pathIgnite:16777215,beacon:15988735},dl={base:2.6,tree:4.2,flash:4.6,path:7},fl=.8,pl=1400;function ml(e){let t=0;for(let n of e)n>t&&(t=n);return{nodeState:new Uint8Array(e.length),parentEdge:new Int32Array(e.length).fill(-1),flashes:new Map,hotAt:new Float64Array(e.length).fill(-1/0),depth:e,maxDepth:t,waveAt:-1,waveMs:0,pending:[],path:null,foundAt:-1,visited:0,lastProbeEdge:-1,rippleAt:-1,rippleDepth:null}}function hl(e,t,n){e.nodeState[t]===0&&e.visited++,e.nodeState[t]=1,e.hotAt[t]=n}function gl(e){for(let t=0;t<e.nodeState.length;t++)e.nodeState[t]===1&&(e.nodeState[t]=2)}function _l(e,t){for(let n of e.pending)hl(e,n,t);e.pending=[]}function vl(e,t){let n=e.depth[t]<0?e.maxDepth:e.depth[t],r=e.maxDepth>0?n/e.maxDepth:0;return e.waveAt+r*e.waveMs*fl}function yl(e,t,n,r=500){switch(t.kind){case`probe`:e.lastProbeEdge=t.edge,e.flashes.set(t.edge,n);break;case`visit`:case`improve`:if(e.waveAt>=0){e.pending.push(t.node);break}t.kind===`visit`&&hl(e,t.node,n),e.lastProbeEdge>=0&&(e.parentEdge[t.node]=e.lastProbeEdge);break;case`settle`:e.nodeState[t.node]=2;break;case`round`:gl(e),_l(e,n),(e.waveAt<0||n>=e.waveAt+e.waveMs)&&(e.waveAt=n,e.waveMs=r),e.lastProbeEdge=-1;break;case`found`:_l(e,n),e.path=t.path,e.foundAt=n;break;case`deadEnd`:break;default:}}function bl(e,t){e.waveAt<0||e.pending.length===0||(e.pending=e.pending.filter(n=>t>=vl(e,n)?(hl(e,n,t),!1):!0))}function xl(e,t,n){for(let[r,i]of e.flashes)t-i>n&&e.flashes.delete(r)}function Sl(e,t){let n=new Int32Array(e.length).fill(-1);n[t]=0;let r=[t];for(let t=0;t<r.length;t++)for(let{node:i}of e[r[t]])n[i]<0&&(n[i]=n[r[t]]+1,r.push(i));return n}function Cl(e,t,n){_l(e,n),gl(e),e.waveAt=-1,e.rippleAt=n,e.rippleDepth=t}function wl(e){"@babel/helpers - typeof";return wl=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},wl(e)}function Tl(e,t){if(wl(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(wl(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function El(e){var t=Tl(e,`string`);return wl(t)==`symbol`?t:t+``}function Y(e,t,n){return(t=El(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Dl=15,Ol=300,kl=class{constructor(e){Y(this,`renderer`,void 0),Y(this,`scene`,new Vn),Y(this,`camera`,void 0),Y(this,`nodeMesh`,null),Y(this,`haloMesh`,null),Y(this,`edgeMesh`,null),Y(this,`graph`,null),Y(this,`strainColor`,new G(`#38d9ff`)),Y(this,`visual`,null),Y(this,`beacon`,null),Y(this,`beaconMat`,null),Y(this,`startMarker`,null),Y(this,`startMat`,null),Y(this,`renderScale`,1),Y(this,`time`,0),Y(this,`dummy`,new Mn),Y(this,`edgeColor`,[]),Y(this,`edgeWidth`,[]),Y(this,`edgeBase`,[]),Y(this,`edgeBaseWidth`,[]),Y(this,`edgesDirty`,!1),Y(this,`composer`,void 0),Y(this,`bloom`,void 0),Y(this,`quality`,`high`),this.renderer=new Zc({canvas:e,antialias:!0}),this.renderer.setSize(d,f,!1),this.renderer.setClearColor(ul.bg,1),this.camera=new ha(0,d,0,-f,-100,100),this.camera.position.z=10,e.addEventListener(`webglcontextlost`,()=>location.reload()),this.composer=new ol(this.renderer),this.composer.addPass(new sl(this.scene,this.camera)),this.bloom=new ll(new H(d,f),1.25,.55,.14),this.composer.addPass(this.bloom)}setQuality(e){e!==this.quality&&(this.quality=e,this.bloom.enabled=e!==`low`,this.applySizes())}setRenderScale(e){let t=Math.min(1,e);t!==this.renderScale&&(this.renderScale=t,this.applySizes())}applySizes(){let e=Math.max(1,Math.round(d*this.renderScale)),t=Math.max(1,Math.round(f*this.renderScale));this.renderer.setSize(e,t,!1),this.composer.setSize(e,t);let n=this.quality===`high`?1:.5;this.bloom.setSize(e*n,t*n)}setField(e){this.disposeMeshes(),this.graph=e;let t=e.nodes.length,n=new Ai(6,20);this.nodeMesh=new gi(n,new Kr,t);let r=new G(ul.nodeBase);for(let n=0;n<t;n++)this.dummy.position.set(e.nodes[n].x,-e.nodes[n].y,0),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(n,this.dummy.matrix),this.nodeMesh.setColorAt(n,r);this.scene.add(this.nodeMesh);let i=new Ai(Dl,24),a=new Kr({blending:2,depthWrite:!1,transparent:!0});this.haloMesh=new gi(i,a,t);let o=new G(0);for(let n=0;n<t;n++)this.dummy.position.set(e.nodes[n].x,-e.nodes[n].y,-.3),this.dummy.scale.setScalar(1),this.dummy.updateMatrix(),this.haloMesh.setMatrixAt(n,this.dummy.matrix),this.haloMesh.setColorAt(n,o);this.scene.add(this.haloMesh);let s=e.edges.map(e=>e.weight/e.length),c=new G(ul.edgeCheap),l=new G(ul.edgeCostly),u=s.map(e=>1-1/e);this.edgeBase=u.map(e=>c.clone().lerp(l,e)),this.edgeBaseWidth=u.map(e=>dl.base*(1+.7*e)),this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice();let d=new ji(1,1);this.edgeMesh=new gi(d,new Kr,e.edges.length),this.edgesDirty=!0,this.scene.add(this.edgeMesh),this.visual=null,this.setTarget(null),this.setStart(null)}beginRun(e,t){this.strainColor=new G(e),this.visual=this.graph?ml(Sl(this.graph.adjacency,t)):null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgesDirty=!0}clearRun(){this.visual=null,this.edgeColor=this.edgeBase.map(e=>e.clone()),this.edgeWidth=this.edgeBaseWidth.slice(),this.edgesDirty=!0}applyOps(e,t){if(!this.visual)return;let n=this.time*1e3,r=Math.max(t??500,pl);for(let t of e)yl(this.visual,t,n,r)}setTarget(e){if(e===null||!this.graph){this.beacon&&(this.beacon.visible=!1);return}this.beacon||(this.beaconMat=new Kr({color:ul.beacon,transparent:!0,opacity:.85,blending:2,depthWrite:!1}),this.beacon=new Nn,this.beacon.add(new ii(new Mi(26,30,48),this.beaconMat),new ii(new Mi(44,46,64),this.beaconMat)),this.beacon.position.z=1,this.scene.add(this.beacon));let t=this.graph.nodes[e];this.beacon.position.set(t.x,-t.y,1),this.beacon.visible=!0}finishRipple(e){!this.visual||!this.graph||Cl(this.visual,Sl(this.graph.adjacency,e),this.time*1e3)}setStart(e){if(e===null||!this.graph){this.startMarker&&(this.startMarker.visible=!1);return}this.startMarker||(this.startMat=new Kr({color:ul.beacon,transparent:!0,opacity:.55,blending:2,depthWrite:!1}),this.startMarker=new ii(new Mi(16,19,40),this.startMat),this.startMarker.position.z=1,this.scene.add(this.startMarker));let t=this.graph.nodes[e];this.startMarker.position.set(t.x,-t.y,1),this.startMarker.visible=!0}update(e){this.time+=e/1e3;let t=this.time*1e3;if(this.camera.position.x=8*Math.sin(this.time*.11),this.camera.position.y=5*Math.cos(this.time*.07),this.beacon?.visible){let t=1+.15*Math.sin(this.time*3);this.beacon.scale.setScalar(t),this.beacon.rotation.z+=e*6e-4}if(this.startMarker?.visible&&this.startMarker.scale.setScalar(1+.08*Math.sin(this.time*3+Math.PI)),!this.nodeMesh||!this.graph)return;let n=this.visual;n?(bl(n,t),xl(n,t,Ol),this.styleEdges(n,t)):this.edgesDirty&&this.rewriteEdges();let r=new G(ul.nodeBase).multiplyScalar(.8),i=new G(ul.frontier),a=this.strainColor.clone().lerp(i,.35),o=this.strainColor.clone().multiplyScalar(.85),s=n!==null&&n.waveAt>=0,c=new G,l=new G;for(let e=0;e<this.graph.nodes.length;e++){let i=n?n.nodeState[e]:0,u;if(i===0)c.copy(r),u=.8,l.setRGB(0,0,0);else{let r=Math.max(0,1-(t-n.hotAt[e])/600);c.copy(o).lerp(a,r),u=1.05+.45*r;let i=.3+.35*r;if(s){let r=t-vl(n,e);if(r>=0&&r<300){let e=1-r/300;c.lerp(a,.35*e),u+=.2*e,i+=.3*e}}if(l.copy(this.strainColor).multiplyScalar(i),n.rippleAt>=0&&n.rippleDepth&&n.rippleDepth[e]>=0){let r=t-(n.rippleAt+n.rippleDepth[e]*50);if(r>=0){let e=Math.max(0,1-r/300);c.copy(o).multiplyScalar(1.1).lerp(a,.9*e),l.copy(this.strainColor).multiplyScalar(.28+.5*e),u=1.05+.35*e}}}let d=this.graph.nodes[e];this.dummy.position.set(d.x,-d.y,0),this.dummy.scale.setScalar(u),this.dummy.updateMatrix(),this.nodeMesh.setMatrixAt(e,this.dummy.matrix),this.nodeMesh.setColorAt(e,c),this.haloMesh.setColorAt(e,l)}this.nodeMesh.instanceMatrix.needsUpdate=!0,this.nodeMesh.instanceColor&&(this.nodeMesh.instanceColor.needsUpdate=!0),this.haloMesh.instanceColor&&(this.haloMesh.instanceColor.needsUpdate=!0)}render(){this.quality===`low`?this.renderer.render(this.scene,this.camera):this.composer.render()}disposeMeshes(){for(let e of[this.nodeMesh,this.haloMesh,this.edgeMesh])e&&(this.scene.remove(e),e.geometry.dispose(),e.material.dispose());this.nodeMesh=null,this.haloMesh=null,this.edgeMesh=null}dispose(){if(this.disposeMeshes(),this.beacon){this.scene.remove(this.beacon);for(let e of this.beacon.children)e.geometry.dispose();this.beaconMat?.dispose()}this.startMarker&&(this.scene.remove(this.startMarker),this.startMarker.geometry.dispose(),this.startMat?.dispose()),this.composer.dispose(),this.renderer.dispose()}styleEdges(e,t){let n=this.graph,r=this.strainColor.clone().multiplyScalar(.6);for(let e=0;e<n.edges.length;e++)this.edgeColor[e].copy(this.edgeBase[e]),this.edgeWidth[e]=this.edgeBaseWidth[e];for(let t=0;t<e.parentEdge.length;t++){let n=e.parentEdge[t];n>=0&&e.nodeState[t]!==0&&(this.edgeColor[n].copy(r),this.edgeWidth[n]=dl.tree)}let i=this.strainColor.clone().lerp(new G(ul.frontier),.45);for(let[n,r]of e.flashes){let e=1-(t-r)/Ol;e<=0||(this.edgeColor[n].lerp(i,.7*e),this.edgeWidth[n]=Math.max(this.edgeWidth[n],dl.flash*e+dl.base*(1-e)))}if(e.waveAt>=0){let r=this.strainColor.clone().lerp(new G(ul.frontier),.25);for(let i=0;i<n.edges.length;i++){let a=n.edges[i],o=t-Math.max(vl(e,a.a),vl(e,a.b));if(o>=0&&o<300){let e=1-o/300;this.edgeColor[i].lerp(r,.25*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],this.edgeBaseWidth[i]+.8*e)}}}if(e.rippleAt>=0&&e.rippleDepth){let r=this.strainColor.clone().lerp(new G(ul.frontier),.5);for(let i=0;i<n.edges.length;i++){let a=n.edges[i],o=e.rippleDepth[a.a],s=e.rippleDepth[a.b];if(o<0||s<0)continue;let c=t-(e.rippleAt+Math.max(o,s)*50);if(c>=0&&c<300){let e=1-c/300;this.edgeColor[i].lerp(r,.8*e),this.edgeWidth[i]=Math.max(this.edgeWidth[i],dl.base+2.4*e)}}}if(e.path&&e.foundAt>=0){let r=Math.floor((t-e.foundAt)/60),i=new G(ul.pathIgnite);for(let t=0;t<Math.min(r,e.path.length-1);t++){let r=e.path[e.path.length-1-t],a=e.path[e.path.length-2-t],o=n.adjacency[r].find(e=>e.node===a);o&&(this.edgeColor[o.edge].copy(i),this.edgeWidth[o.edge]=dl.path)}}this.edgesDirty=!0,this.rewriteEdges()}rewriteEdges(){let e=this.graph;if(!(!e||!this.edgeMesh)){for(let t=0;t<e.edges.length;t++){let n=e.edges[t],r=e.nodes[n.a],i=e.nodes[n.b],a=(r.x+i.x)/2,o=(r.y+i.y)/2;this.dummy.position.set(a,-o,-1),this.dummy.rotation.set(0,0,Math.atan2(-(i.y-r.y),i.x-r.x)),this.dummy.scale.set(n.length,this.edgeWidth[t],1),this.dummy.updateMatrix(),this.edgeMesh.setMatrixAt(t,this.dummy.matrix),this.edgeMesh.setColorAt(t,this.edgeColor[t])}this.dummy.rotation.set(0,0,0),this.edgeMesh.instanceMatrix.needsUpdate=!0,this.edgeMesh.instanceColor&&(this.edgeMesh.instanceColor.needsUpdate=!0),this.edgesDirty=!1}}},Al=[`low`,`medium`,`high`],jl=class{constructor(e=`high`){Y(this,`window`,[]),Y(this,`fastStreak`,0),Y(this,`current`,void 0),this.current=e}get tier(){return this.current}sample(e){this.window.push(e),this.window.length>60&&this.window.shift(),this.fastStreak=e<16?this.fastStreak+1:0;let t=Al.indexOf(this.current);return this.window.length===60&&this.window.reduce((e,t)=>e+t,0)/60>22&&t>0&&(this.current=Al[t-1],this.window=[],this.fastStreak=0),this.fastStreak>=300&&t<Al.length-1&&(this.current=Al[t+1],this.window=[],this.fastStreak=0),this.current}};function Ml(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Nl(e,t){let n=Array.from({length:4096},()=>e()),r=(e,t)=>n[(t%64+64)%64*64+(e%64+64)%64],i=e=>e*e*(3-2*e);return(e,n)=>{let a=e/t,o=n/t,s=Math.floor(a),c=Math.floor(o),l=i(a-s),u=i(o-c),d=r(s,c)+(r(s+1,c)-r(s,c))*l;return d+(r(s,c+1)+(r(s+1,c+1)-r(s,c+1))*l-d)*u}}function Pl(e,t,n,r,i,a,o){let s=i/Math.SQRT2,c=Math.ceil(t/s),l=Math.ceil(n/s),u=Math.ceil(a/s),d=Array(c*l).fill(null),f=[],p=[],m=e=>e.x>=o&&e.x<=t-o&&e.y>=o&&e.y<=n-o,h=(e,t)=>{let n=Math.floor(e.x/s),r=Math.floor(e.y/s);for(let i=Math.max(0,r-u);i<=Math.min(l-1,r+u);i++)for(let r=Math.max(0,n-u);r<=Math.min(c-1,n+u);r++){let n=d[i*c+r];if(n!==null&&Math.hypot(f[n].x-e.x,f[n].y-e.y)<t)return!1}return!0},g=e=>{f.push(e),p.push(f.length-1),d[Math.floor(e.y/s)*c+Math.floor(e.x/s)]=f.length-1};for(g({x:t/2,y:n/2});p.length>0;){let t=Math.floor(e()*p.length),n=f[p[t]],i=r(n.x,n.y),a=!1;for(let t=0;t<30;t++){let t=e()*Math.PI*2,o=i*(1+e()),s={x:n.x+Math.cos(t)*o,y:n.y+Math.sin(t)*o};if(m(s)&&h(s,r(s.x,s.y))){g(s),a=!0;break}}a||p.splice(t,1)}return f}function Fl(e){let{seed:t,radius:n=70,terrainCell:r=400,terrainStrength:i=2,prune:a=0,mask:o}=e,s=Ml(t),c=Nl(s,r),l=o?Nl(s,o.cell):null,u=Pl(s,d,f,l&&o?(e,t)=>n*(1+o.strength*l(e,t)):()=>n,n,n*(1+(o?.strength??0)),60).map((e,t)=>({id:t,x:e.x,y:e.y})),p=[];for(let e=0;e<u.length;e++)for(let t=e+1;t<u.length;t++){let n=u[e],r=u[t],i=(n.x+r.x)/2,a=(n.y+r.y)/2,o=((n.x-r.x)**2+(n.y-r.y)**2)/4,s=!0;for(let n=0;n<u.length;n++){if(n===e||n===t)continue;let r=u[n];if((r.x-i)**2+(r.y-a)**2<o-1e-9){s=!1;break}}s&&p.push([e,t])}a>0&&(p=Il(u.length,p,a,s));let m=[],h=u.map(()=>[]);for(let[e,t]of p){let n=u[e],r=u[t],a=Math.hypot(n.x-r.x,n.y-r.y),o=a*(1+i*c((n.x+r.x)/2,(n.y+r.y)/2)),s=m.length;m.push({id:s,a:e,b:t,length:a,weight:o}),h[e].push({node:t,edge:s}),h[t].push({node:e,edge:s})}return{nodes:u,edges:m,adjacency:h}}function Il(e,t,n,r){let i=Math.floor(t.length*n),a=t.map((e,t)=>t);for(let e=a.length-1;e>0;e--){let t=Math.floor(r()*(e+1));[a[e],a[t]]=[a[t],a[e]]}let o=new Set,s=0;for(let n of a){if(s>=i)break;o.add(n),X(e,t,o,t[n])?s++:o.delete(n)}return t.filter((e,t)=>!o.has(t))}function X(e,t,n,[r,i]){let a=Array.from({length:e},()=>[]);t.forEach(([e,t],r)=>{n.has(r)||(a[e].push(t),a[t].push(e))});let o=new Uint8Array(e);o[r]=1;let s=[r];for(;s.length;){let e=s.pop();if(e===i)return!0;for(let t of a[e])o[t]||(o[t]=1,s.push(t))}return!1}var Z=[{id:`open-sector`,name:`OPEN SECTOR`,tagline:`Flat, cheap terrain. Straight shots win.`,params:{radius:58,terrainCell:400,terrainStrength:.05}},{id:`badlands`,name:`BADLANDS`,tagline:`Vast corrupted zones, half the routes dead. Cheap ground is worth a detour.`,params:{radius:160,terrainCell:1200,terrainStrength:7,prune:.6}},{id:`maze`,name:`THE MAZE`,tagline:`Severed conduits. Few paths thread the labyrinth.`,params:{radius:110,terrainCell:400,terrainStrength:1,prune:.45}},{id:`minefield`,name:`MINEFIELD`,tagline:`Cost spikes everywhere. Caution pays.`,params:{radius:70,terrainCell:170,terrainStrength:4}},{id:`archipelago`,name:`ARCHIPELAGO`,tagline:`Dense clusters, thin bridges. Find the crossings.`,params:{radius:54,terrainCell:400,terrainStrength:.1,mask:{cell:520,strength:2}}}];function Ll(e){let t=Ml(388208^e),n=Z.map((e,t)=>t);for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}function Rl(e){let t=Z.length,n=Math.floor(e/t),r=Ll(n);return n>0&&r[0]===Ll(n-1)[t-1]&&([r[0],r[1]]=[r[1],r[0]]),Z[r[e%t]]}var zl=(e,t)=>e.kind===`probe`?1:e.kind===`round`?t*2:0,Bl=[`ripple`,`tendril`,`miser`,`bloodhound`,`oracle`,`paranoia`],Vl=[{id:`cover`,name:`FULL COVERAGE`,task:`Touch every node in the sector. Least work wins — the beacon is just scenery here.`,metricLabel:`WORK`,eligible:Bl,needsTarget:!1},{id:`reach`,name:`FIRST CONTACT`,task:`Reach the beacon. Least work wins.`,metricLabel:`WORK`,eligible:Bl,needsTarget:!0},{id:`economy`,name:`CHEAPEST ROUTE`,task:`Find the cheapest route to the beacon. The route is judged, not the speed.`,metricLabel:`ROUTE COST`,eligible:Bl,needsTarget:!0}];function Hl(e,t,n,r){let i=r.edges.length;if(e.id===`cover`){let e=new Set,a=0;for(let o=0;o<n.ops.length;o++){let s=n.ops[o];if(a+=zl(s,i),s.kind===`visit`&&(e.add(s.node),e.size===r.nodes.length))return{strain:t,run:n,metric:a,tiebreak:0,endIndex:o}}throw Error(`${t} never covered the graph — eligibility/objective bug`)}let a=n.ops.findIndex(e=>e.kind===`found`);if(a<0)throw Error(`${t} emitted no found op on a targeted objective`);let o=0;for(let e=0;e<=a;e++)o+=zl(n.ops[e],i);return e.id===`reach`?{strain:t,run:n,metric:o,tiebreak:n.pathCost,endIndex:a}:{strain:t,run:n,metric:n.pathCost,tiebreak:o,endIndex:a}}function Ul(e,t){let n=t=>e.eligible.indexOf(t);return[...t].sort((e,t)=>e.metric-t.metric||e.tiebreak-t.tiebreak||n(e.strain)-n(t.strain))}var Wl=class{constructor(){Y(this,`items`,[])}get size(){return this.items.length}push(e,t){let n=this.items;n.push({item:e,priority:t});let r=n.length-1;for(;r>0;){let e=r-1>>1;if(n[e].priority<=n[r].priority)break;[n[e],n[r]]=[n[r],n[e]],r=e}}pop(){let e=this.items;if(e.length===0)return;let t=e[0].item,n=e.pop();if(e.length>0){e[0]=n;let t=0;for(;;){let n=2*t+1,r=n+1,i=t;if(n<e.length&&e[n].priority<e[i].priority&&(i=n),r<e.length&&e[r].priority<e[i].priority&&(i=r),i===t)break;[e[i],e[t]]=[e[t],e[i]],t=i}}return t}};function Gl(e,t,n,r,i=n){if(i===null&&(r===`greedy`||r===`astar`))throw Error(`${r} steers by distance-to-beacon — it needs an anchor node`);let a=e.nodes.length,o=r!==`bfs`&&r!==`dfs`,s=(()=>{if(i===null)return()=>0;let t=e.nodes[i].x,n=e.nodes[i].y;return r=>Math.hypot(e.nodes[r].x-t,e.nodes[r].y-n)})(),c=Array(a).fill(1/0),l=Array(a).fill(-1),u=Array(a).fill(!1),d=[],f=new Wl,p=0,m=e=>{switch(r){case`bfs`:return p;case`dfs`:return-p;case`dijkstra`:return c[e];case`greedy`:return s(e);case`astar`:return c[e]+s(e)}};for(c[t]=0,d.push({kind:`visit`,node:t,cost:0}),f.push(t,m(t)),p++;f.size>0;){let t=f.pop();if(u[t])continue;if(u[t]=!0,d.push({kind:`settle`,node:t,cost:c[t]}),n!==null&&t===n){let t=[];for(let e=n;e!==-1;e=l[e])t.push(e);t.reverse();let r=Kl(e,t);return d.push({kind:`found`,path:t,cost:r}),{ops:d,path:t,pathCost:r,workOps:d.filter(e=>e.kind===`probe`).length}}let r=0;for(let{node:n,edge:i}of e.adjacency[t]){if(u[n])continue;d.push({kind:`probe`,edge:i,from:t,to:n});let a=o?e.edges[i].weight:1,s=c[t]+a;if(s<c[n]){let e=c[n]===1/0;c[n]=s,l[n]=t,d.push(e?{kind:`visit`,node:n,cost:s}:{kind:`improve`,node:n,cost:s}),f.push(n,m(n)),p++,r++}}r===0&&d.push({kind:`deadEnd`,node:t})}if(n!==null)throw Error(`target unreachable — graph invariant violated`);return{ops:d,path:[],pathCost:0,workOps:d.filter(e=>e.kind===`probe`).length}}function Kl(e,t){let n=0;for(let r=0;r+1<t.length;r++){let i=e.adjacency[t[r]].find(e=>e.node===t[r+1]);if(!i)throw Error(`path uses a non-edge`);n+=e.edges[i.edge].weight}return n}function ql(e,t,n){let r=e.nodes.length,i=Array(r).fill(1/0),a=Array(r).fill(-1),o=[],s=Array(r).fill(!1);i[t]=0,s[t]=!0,o.push({kind:`visit`,node:t,cost:0});let c=0;for(let t=0;t<r-1;t++){let n=0,r=[];for(let t of e.edges)for(let[e,o]of[[t.a,t.b],[t.b,t.a]])i[e]+t.weight<i[o]&&(i[o]=i[e]+t.weight,a[o]=e,n++,r.push(s[o]?{kind:`improve`,node:o,cost:i[o]}:{kind:`visit`,node:o,cost:i[o]}),s[o]=!0);if(c++,o.push({kind:`round`,index:t,changed:n}),o.push(...r),n===0)break}if(n===null)return{ops:o,path:[],pathCost:0,workOps:c*e.edges.length*2};let l=[];for(let e=n;e!==-1;e=a[e])l.push(e);if(l.reverse(),l[0]!==t)throw Error(`target unreachable — graph invariant violated`);let u=Kl(e,l);return o.push({kind:`found`,path:l,cost:u}),{ops:o,path:l,pathCost:u,workOps:c*e.edges.length*2}}var Jl=[{id:`ripple`,name:`RIPPLE`,algorithm:`Breadth-First Search`,tagline:`Spreads evenly in every direction. Ignores distance.`,rule:`Always spread from the oldest node it found.`,color:`#38d9ff`},{id:`tendril`,name:`TENDRIL`,algorithm:`Depth-First Search`,tagline:`Follows one path as deep as it can before backtracking.`,rule:`Always spread from the newest node it found.`,color:`#b45cff`},{id:`miser`,name:`MISER`,algorithm:`Dijkstra's Algorithm`,tagline:`Always infects the cheapest reachable node next. Thorough but slow.`,rule:`Always spread from the cheapest node it can reach.`,color:`#ffd23e`},{id:`bloodhound`,name:`BLOODHOUND`,algorithm:`Greedy Best-First`,tagline:`Smells the target and beelines. Fast, but easily fooled.`,rule:`Always spread from the node nearest the beacon.`,color:`#ff5c7a`},{id:`oracle`,name:`ORACLE`,algorithm:`A* Search`,tagline:`Miser's caution + Bloodhound's nose. The smart one.`,rule:`Balance the cost already paid against the distance still to go.`,color:`#5cff9d`},{id:`paranoia`,name:`PARANOIA`,algorithm:`Bellman-Ford`,tagline:`Re-checks everything, over and over. Wasteful… but never wrong.`,rule:`Recheck every link in the sector. Then do it again.`,color:`#ff8c38`}],Yl={ripple:`bfs`,tendril:`dfs`,miser:`dijkstra`,bloodhound:`greedy`,oracle:`astar`};function Xl(e,t,n,r,i=r){return e===`paranoia`?ql(t,n,r):Gl(t,n,r,Yl[e],i)}function Zl(e,t,n){let r=0,i=1/0;for(let a of e.nodes){let e=(a.x-t)**2+(a.y-n)**2;e<i&&(i=e,r=a.id)}return r}var Ql=728775;function $l(e){let t=Vl.length,n=Ml((Ql^Math.floor(e/t))>>>0),r=Vl.map((e,t)=>t);for(let e=r.length-1;e>0;e--){let t=Math.floor(n()*(e+1));[r[e],r[t]]=[r[t],r[e]]}return Vl[r[e%t]]}function eu(e,t,n){let r=Fl({seed:e,...t.params}),i=Zl(r,d*.12,f*.5),a=Zl(r,d*.88,f*.5),o=n.needsTarget?a:null,s=Ul(n,n.eligible.map(e=>Hl(n,e,Xl(e,r,i,o,a),r)));return{seed:e,archetype:t,objective:n,graph:r,start:i,beacon:a,target:o,outcomes:s,winner:s[0].strain}}function tu(e){let t=Rl(e),n=$l(e),r;for(let i=0,a=2*e+1;i<5;i++,a+=2)try{return eu(a,t,n)}catch(e){r=e}throw r}function nu(e,t,n){if(n===0)return e;let r=t/n;return e*(1+2*r*r)}var ru=class{constructor(e,t,n=!1){Y(this,`budget`,0),Y(this,`index`,0),Y(this,`ops`,void 0),Y(this,`opsPerSecond`,void 0),Y(this,`ramp`,void 0),this.ops=e,this.opsPerSecond=t,this.ramp=n}get done(){return this.index>=this.ops.length}get consumed(){return this.index}rate(){return this.ramp?nu(this.opsPerSecond,this.index,this.ops.length):this.opsPerSecond}msPerTick(){return 1e3/this.rate()}advance(e){this.budget+=e/1e3*this.rate();let t=[];for(;!this.done;){let e=this.ops[this.index],n=e.kind===`round`?48:1;if(this.budget<n)break;if(this.budget-=n,this.index++,t.push(e),e.kind===`round`)for(;!this.done&&this.ops[this.index].kind!==`round`&&this.ops[this.index].kind!==`found`;)t.push(this.ops[this.index]),this.index++}return t}};function iu(){return{phase:`attract`,sectorIndex:0,rematch:!1,strain:null,strainFocus:0,mapPeek:!1}}function au(e,t){switch(t.type){case`idle`:return e.phase===`attract`?e:{...iu(),sectorIndex:e.sectorIndex+1};case`wake`:return e.phase===`attract`?{...e,phase:`reveal`,rematch:!1,strain:null,strainFocus:0}:e;case`revealDone`:return e.phase===`reveal`?{...e,phase:`select`}:e;case`focusStrain`:return e.phase===`select`?{...e,strainFocus:t.index}:e;case`toggleMapPeek`:return e.phase===`select`?{...e,mapPeek:!e.mapPeek}:e;case`chooseStrain`:return e.phase===`select`?{...e,phase:`run`,strain:t.strain,mapPeek:!1}:e;case`runDone`:return e.phase===`run`?{...e,phase:`leaderboard`}:e;case`rematch`:return e.phase===`leaderboard`?{...e,phase:`select`,rematch:!0,strain:null,strainFocus:0,mapPeek:!1}:e;case`nextSector`:return e.phase===`leaderboard`?{...e,phase:`reveal`,sectorIndex:e.sectorIndex+1,rematch:!1,strain:null,strainFocus:0}:e}}function ou(e,t=6){return{strainIndex:(e.strainIndex+1)%t}}var su=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),Q=e(((e,t)=>{t.exports=su()}))(),cu={ripple:`M60 60 m-12 0 a12 12 0 1 0 24 0 a12 12 0 1 0 -24 0 M60 60 m-28 0 a28 28 0 1 0 56 0 a28 28 0 1 0 -56 0 M60 60 m-44 0 a44 44 0 1 0 88 0 a44 44 0 1 0 -88 0`,tendril:`M16 100 C 30 20, 50 20, 55 60 S 70 110, 80 70 S 95 20, 104 28`,miser:`M60 60 L16 40 M60 60 L30 95 M60 60 L60 14 M60 60 L95 90 M60 60 L104 45 M60 60 L85 20`,bloodhound:`M16 95 L104 25 M104 25 l-18 2 M104 25 l-4 17`,oracle:`M16 95 Q 45 80 60 60 T 104 25 M104 25 l-18 2 M104 25 l-4 17`,paranoia:`M16 40 H104 M16 60 H104 M16 80 H104 M20 30 Q 60 20 100 30`};function lu(e){return(0,Q.jsxs)(`div`,{className:`strain-screen`,children:[(0,Q.jsxs)(`div`,{className:`strain-header`,children:[(0,Q.jsx)(`h1`,{children:e.rematch?`SAME MAP — NEW CALL`:`WHO WINS THIS SECTOR?`}),(0,Q.jsxs)(`div`,{className:`strain-sub`,children:[e.objectiveName,` — choose the strain you think wins`]}),(0,Q.jsxs)(`button`,{className:`peek-btn`,onClick:e.onPeek,children:[`view the map `,(0,Q.jsx)(`span`,{className:`hint`,children:`Y`})]})]}),(0,Q.jsx)(`div`,{className:`strain-row`,children:e.strains.map((t,n)=>(0,Q.jsxs)(`button`,{className:`strain-card${n===e.focus?` focused`:``}`,style:{"--accent":t.color},onMouseEnter:()=>e.onFocus(n),onClick:()=>e.onChoose(t.id),children:[(0,Q.jsx)(`h2`,{children:t.name}),(0,Q.jsx)(`div`,{className:`algo`,children:t.algorithm}),(0,Q.jsx)(`svg`,{className:`preview`,viewBox:`0 0 120 120`,children:(0,Q.jsx)(`path`,{d:cu[t.id],fill:`none`,stroke:t.color,strokeWidth:`3`,strokeLinecap:`round`})}),(0,Q.jsx)(`div`,{className:`tagline`,children:t.tagline})]},t.id))})]})}function uu(e){return(0,Q.jsxs)(`div`,{className:`run-hud`,style:{"--accent":e.color??`#38d9ff`},children:[(0,Q.jsx)(`div`,{className:`strain-tag`,children:e.strainName}),(0,Q.jsxs)(`div`,{className:`run-rule`,children:[(0,Q.jsx)(`span`,{children:`RULE`}),` `,e.rule]}),(0,Q.jsxs)(`div`,{className:`run-metric`,children:[e.metricLabel,` `,(0,Q.jsx)(`b`,{children:e.metricValue})]}),e.pass&&(0,Q.jsxs)(`div`,{className:`run-pass`,children:[`PASS `,e.pass.index+1,` — `,e.done&&e.pass.changed===0?`NOTHING CHANGED. DONE.`:`${e.pass.changed} ROUTES IMPROVED`]}),e.found&&(0,Q.jsx)(`div`,{className:`run-found`,children:`TARGET REACHED`})]})}function du(e){return(0,Q.jsxs)(`div`,{className:`reveal-card`,children:[(0,Q.jsx)(`div`,{className:`reveal-archetype`,children:e.archetypeName}),(0,Q.jsx)(`div`,{className:`reveal-tagline`,children:e.tagline}),(0,Q.jsxs)(`div`,{className:`reveal-objective`,children:[`OBJECTIVE — `,e.objectiveName]}),(0,Q.jsx)(`div`,{className:`reveal-task`,children:e.task}),(0,Q.jsx)(`div`,{className:`reveal-hint`,children:`reading the ground is half the game`}),(0,Q.jsx)(`div`,{className:`reveal-continue`,children:(0,Q.jsxs)(`button`,{className:`primary`,onClick:e.onContinue,children:[`Choose your strain `,(0,Q.jsx)(`span`,{className:`hint`,children:`A`})]})})]})}function fu(){return(0,Q.jsxs)(`div`,{className:`cost-legend`,children:[(0,Q.jsx)(`span`,{className:`legend-title`,children:`LINK COST`}),(0,Q.jsx)(`span`,{className:`legend-end`,children:`CHEAP`}),(0,Q.jsx)(`div`,{className:`bar`}),(0,Q.jsx)(`span`,{className:`legend-end`,children:`COSTLY`})]})}var pu={cover:{ripple:`Even rings waste nothing — RIPPLE touched the last node while the others were still doubling back across {ARCH}.`,tendril:`TENDRIL threaded {ARCH} corridor by corridor and hit the final pocket early.`,miser:`Cheapest ground first meant no wasted probes — MISER covered {ARCH} on a budget.`,bloodhound:`The beacon sat dead centre of {ARCH} — BLOODHOUND chased it and swept the whole sector almost by accident.`,oracle:`ORACLE's beacon-ward bias lined up with how {ARCH} is laid out, and its cost-first half did the rest.`,paranoia:`One brute-force sweep touched nearly everything at once — on {ARCH}, PARANOIA's excess was actually efficient.`},reach:{ripple:`No terrain worth exploiting on {ARCH} — RIPPLE's steady rings reached the beacon without detours.`,tendril:`A corridor ran straight to the beacon — TENDRIL's all-in lunge paid off on {ARCH}.`,miser:`The others drowned in costly ground — MISER rode the cheap channels of {ARCH} to the beacon.`,bloodhound:`Open ground, clear scent — BLOODHOUND beelined across {ARCH} while the careful ones checked receipts.`,oracle:`Cost so far plus distance to go — ORACLE read {ARCH} and spent almost nothing it didn't have to.`,paranoia:`Every rival wandered into expensive dead ends — on {ARCH}, even PARANOIA's full sweeps came out ahead.`},economy:{ripple:`On this flat stretch of {ARCH} the fewest hops IS the cheapest route — RIPPLE tied the optimum with less work.`,tendril:`TENDRIL's single thread through {ARCH} happened to be the cheap one.`,miser:`MISER never pays more than it must — the guaranteed-cheapest route through {ARCH}.`,bloodhound:`The straight shot across {ARCH} was also the cheap one — BLOODHOUND's rush cost nothing extra.`,oracle:`ORACLE found the same unbeatable route MISER did, and its nose for the beacon meant it checked far less of {ARCH} to get there.`,paranoia:`PARANOIA re-checked every connection in {ARCH} until only the truly cheapest route remained.`}};function mu(e,t,n){return(pu[e][n]??`${n.toUpperCase()} simply fit this ground best.`).replaceAll(`{ARCH}`,t)}var hu={ripple:`RIPPLE counts hops, never cost — it fanned out evenly in every direction and paid for ground it never needed.`,tendril:`TENDRIL always chases its newest lead — it committed to one corridor and had to back all the way out.`,miser:`MISER only ever takes the cheapest node next, and nothing in that rule points at the beacon — so it searched the sector in every direction at once.`,bloodhound:`BLOODHOUND runs at whatever looks closest to the beacon and never checks what a link costs — the direct line ran straight through expensive ground.`,oracle:`ORACLE weighs cost paid against distance left before every single move — careful, but on ground this open the caution cost more than it saved.`,paranoia:`PARANOIA rechecks every link in the sector on every pass — never wrong, but it pays full price for that certainty.`},gu={cover:{ripple:`RIPPLE widens one even ring at a time — when the job is simply to touch everything, that tidy order probed more links than it had to.`,tendril:`TENDRIL dives down one path to its very end before trying anything else — collecting the last few stragglers is what cost it.`,miser:`MISER sorts every step by cost, but this objective never asked about cost — that careful ordering bought nothing and probed more to get it.`,bloodhound:`BLOODHOUND only knows one move: run at the beacon. Nobody asked it to reach the beacon here — it sprinted there anyway and then had to crawl back for everything it skipped.`,oracle:`ORACLE aims every step at the beacon. A sharp aim is worthless when the job is to touch everything, so its best instinct pulled it away from the corners it still had to cover.`,paranoia:`PARANOIA sweeps every link in the sector on every pass — it does touch everything, but it pays for the whole map several times over to be sure.`},economy:{ripple:`RIPPLE counts hops, never cost — it found a route with few links, but those links were the expensive kind.`,tendril:`TENDRIL commits to the first path it stumbles into — it delivered a route, but nothing in its rule ever asked what that route cost.`,miser:`MISER always takes the cheapest node next, which is exactly what this objective rewards — it gave up ground on work, not on price.`,oracle:`ORACLE splits its attention between cost paid and distance left — the distance half pulled it toward routes that looked short and priced badly.`}};function _u(e,t,n,r){let i=e===`economy`,a=n>0?t/n:1/0;if(a>=2&&Number.isFinite(a)){let e=a>=10?String(Math.round(a)):a.toFixed(1).replace(/\.0$/,``);return i?`That route cost ${e}× what ${r} paid.`:`That came to ${e}× the work ${r} did.`}let o=Math.round((a-1)*100);return o<1?i?`It came in a hair dearer than ${r}'s route.`:`It came in a hair above ${r} on work.`:i?`That route cost ${o}% more than ${r}'s.`:`That took ${o}% more work than ${r}.`}function vu(e,t,n){let r=t[0],i=t.find(e=>e.strain===n);if(!r||!i||i.strain===r.strain)return null;let a=r.strain.toUpperCase();return i.metric===r.metric?`Nothing wrong with ${n.toUpperCase()}'s answer — it matched the winner exactly. ${a} just got there doing less work.`:`${gu[e]?.[n]??hu[n]} ${_u(e,i.metric,r.metric,a)}`}function yu(e){let{round:t,pick:n}=e,r=e=>Math.round(e).toLocaleString(),i=vu(t.objective.id,t.outcomes,n);return(0,Q.jsxs)(`div`,{className:`board-panel`,children:[(0,Q.jsxs)(`div`,{className:`board-title`,children:[t.objective.name,` — RESULTS`]}),(0,Q.jsx)(`div`,{className:`board-rows`,children:t.outcomes.map((e,i)=>{let a=Jl.find(t=>t.id===e.strain);return(0,Q.jsxs)(`div`,{className:`board-row${e.strain===n?` picked`:``}${i===0?` winner`:``}`,style:{"--accent":a.color},children:[(0,Q.jsx)(`span`,{className:`rank`,children:i+1}),(0,Q.jsx)(`span`,{className:`name`,children:a.name}),(0,Q.jsxs)(`span`,{className:`metric`,children:[t.objective.metricLabel,` `,r(e.metric)]}),e.strain===n&&(0,Q.jsx)(`span`,{className:`call`,children:i===0?`CALLED IT ✓`:`YOUR PICK`})]},e.strain)})}),(0,Q.jsx)(`div`,{className:`board-why`,children:mu(t.objective.id,t.archetype.name,t.winner)}),i&&(0,Q.jsxs)(`div`,{className:`board-loss`,style:{"--accent":Jl.find(e=>e.id===n).color},children:[(0,Q.jsx)(`span`,{className:`board-loss-tag`,children:`YOUR CALL`}),` `,i]}),(0,Q.jsxs)(`div`,{className:`board-actions`,children:[(0,Q.jsxs)(`button`,{className:`primary`,onClick:e.onNext,children:[`Next sector `,(0,Q.jsx)(`span`,{className:`hint`,children:`A`})]}),(0,Q.jsxs)(`button`,{onClick:e.onRematch,children:[`Rematch — same map, new strain `,(0,Q.jsx)(`span`,{className:`hint`,children:`B`})]})]})]})}var bu=[[12,`up`],[13,`down`],[14,`left`],[15,`right`],[0,`confirm`],[1,`back`],[3,`map`]],xu=.6,Su=.35;function Cu(e,t){let n=e.buttons.slice(),r=e.axes[0]??0,i=e.axes[1]??0,a=(e,n)=>t[e]?n>Su:n>xu;return n[12]=n[12]||a(12,-i),n[13]=n[13]||a(13,i),n[14]=n[14]||a(14,-r),n[15]=n[15]||a(15,r),n}function wu(e,t){return bu.filter(([n])=>t[n]&&!e[n]).map(([,e])=>e)}function Tu(){let e=[...navigator.getGamepads?navigator.getGamepads():[]].find(e=>e);return e?{buttons:e.buttons.map(e=>e.pressed),axes:[...e.axes]}:{buttons:Array(16).fill(!1),axes:[0,0,0,0]}}var Eu=[`left`,`right`,`up`,`down`,`confirm`,`back`,`map`];function Du(e){let t=e??(typeof location>`u`?``:location.search),n=new URLSearchParams(t);return n.has(`ftMsgUrl`)||n.get(`ftmsg`)===`1`}function Ou(e){if(!e||typeof e!=`object`)return null;let t=e;return t.type===`pad`?Eu.find(e=>e===t.action)??null:null}function ku(e,t){if(!(t?.enabled??Du()))return()=>{};let n=globalThis.FootronMessaging;if(!n||typeof n.Messaging!=`function`)return console.warn(`[phone] footron messaging client not loaded; phone controls are off`),()=>{};let r=new n.Messaging,i=t=>{let n=Ou(t);n&&e.onAction(n)},a=()=>e.onConnect?.();return r.addMessageListener(i),r.addConnectionListener(a),r.mount(),()=>{r.removeMessageListener(i),r.removeConnectionListener(a),r.unmount()}}function Au(e){let[t,n]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{let t=0,r=()=>{window.clearTimeout(t),n(!0),t=window.setTimeout(()=>n(!1),e)};return window.addEventListener(`gamepadconnected`,r),()=>{window.clearTimeout(t),window.removeEventListener(`gamepadconnected`,r)}},[e]),t}function ju(e,t){let n=(0,l.useRef)(0),r=(0,l.useRef)(e);r.current=e;let i=(0,l.useRef)(()=>{window.clearTimeout(n.current),n.current=window.setTimeout(()=>r.current(),t)}).current;return(0,l.useEffect)(()=>(i(),window.addEventListener(`pointerdown`,i),window.addEventListener(`pointermove`,i),()=>{window.clearTimeout(n.current),window.removeEventListener(`pointerdown`,i),window.removeEventListener(`pointermove`,i)}),[]),i}function Mu(){let[e,t]=(0,l.useState)({scale:1,x:0,y:0});return(0,l.useEffect)(()=>{let e=()=>{let e=Math.min(window.innerWidth/d,window.innerHeight/f);t({scale:e,x:(window.innerWidth-d*e)/2,y:(window.innerHeight-f*e)/2})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),e}function Nu(){let e=Mu(),t=(0,l.useRef)(null),n=(0,l.useRef)(null),[r,i]=(0,l.useReducer)(au,void 0,iu),[a,o]=(0,l.useState)({strainIndex:0}),s=(0,l.useRef)(r);(0,l.useEffect)(()=>{s.current=r},[r]);let c=ju(()=>i({type:`idle`}),m),u=Au(g),_=(0,l.useMemo)(()=>tu(r.sectorIndex),[r.sectorIndex]),v=(0,l.useRef)(_);(0,l.useEffect)(()=>{v.current=_},[_]);let y=(0,l.useMemo)(()=>_.objective.eligible.map(e=>Jl.find(t=>t.id===e)),[_]),b=Jl.find(e=>e.id===r.strain)??null,x=(0,l.useRef)(null),S=(0,l.useRef)(null),[C,w]=(0,l.useState)({work:0,visited:0,found:!1,pass:null,done:!1}),T=(0,l.useRef)(Array(16).fill(!1)),E=(0,l.useRef)(y);(0,l.useEffect)(()=>{E.current=y},[y]);let D=e=>{c();let t=s.current;switch(t.phase){case`attract`:i({type:`wake`});break;case`reveal`:e===`confirm`&&i({type:`revealDone`});break;case`select`:{if(t.mapPeek){i({type:`toggleMapPeek`});break}if(e===`map`){i({type:`toggleMapPeek`});break}let n=E.current.length-1;e===`left`&&i({type:`focusStrain`,index:Math.max(0,t.strainFocus-1)}),e===`right`&&i({type:`focusStrain`,index:Math.min(n,t.strainFocus+1)}),e===`confirm`&&i({type:`chooseStrain`,strain:E.current[Math.min(t.strainFocus,n)].id});break}case`run`:break;case`leaderboard`:e===`confirm`&&i({type:`nextSector`}),e===`back`&&i({type:`rematch`});break}};(0,l.useEffect)(()=>ku({onAction:D,onConnect:()=>{c(),s.current.phase===`attract`&&i({type:`wake`})}}),[]),(0,l.useEffect)(()=>{let e=new kl(t.current);return n.current=e,()=>{e.dispose(),n.current=null}},[]),(0,l.useEffect)(()=>{n.current?.setField(_.graph),n.current?.setTarget(_.beacon),n.current?.setStart(_.start)},[_]),(0,l.useEffect)(()=>{n.current?.setRenderScale(e.scale*window.devicePixelRatio)},[e.scale]),(0,l.useEffect)(()=>{r.phase===`reveal`&&n.current?.clearRun()},[r.phase]),(0,l.useEffect)(()=>{if(r.phase!==`run`||!r.strain)return;let e=_.outcomes.find(e=>e.strain===r.strain);return x.current=new ru(e.run.ops.slice(0,e.endIndex+1),90,!0),n.current?.beginRun(Jl.find(e=>e.id===r.strain).color,_.start),w({work:0,visited:0,found:!1,pass:null,done:!1}),()=>{x.current=null}},[r.phase,r.strain,_]),(0,l.useEffect)(()=>{if(r.phase!==`attract`)return;let e=_.outcomes[a.strainIndex%_.outcomes.length];return n.current?.beginRun(Jl.find(t=>t.id===e.strain).color,_.start),S.current=new ru(e.run.ops.slice(0,e.endIndex+1),180,!0),()=>{S.current=null}},[r.phase,a.strainIndex,_]),(0,l.useEffect)(()=>{let e=new URLSearchParams(location.search).get(`quality`),t=new jl(e??`high`);n.current?.setQuality(t.tier);let r=0,a=performance.now(),c=l=>{let u=l-a;a=l;let d=Cu(Tu(),T.current);for(let e of wu(T.current,d))D(e);T.current=d;let f=n.current;if(f){e||f.setQuality(t.sample(u));let n=x.current;if(s.current.phase===`run`&&n){let e=n.advance(u);if(e.length>0){f.applyOps(e,48*n.msPerTick());let t=v.current.graph.edges.length,r=[...e].reverse().find(e=>e.kind===`round`);w(n=>({...n,work:n.work+e.reduce((e,n)=>e+zl(n,t),0),visited:n.visited+e.filter(e=>e.kind===`visit`).length,found:n.found||e.some(e=>e.kind===`found`),pass:r&&r.kind===`round`?{index:r.index,changed:r.changed}:n.pass}))}n.done&&(x.current=null,w(e=>({...e,done:!0})),v.current.objective.id===`cover`&&f.finishRipple(v.current.start),window.setTimeout(()=>i({type:`runDone`}),p))}else if(s.current.phase===`attract`){let e=S.current;if(e){let t=e.advance(u);t.length>0&&f.applyOps(t,48*e.msPerTick()),e.done&&(S.current=null,v.current.objective.id===`cover`&&f.finishRipple(v.current.start),window.setTimeout(()=>o(e=>ou(e,v.current.outcomes.length)),h))}}f.update(u),f.render()}r=requestAnimationFrame(c)};return r=requestAnimationFrame(c),()=>cancelAnimationFrame(r)},[]);let O=Jl.find(e=>e.id===_.outcomes[a.strainIndex%_.outcomes.length].strain),k=_.objective.id===`cover`?`${Math.round(100*C.visited/_.graph.nodes.length)}% COVERED`:(e=>Math.round(e).toLocaleString())(C.work),A=_.objective.id===`cover`?`COVERAGE`:`WORK`;return(0,Q.jsxs)(`div`,{className:`stage`,style:{transform:`translate(${e.x}px, ${e.y}px) scale(${e.scale})`},children:[(0,Q.jsx)(`canvas`,{ref:t,width:d,height:f,style:{width:d,height:f}}),(0,Q.jsxs)(`div`,{className:`hud`,onPointerDown:()=>{r.phase===`attract`&&i({type:`wake`})},children:[(0,Q.jsx)(`div`,{className:`vignette`}),r.phase===`attract`&&(0,Q.jsxs)(`div`,{className:`attract-card`,style:{"--accent":O.color},children:[(0,Q.jsx)(`h1`,{children:`NODE ZERO`}),(0,Q.jsxs)(`div`,{className:`now-spreading`,children:[`now spreading: `,(0,Q.jsx)(`b`,{children:O.name}),` — `,O.algorithm]}),u?(0,Q.jsx)(`div`,{className:`press press-ready`,children:`CONTROLLER READY`}):(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`div`,{className:`press`,children:`PRESS ANY BUTTON TO PLAY`}),(0,Q.jsx)(`div`,{className:`press-sub`,children:Du()?`no controller? scan the QR code to play on your phone`:`controller asleep? press the Xbox button to wake it`})]})]}),r.phase===`reveal`&&(0,Q.jsx)(du,{archetypeName:_.archetype.name,tagline:_.archetype.tagline,objectiveName:_.objective.name,task:_.objective.task,onContinue:()=>i({type:`revealDone`})}),r.phase===`select`&&!r.mapPeek&&(0,Q.jsx)(lu,{strains:y,objectiveName:_.objective.name,rematch:r.rematch,focus:r.strainFocus,onFocus:e=>i({type:`focusStrain`,index:e}),onChoose:e=>i({type:`chooseStrain`,strain:e}),onPeek:()=>i({type:`toggleMapPeek`})}),r.phase===`select`&&r.mapPeek&&(0,Q.jsx)(`button`,{className:`peek-banner`,onClick:()=>i({type:`toggleMapPeek`}),children:`READING THE GROUND — press any button to choose your strain`}),r.phase===`run`&&b&&(0,Q.jsx)(uu,{strainName:b.name,color:b.color,rule:b.rule,metricLabel:A,metricValue:k,found:C.found,pass:C.pass,done:C.done}),(r.phase===`reveal`||r.phase===`run`||r.phase===`select`&&r.mapPeek)&&(0,Q.jsx)(fu,{}),r.phase===`leaderboard`&&r.strain&&(0,Q.jsx)(yu,{round:_,pick:r.strain,onRematch:()=>i({type:`rematch`}),onNext:()=>i({type:`nextSector`})})]})]})}var Pu=class extends l.Component{componentDidCatch(){location.reload()}render(){return this.props.children}};(0,u.createRoot)(document.getElementById(`root`)).render((0,Q.jsx)(l.StrictMode,{children:(0,Q.jsx)(Pu,{children:(0,Q.jsx)(Nu,{})})}));