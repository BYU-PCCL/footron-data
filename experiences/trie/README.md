# Trie: How Autocomplete Works

Words that start the same way share the same branch. A trie stores every word as a path out from the centre, one letter per step — so typing “ca” lights up everything that could come next.
