...
export const slides = [
  ...
  {
    text: "Part of the utility of Fourier transform comes from being able to filter out unnecissary information.",
    screen: "both"
  },
  {
  ...
  { screen: "left" },
  {
    ...
    text: "The fourier transform is widely used every day everywhere from phone call audio to quantum mechanics.",
  },
]