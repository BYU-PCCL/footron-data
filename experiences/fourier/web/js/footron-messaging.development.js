...
//       factory((global.FootronMessaging = {})));
...
//         return _awaitIgnored$1(
//           _this12.sendProtocolMessage({
...
//                     (_this5$socket = _this5.socket) == null
//                       ? void 0
//                       : _this5$socket.removeEventListener("open", openCallback);
//                     (_this5$socket2 = _this5.socket) == null
//                       ? void 0
//                       : _this5$socket2.removeEventListener(
//                           "close",
//                           closeCallback
//                         );
//                   };
...
//               return _await(
//                 _this7.compareHeartbeatUpConnections(message.clients),
//                 function () {
//                   _exit5 = true;
//                 }
//               );
...
//                   message.type +
//                   "' doesn't contain valid 'client' field required by all remaining message handlers"
//               );
//             }
...
//                           connection.sendEmptyInitialMessage()
//                         );
//                       }
//                     },
//                     function () {
...
//                     "Unauthorized client '" +
//                       message.client +
//                       "' attempted to send an authenticated message"
//                   );
//                 }
...
//                   (_this7$connections$ge = _this7.connections.get(
//                     message.client
//                   )) == null
//                     ? void 0
//                     : _this7$connections$ge.notifyMessageListeners(
//                         listenerMessage
//                       );
//                   return;
//                 }
...
//                 throw Error(
//                   "Couldn't handle message type '" + message.type + "'"
//                 );
//               }
//             );
//           }
...
//     _proto.compareHeartbeatUpConnections =
//       function compareHeartbeatUpConnections(connections) {
//         var _this8 = this;
...
//       (_this$connections = this.connections) == null
//         ? void 0
//         : (_this$connections$get = _this$connections.get(id)) == null
//         ? void 0
//         : _this$connections$get.notifyCloseListeners();
...
//           (_this10$socket = _this10.socket) == null
//             ? void 0
//             : _this10$socket.send(
//                 JSON.stringify(
//                   _extends({}, message, {
...
//     _proto.removeConnectionListener = function removeConnectionListener(
//       callback
//     ) {
...
//     _proto.notifyConnectionListeners = function notifyConnectionListeners(
//       connection
//     ) {
...
//         url =
//           (_URLSearchParams$get = new URLSearchParams(location.search).get(
//             "ftMsgUrl"
//           )) != null
