...
/*
 * Phone controls for `bloom-filter` (Have I Seen This Before?).
 *
 ...
 * number of bits in the filter or how many hash functions it uses: that
 * changes what the captions on the wall say, and a panel that can put the
 * wall's narration out of step with its picture is worse than no panel.
 *
...
const ControlsComponent = () => {
  ...
  return (
    <div css={containerStyle}>
      <p>
        <b>
          A set that answers out of thirty-two bits and never keeps what you
          put into it. The wall fills one, then asks it about a name it was
          never given.
        </b>
      </p>

      <p className="q">Have I seen this before?</p>
      ...
      <p className="foot">
        <b>New data</b> deals a fresh set — different names, different bits
        set, a different false positive — and plays it again from the start.
